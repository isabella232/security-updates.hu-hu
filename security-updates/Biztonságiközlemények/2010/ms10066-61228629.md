---
TOCTitle: 'MS10-066'
Title: 'A Microsoft számú biztonsági közleménye MS10-066 - Fontos'
ms:assetid: 'ms10-066'
ms:contentKeyID: 61228629
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-066(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS10-066 - Fontos
=========================================================

A távoli eljáráshívás biztonsági rése távolról történő kódfuttatást tesz lehetővé (982802)
------------------------------------------------------------------------------------------
...
A biztonsági frissítés a biztonsági rés elhárítása végett kijavítja a memóriakiosztás módját az RPC ügyfélen, a távoli kiszolgálóra küldött RPC kérelmek betöltése előtt. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7ad0f2cf-03dc-49a0-a16e-17fed0c01cc6)                           | Távoli kódfuttatás         | Fontos                           | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3349b12b-621e-48bc-9c57-489c7a56920d)  | Távoli kódfuttatás         | Fontos                           | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8b3004b-07db-4638-a9b7-224ff829081c)                  | Távoli kódfuttatás         | Fontos                           | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=612b2096-bd82-47ca-8b99-454c2f158d39)      | Távoli kódfuttatás         | Fontos                           | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 SP2 Itanium alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73) | Távoli kódfuttatás         | Fontos                           | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
...
<th style="border:1px solid black;" >RPC memóriameghibásodás biztonsági rése - CVE-2010-2567</th>
...
RPC memóriameghibásodás biztonsági rése - CVE-2010-2567  
-------------------------------------------------------
  
<span></span>
A különlegesen kialakított RPC válaszoknak a távoli eljáráshívás (RPC) ügyfélszoftvere általi memóriakiosztási módja hitelesítés nélküli távoli kód futtatását lehetővé tévő biztonsági rést okoz. A biztonsági rés kihasználásához nem szükséges hitelesítés, így a támadók a rés kihasználásához az ügyfél által kezdeményezett RPC kérelemre különlegesen kialakított RPC választ küldhetnek. Ha egy támadó kihasználja a biztonsági rést, távolról mesterséges kódot futtathat és teljes mértékben átveheti az érintett rendszer irányítását. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-2567](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567).
  
#### Az RPC memóriameghibásodás biztonsági résének (CVE-2010-2567) súlyosságát enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   A támadónak meg kell győznie a felhasználót, hogy RPC kapcsolatot kezdeményezzen egy rosszindulatú kiszolgálóval, amely a támadó felügyelete alatt áll. A támadó távolról nem tudja kihasználni ezt a biztonsági rést a felhasználó közreműködése nélkül.  
-   A biztonsági rést kihasználó támadó a helyi felhasználóval egyező hozzáférést nyer a rendszerhez. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén
  
#### Az RPC memóriameghibásodás biztonsági résének (CVE-2010-2567) lehetséges megoldásai
  
A lehetséges megoldás olyan beállítást vagy konfigurációs módosítást takar, amely magát a biztonsági rést nem szünteti meg, azonban a frissítés telepítése előtt segít az ismert támadási lehetőségek kivédésében. A Microsoft alaposan megvizsgálta a következő lehetséges megoldásokat, és tájékoztatja a felhasználókat, amennyiben a megoldás csökkenti a működőképességet:
  
-   **A tűzfalnál blokkolja az RPC-hez társított portokat**
...
#### Gyakran feltett kérdések az RPC memóriameghibásodás biztonsági résével (CVE-2010-2567) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés távolról történő kódfuttatást tehet lehetővé. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rés oka a Microsoft távoli eljáráshívás (RPC) ügyfélszoftver helytelen memóriakiosztási módja a speciálisan kialakított RPC válaszok elemzése során.
  
**Mi a távoli eljáráshívás (Remote Procedure Call, RPC)?**  
A Microsoft távoli eljáráshívás (RPC) az 1980-as évek elején kifejlesztett hálózati programozási szabvány. Az RPC segítségével a programozó elkészíthet egy korlátlan számú eljárást tartalmazó alkalmazást: ezek egy része helyben, másik része pedig távoli számítógépekről, hálózaton keresztül fut.
  
**Mire használhatja a biztonsági rést a támadó?**    
A biztonsági rést sikeresen kihasználó támadó kódot futtathat az RPC ügyfélalkalmazás biztonsági környezetében. Ha az RPC ügyfélalkalmazás LocalSystem környezetben, vagy rendszergazda jogosultságokkal ellátott fiók alól fut, a támadó teljesen átveheti a hatalmat az érintett rendszer felett.
  
**Hogyan használhatja ki a támadó a biztonsági rést?**    
A támadó speciálisan kialakított RPC kiszolgálót üzemeltethet, amelynek rendeltetése a biztonsági rés kihasználása, majd ráveszi a felhasználót, hogy RPC hívást kezdeményezzen a kiszolgálóra. Ezen kívül a helyi hálózaton lévő támadó illetéktelen támadás útján is elérheti, hogy a rendszer jogszerű RPC hívásra hibás RPC választ küldjön.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**    
A Windows XP és Windows Server 2003 támogatott kiadásait futtató összes rendszert érinti a biztonsági rés kockázata.
  
**Mi a frissítés feladata?**    
A frissítés a biztonsági rés elhárítása végett kijavítja a memóriakiosztás módját az RPC ügyfélen, a távoli kiszolgálóra küldött RPC kérelmek betöltése előtt.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB982802$\Spuninst mappában található.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/982802">Microsoft Tudásbázis 982802. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   Yamata Li, [Palo Alto Networks](http://www.paloaltonetworks.com/), az RPC memóriameghibásodás biztonsági résének (CVE-2010-2567) jelentéséért
