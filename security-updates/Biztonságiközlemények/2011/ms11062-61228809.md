---
TOCTitle: 'MS11-062'
Title: 'A Microsoft számú biztonsági közleménye MS11-062 - Fontos'
ms:assetid: 'ms11-062'
ms:contentKeyID: 61228809
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-062(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS11-062 - Fontos
=========================================================

A távelérés szolgáltatás NDISTAPI illesztőprogramjában a biztonsági rés jogok kiterjesztését teheti lehetővé (2566454)
----------------------------------------------------------------------------------------------------------------------
...
A biztonsági frissítés a biztonsági rés megszüntetéséhez módosítja azt az eljárást, amelyikkel az NDISTAPI illesztő a bemeneti adatokat a felhasználói módból a Windows rendszermagba történő küldés előtt érvényesíti. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4)                                                 | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b)                        | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc)                                        | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667)                            | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 SP2 karbantartó csomaggal Itanium-alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d) | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
...
<th style="border:1px solid black;" >Az NDISTAPI jogok kiterjesztését eredményező biztonsági rése - CVE-2011-1974</th>
...
Az NDISTAPI jogok kiterjesztését eredményező biztonsági rése - CVE-2011-1974  
----------------------------------------------------------------------------
  
<span></span>
A jogok kiterjesztését okozó biztonsági rés a Remote Access Service NDISTAPI illesztőjében található. A biztonsági rés oka, hogy az NDISTAPI illesztő nem megfelelően érvényesíti a felhasználó általi bevitelt, amikor a felhasználói módból adatokat továbbít a Windows rendszermagjába. Ha egy helyi támadó kihasználja a biztonsági rést, távolról tetszőleges kódot futtathat és teljes mértékben átveheti az érintett rendszer irányítását. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1974](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974).
  
#### Az NDISTAPI jogok kiterjesztését lehetővé tévő biztonsági résének (CVE-2011-1974) súlyosságát enyhítő tényezők
...
#### Lehetséges megoldások az NDISTAPI jogok kiterjesztését lehetővé tévő biztonsági résének (CVE-2011-1974) kiküszöbölésére
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismételt kérdések az NDISTAPI jogok kiterjesztését lehetővé tévő biztonsági résével (CVE-2011-1974) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés jogok kiterjesztését teheti lehetővé.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rés oka, hogy az NDISTAPI illesztő nem megfelelően érvényesíti a felhasználó általi bevitelt, amikor a felhasználói módból adatokat továbbít a Windows rendszermagjába.
  
**Melyik összetevőt érinti a biztonsági rés?**    
A NDISTAPI.sys az az összetevő, amelyet a biztonsági rés érint.
  
**Mire szolgál a távelérési szolgáltatás (RAS)?**    
A távelérési szolgáltatással (Remote Access Service - RAS) a felhasználók telefonvonalon, interneten vagy egyéb hálózati kapcsolaton keresztül csatlakozhatnak távoli számítógépekhez, így lényegében úgy dolgozhatnak, mintha rendszerük fizikailag csatlakozna a távoli hálózathoz. A RAS lehetővé teszi, hogy a felhasználók olyan műveleteket hajtsanak végre, mint az e-mailek küldése és fogadása, dokumentumok faxolása, fájlok visszakeresése vagy dokumentumok nyomtatása az iroda valamelyik nyomtatóján. További információkért lásd a [RAS](http://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx)Architecture Overview (NDIS 5.1) című MSDN-cikket.
  
A RAS a Windows XP és a Windows Server 2003 rendszerben natív szolgáltatás. A későbbi operációs rendszerekben a RAS szolgáltatást az Útválasztás és távelérés szolgáltatás (Routing and Remote Access Service - RRAS) váltotta fel. Az RRAS segítségével a számítógép hálózati útválasztóként működtethető. Az RRAS következő generációs kiszolgálófunkciókat is nyújt a Windows távelérési szolgáltatása (RAS) számára. Az RRAS kiszolgálófunkció a korábbi rendszereken már alkalmazott távelérési szolgáltatást (RAS) veszi alapul.
  
**Mi az NDISTAPI illesztő?**     
Az NDISTAPI illesztő a RAS architektúra része, és csatolót biztosít az NDISWAN részére a TAPI szolgáltatásokhoz. A telefonkezelő alkalmazások implementálják a TAPI szolgáltatásokat, és a telefonvonalak és hívások beállítására, figyelésére és bontására vonatkozó TAPI kérelmeket kezdeményezhetnek. Az NDISTAPI illesztő ezeket a TAPI kérelmeket adja át az NDISWAN részére. További információkért lásd a [NDISTAPI Overview (NDIS 5.1)](http://msdn.microsoft.com/en-us/library/ff554813(v=vs.85).aspx) című MSDN-cikket.
  
**Mi az NDISWAN?**    
Az NDISWAN (Network Driver Interface Standard Wide Area Network) a rendszer által szolgáltatott olyan köztes NDIS illesztő, amelyik olyan funkciókat biztosít, mint az adattömörítés, titkosítás, visszavezetés és a WAN miniport-illesztők által használt egyszerű PPP keretek. A WAN miniport-illesztőkre azonban csak az olyan funkciók implementálásakor van szükség, amelyek az adott hordozóközegre jellemzők (például az ISDN esetén szükséges a Q931 jeltovábbítás). További információért olvassa el az [NDISWAN Overview](http://msdn.microsoft.com/en-us/library/ff564653(v=vs.85).aspx) című MSDN-cikket.
  
**Mi az a TAPI szolgáltatás?**     
A TAPI (Telephony Application Programming Interface) szolgáltatás egy olyan programozási felület, amelyik telefonkezelési szolgáltatásokat biztosít a telefonos kommunikációra képes alkalmazások részére.
  
**Mi az NDIS?**    
Az NDIS (Network Driver Interface Standard) a Windows Driver Kit része, és olyan teljesen integrált illesztőfejlesztő rendszer, amelyikbe a Windows Driver Device Kit és a Windows illesztőprogramok stabilitására és megbízhatóságára vonatkozó tesztek is beletartoznak. Az NDIS függvénykönyvtára a hálózati hardvert a hálózati illesztőprogramokból képezi le. Az NDIS adja meg a többrétegű hálózati illesztőprogramok közötti szabványos illesztést is azáltal, hogy az olyan felsőbb szintű illesztőprogramokból, mint a hálózati adatátvitelé, leképezik a hardvert kezelő alacsonyabb szintű illesztőprogramokat. Szintén az NDIS kezeli a hálózati illesztőprogramok állapotadatait és paramétereit, beleértve a függvények, kezelők és paraméterblokkok meghívható pointereit és az egyéb rendszerbeli értékeket is.
  
**Mire használhatja a biztonsági rést a támadó?**    
A biztonsági rést sikeresen kihasználó támadó tetszőleges kódot futtathat a helyi rendszer környezetében. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
...
A frissítés a biztonsági rés megszüntetéséhez módosítja azt az eljárást, amelyikkel az NDISTAPI illesztő a bemeneti adatokat a felhasználói módból a Windows rendszermagba történő küldés előtt érvényesíti.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2566454$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2566454">Microsoft Tudásbázis 2566454. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   Lufeng Li, , az NDISTAPI jogok kiterjesztését eredményező biztonsági rése (CVE-2011-1974) jelentéséért
