---
TOCTitle: 'MS10-057'
Title: 'A Microsoft számú biztonsági közleménye MS10-057 - Fontos'
ms:assetid: 'ms10-057'
ms:contentKeyID: 61228620
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-057(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS10-057 - Fontos
=========================================================

A Microsoft Office Excel biztonsági rése távolról történő programkódfuttatást tehet lehetővé (2269707)
------------------------------------------------------------------------------------------------------
...
Ez a biztonsági frissítés a Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office 2004 for Mac, és Microsoft Office 2008 for Mac; és Open XML File Format Converter for Mac valamennyi támogatott kiadására nézve Fontos besorolású. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.
...
**Ismert problémák** A[Microsoft Tudásbázis 2269707. számú cikkében](http://support.microsoft.com/kb/2269707) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
Az Office különálló programjait ugyanolyan súlyossági besorolás szerint érinti, mint az Office csomag megfelelő elemét. Például a Microsoft Office Excel különálló telepítését azonos súlyossági besorolás szerint érinti, mint az Office csomag részeként szállított Microsoft Office Excel telepítést.
...
<th>
Az Excel alkalmazás memóriameghibásodást okozó biztonsági rése - CVE-2010-2562
</th>
<th>
Összesített súlyossági besorolás
</th>
...
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-2562](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562).

#### Az Excel alkalmazás memóriameghibásodás miatti biztonsági rése (CVE-2010-2562) hibáit enyhítő tényezők
...
#### Az Excel alkalmazás memóriameghibásodás miatti biztonsági résének (CVE-2010-2562) lehetséges megoldásai
...
#### Gyakran feltett kérdések az Excel alkalmazás memóriameghibásodás miatti biztonsági rése (CVE-2010-2562) kapcsán
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2264397">Microsoft Tudásbázis 2264397. számú cikkét</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2264403">Microsoft Tudásbázis 2264403. számú cikkét</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Beállításkulcsok hitelesítése</strong></td>
<td style="border:1px solid black;">Nem érintett</td>
...
-   Damián Frizza, a [Core Security Technologies](http://www.coresecurity.com/) munkatársa az Excel memóriameghibásodást okozó biztonsági rése (CVE-2010-2562) jelentéséért
...
-   1.1 verzió (2010. augusztus 11.): Új hivatkozás a Microsoft Tudásbázis 2269707 cikkére az Összefoglalás rész Ismert problémák c. szakaszában.
