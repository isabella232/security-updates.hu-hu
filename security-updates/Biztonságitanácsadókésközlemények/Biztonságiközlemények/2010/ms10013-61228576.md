---
TOCTitle: 'MS10-013'
Title: 'A Microsoft számú biztonsági közleménye MS10-013 - Kritikus'
ms:assetid: 'ms10-013'
ms:contentKeyID: 61228576
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-013(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS10-013 - Kritikus
===========================================================

A Microsoft DirectShow biztonsági rése távoli kódfuttatást tehet lehetővé (977935)
----------------------------------------------------------------------------------
...
A biztonsági frissítés besorolása a Microsoft Windows összes támogatott kiadására nézve Kritikus, kivéve a Windows Server 2003, Windows Server 2008 és Windows Server 2008 R2 Itanium alapú kiadásait: ezekre nézve a besorolás Fontos. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.

A biztonsági frissítés a biztonsági rés elhárítása érdekében javítja az AVI-fájlok megnyitási módját a DirectShow alkalmazásban. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
(KB975560)  
[Quartz elem a DirectX 9.0 alkalmazásban](http://www.microsoft.com/downloads/details.aspx?familyid=59a8bc19-02bb-4800-bac1-464f59e1cb7b)<sup>[1]</sup>   
(KB975560)
</td>
<td style="border:1px solid black;">
Távoli kódfuttatás
...
**Megjegyzése a DirectX alkalmazáshoz**
...
**Miért vonatkozik néha két frissítés is ugyanarra az érintett operációs rendszerre?**  
Ez a közlemény olyan biztonsági résre vonatkozik, amelyik két különböző összetevőben is jelen van. Tehát két, eltérő KB számozású frissítési csomagból az egyik az egyik érintett összetevőhöz használható, a másik pedig a másikhoz használható. A KB977914 az AVI-szűrő biztonsági résére vonatkozik. A KB975560 a DirectX biztonsági résére vonatkozik. Azokon az operációs rendszereken, amelyeken jelen van mindkét összetevő, mindkét frissítést telepíteni kell.

A Microsoft Windows 2000, a Windows XP és a Windows Server 2003 támogatott kiadásait használóknak telepíteni kell a KB977914 és a KB975560 számú frissítőcsomagot is, mivel erre a környezetre mindkettő vonatkozik. Más érintett operációs rendszereknél csak a KB975560 számú biztonsági frissítőcsomagot kell telepíteni.
...
<th>
DirectShow halomtúlcsordulást okozó biztonsági rése – CVE-2010-0250
</th>
<th>
Összesített súlyossági besorolás
</th>
...
<tr>
<td style="border:1px solid black;">
AVI-szűrő Microsoft Windows 2000 Service Pack 4 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
AVI-szűrő Windows XP Service Pack 2 és Windows XP Service Pack 3 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
AVI-szűrő Windows XP Professional x64 Edition Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
AVI-szűrő Windows Server 2003 Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
AVI-szűrő Windows Server 2003 x64 Edition Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
AVI-szűrő Windows Server 2003 SP2 Itanium alapú rendszereken
</td>
<td style="border:1px solid black;">
**Fontos**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Microsoft Windows 2000 Service Pack 4 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz Microsoft Windows XP Service Pack 2 és Windows XP Service Pack 3 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Microsoft Windows XP Professional x64 Edition Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz Windows Server 2003 Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Windows Server 2003 x64 Edition Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz Windows Server 2003, SP2 Itanium alapú rendszereken
</td>
<td style="border:1px solid black;">
**Fontos**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Windows Vista, Windows Vista Service Pack 1 és Windows Vista Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 és Windows Vista x64 Edition Service Pack 2 rendszeren
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Windows Server 2008 32 bites rendszerekhez és Windows Server 2008 32 bites rendszerekhez Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz Windows Server 2008 x64 alapú rendszerekhez és Windows Server 2008 x64 alapú rendszerekhez Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Windows Server 2008 Itanium alapú rendszerekhez és Windows Server 2008 Itanium alapú rendszerekhez, Service Pack 2
</td>
<td style="border:1px solid black;">
**Fontos**  
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz Windows 7 32 bites rendszerekhez
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Windows 7 x64 alapú rendszerekhez
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz Windows Server 2008 R2 x64 alapú rendszerekhez
</td>
<td style="border:1px solid black;">
**Kritikus**   
Távoli kódfuttatás
...
<tr>
<td style="border:1px solid black;">
Quartz Windows Server 2008 R2 Itanium alapú rendszerekhez
</td>
<td style="border:1px solid black;">
**Fontos**   
Távoli kódfuttatás
...
<span></span>
A Microsoft DirectShow alkalmazásban a AVI médiafájlok elemzési módjában távoli kódvégrehajtást lehetővé tévő biztonsági rés található. Ez a biztonsági rés távoli kódvégrehajtást tehet lehetővé, ha a felhasználó megnyit egy speciálisan kialakított AVI fájlt. Ha valamely felhasználó felügyeleti jogosultságokkal bejelentkezett a rendszerbe, akkor a biztonsági rést kihasználó támadó teljes mértékben átveheti az irányítást a számítógép felett, Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén

A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-0250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0250).

#### A DirectShow képmegjelenítő halomtúlcsordulást okozó biztonsági résének (CVE-2010-0250) hibáit enyhítő tényezők
...
#### A DirectShow halomtúlcsordulást okozó biztonsági résének (CVE-2010-0250) lehetséges megoldásai

A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.

#### Gyakran feltett kérdések a DirectShow halomtúlcsordulást okozó biztonsági rése (CVE-2010-0250) kapcsán
...
A Microsoft DirectShow összetevő nem megfelelően kezeli a speciálisan kialakított AVI-fájlokat.
...
A frissítés a probléma elhárítása érdekében javítja a médiafájlok megnyitási módját a DirectShow alkalmazásban.
...
|--------------------------------------------------------------------------------------------------------------------|---------|-----------------------------|-----------------------------|----------------------------|
| Microsoft Windows 2000 Service Pack 4 (AVI-szűrő)                                                                  | Igen    | Igen                        | Igen                        | Igen                       |
| Microsoft Windows 2000 Service Pack 4 (Quartz)                                                                     | Nem     | Nem                         | Igen                        | Igen                       |
| Windows XP Service Pack 2 és Windows XP Service Pack 3 (AVI-szűrő)                                                 | Igen    | Igen                        | Igen                        | Igen                       |
| Windows XP Service Pack 2 és Windows XP Service Pack 3 (Quartz)                                                    | Nem     | Nem                         | Igen                        | Igen                       |
| Windows XP Professional x64 Edition Service Pack 2                                                                 | Nem     | Nem                         | Igen                        | Igen                       |
| Windows Server 2003 Service Pack 2 (AVI-szűrő)                                                                     | Igen    | Igen                        | Igen                        | Igen                       |
| Windows Server 2003 Service Pack 2 (Quartz)                                                                        | Nem     | Nem                         | Igen                        | Igen                       |
...
<td style="border:1px solid black;">A Microsoft Windows 2000 rendszer AVI-szűrőjéhez:<br />
Windows2000-KB977914-x86-ENU /quiet<br />
<br />
Ezenkívül a Quartz esetén pedig az alábbiak egyike:<br />
<br />
- Microsoft Windows 2000:<br />
Windows2000-KB975560-x86-ENU /quiet<br />
<br />
- Microsoft Windows 2000 és DirectX 9.0:<br />
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB977914$\Spuninst és a %Windir%\$NTUninstallKB975560$\Spuninst mappában található</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/977914">Microsoft Tudásbázis 977914</a> számú és a <a href="http://support.microsoft.com/kb/975560">Microsoft Tudásbázis 975560</a> számú cikkét</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Telepítés felhasználói beavatkozás nélkül</td>
<td style="border:1px solid black;">A Windows XP SP 2 és a Windows XP SP 3 esetén is mindkét alábbi:<br />
- Az AVI szűrő részére:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows XP Professional x64 Edition SP 2 esetén mindkét alábbi:<br />
- Az AVI szűrő részére:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Telepítés felhasználói beavatkozás nélkül</td>
<td style="border:1px solid black;">A Windows Server 2003 összes támogatott 32 bites kiadása esetén mindkét alábbi:<br />
- Az AVI szűrő részére:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows Server 2003 összes támogatott x64 alapú kiadása esetén mindkét alábbi:<br />
- Az AVI szűrő részére:<br />
WindowsServer2003.WindowsXP-KB977914-x64-ENU /quiet<br />
- A Quartz részére:<br />
WindowsServer2003.WindowsXP-KB975560-x64-ENU /quiet</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows Server 2003 összes támogatott Itanium alapú kiadása esetén mindkét alábbi:<br />
- Az AVI szűrő részére:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/975560">Microsoft Tudásbázis 975560 számú cikkét</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Rendszerleíró kulcsok ellenőrzése</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008 R2 Itanium alapú rendszerekhez:<br />
...
-   Névtelen bejelentő a [TippingPoint](http://www.tippingpoint.com/) és a [Zero Day Initiative](http://www.zerodayinitiative.com/) cégektől, a DirectShow halomtúlcsordulást okozó biztonsági résének (CVE-2010-0250) jelentéséért.
...
-   1.1 verzió (2010. február 10.): Helyesbítettük a csereközleményt a Quartz (KB975560) frissítőcsomag vonatkozásában. A Microsoft Windows 2000 és a Windows Server 2008 kivételével módosítottuk a frissítés miatti újraindítási követelményeket. Módosult a **Systems Management Server** táblázat SMS 2003 ITMU eleme, a Windows 7 és a Windows Server 2008 R2 vonatkozásában. A Windows XP összes támogatott, x64 alapú verziójánál javítottuk a rendszerleíró kulcsok ellenőrzési módját. Ezek csak tájékoztató jellegű módosítások. A biztonsági frissítéshez kapcsolódó fájlok és az észlelési logika nem változott.
