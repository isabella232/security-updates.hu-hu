---
TOCTitle: 'MS09-039'
Title: 'A Microsoft számú biztonsági közleménye MS09-039 - Kritikus'
ms:assetid: 'ms09-039'
ms:contentKeyID: 61228328
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms09-039(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS09-039 - Kritikus
===========================================================

A WINS biztonsági rései távolról történő kódfuttatást tesznek lehetővé (969883)
-------------------------------------------------------------------------------
...
A biztonsági frissítés Microsoft Windows 2000 Server Service Pack 4 és Windows Server 2003 rendszerek összes támogatott kiadásának vonatkozásában ez a frissítés kritikus besorolásúnak minősül. További tudnivalókért tekintse meg az **Érintett és nem érintett szoftverek** c. részt.

A biztonsági frissítés a biztonsági résre vonatkozik, és módosítja a pufferméret kiszámításának eljárását a WINS szolgáltatásban, valamint helyes adatértékelést biztosít a WINS kiszolgálón fogadott csomagokban. A biztonsági résekkel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=96c3f496-7b2f-4dbc-b484-216c9943c2b1">Windows Server 2003 SP2 for Itanium-based Systems</a></td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=139821">MS09-008</a><br />
(csak KB961064)</td>
...
<th style="border:1px solid black;" >WINS képmegjelenítő halomtúlcsordulást okozó biztonsági rése - CVE-2009-1923</th>
<th style="border:1px solid black;" >WINS egészszám-bejegyzés túlcsordulása miatti biztonsági rés - CVE-2009-1924</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
WINS képmegjelenítő halomtúlcsordulást okozó biztonsági rése - CVE-2009-1923  
----------------------------------------------------------------------------
  
<span></span>
Távoli kódfuttatással kapcsolatos biztonsági rés van a Windows Internet Name Service (WINS) programban egy puffertúlcsordulás miatt, amit a pufferméret helytelen kiszámítása okoz a speciálisan kialakított WINS hálózati csomagok feldolgozásánál. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2009-1923](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1923).
  
#### A WINS képmegjelenítő halomtúlcsordulást okozó biztonsági résének (CVE-2009-1923) hibáit enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   Alapértelmezés szerint a WINS egyik érintett operációsrendszer-változatra sem telepített. Csak azokat az ügyfeleket érinti a probléma, akik manuálisan telepítették ezt az elemet.  
...
#### A WINS képmegjelenítő halomtúlcsordulást okozó biztonsági résének (CVE-2009-1923) lehetséges megoldásai
  
A lehetséges megoldás olyan beállítást vagy konfigurációs módosítást takar, amely magát a biztonsági rést nem szünteti meg, azonban a frissítés telepítése előtt segít az ismert támadási lehetőségek kivédésében. A Microsoft alaposan megvizsgálta a következő lehetséges megoldásokat, és tájékoztatja a felhasználókat, amennyiben a megoldás csökkenti a működőképességet:
  
-   A tűzfal 42-es TCP- és UDP-portjának tiltása.
  
    A rendszer e két port segítségével létesít kapcsolatot a távoli WINS-kiszolgálókkal. A tűzfal e két portjának letiltása megakadályozza, hogy a tűzfal mögötti rendszereket a biztonsági rés kihasználásával megtámadják. Lehetséges azonban, hogy a biztonsági rés a rendszer egyéb portjain keresztül mégis kihasználható. Az itt említett portok az esetleges támadások legvalószínűbb pontjai, ezért javasoljuk, hogy tiltsa le az internetről érkező összes kéretlen adatforgalmat.
  
#### A WINS képmegjelenítő halomtúlcsordulást okozó biztonsági résének (CVE-2009-1923) gyakran ismételt kérdései
...
A biztonsági rés amiatt keletkezik, ahogy a WINS kiszámítja pufferméretet a speciálisan kialakított WINS hálózati csomagok feldolgozásakor.
  
**Mi a WINS?**    
A WINS egy olyan protokoll, amelyet speciálisan a NetBIOS TCP/IP-kapcsolaton keresztül történő használatának (NetBT) támogatására fejlesztettek ki. A WINS használata valamennyi olyan környezetben elengedhetetlen, ahol a felhasználók NetBIOS névvel rendelkező erőforrásokhoz férnek hozzá. Ha egy ilyen hálózatban a WINS-szolgáltatást nem használják, NetBIOS nevének használatával nem tud kapcsolódni távoli hálózati erőforrásokhoz, kivéve akkor, ha Lmhosts fájlokat alkalmaz, illetve előfordulhat, hogy fájl- és nyomtatómegosztásra sem nyílik lehetőség. További információk a [WINS](http://technet.microsoft.com/en-us/library/cc784180.aspx) témájú TechNet cikkben.
...
A támadó megpróbálhatja kihasználni ezt a biztonsági rést úgy, hogy speciálisan erre a célra kialakított WINS alkalmazást küld az érintett rendszernek, amelyen WINS fut. A támadás anélkül is sikeres lehet, hogy a WINS rendszerben engedélyezve lenne a replikáció.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**    
A biztonsági rés a Windows WINS kiszolgálókat veszélyezteti.
  
**Mi a frissítés feladata?**    
A frissítés ezt a biztonsági rést úgy szünteti meg, hogy kijavítja a pufferméret kiszámításának eljárását a WINS rendszerben.
...
WINS egészszám-bejegyzés túlcsordulása miatti biztonsági rés - CVE-2009-1924  
----------------------------------------------------------------------------
  
<span></span>
Távoli kódfuttatással kapcsolatos biztonsági rés van a Windows Internet Name Service (WINS) programban az adatstruktúrák nem megfelelő értékelése miatt a megbízható WINS replikációs partnerektől kapott, speciálisan kialakított WINS hálózati csomagok esetében.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2009-1924](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1924).
  
#### A WINS egészszám-bejegyzés túlcsordulása miatti biztonsági résének (CVE-2009-1924) súlyosságát enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   Az alapértelmezett konfigurációban ez a támadás csak akkor lehet sikeres, ha egy megbízható WINS replikációs partnerről hajtják végre. A "HKLM\\System\\CCS\\Services\\WINS\\Parameteres\\RplOnlyWCnfPnrs" rendszerleíró kulcs 0 beállítása esetén azonban bárki kihasználhatja a hálózatról ezt a biztonsági rést. A rendszerleíró kulcs jellemzőinek és használatának teljes leírását lásd: [KB251067](http://support.microsoft.com/kb/251067/hu).  
-   Alapértelmezés szerint a WINS egyik érintett operációsrendszer-változatra sem telepített. Csak azokat az ügyfeleket érinti a probléma, akik manuálisan telepítették ezt az elemet.  
-   A tűzfalakra vonatkozó gyakorlati tanácsok, valamint a szabványos alapértelmezett tűzfal-konfigurációk segítséget nyújtanak a hálózatot érő, a szervezet határain kívülről eredő támadások kivédésében. Gyakorlati tanácsként azt javasoljuk, hogy az internetkapcsolattal rendelkező számítógépeken a lehető legkevesebb port legyen megnyitva.  
-   Ez a probléma csak a Windows 2000 Server Service Pack 4 alapon futó WINS rendszereket érinti.
  
#### Lehetséges megoldások a WINS egészszám-bejegyzés túlcsordulása miatti biztonsági résének (CVE-2009-1924) kiküszöbölésére
...
#### Gyakran feltett kérdések a WINS egészszám-bejegyzés túlcsordulása miatti biztonsági résével (CVE-2009-1924) kapcsolatban
...
**Mi okozza a biztonsági rést?**    
A problémát az okozza, hogy a WINS nem megfelelően értékeli és korlátozza halomterületre továbbított pufferméretet.
...
**Hogyan használhatja ki a támadó a biztonsági rést?**    
A WINS replikáció szempontjából megbízható támadó megpróbálhatja kihasználni a biztonsági rést, ha speciálisan erre a célra kialakított hálózati csomagokat hoz létre, és elküldi azokat az érintett WINS rendszernek.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**    
A biztonsági rés Windows 2000 kiszolgálón futó WINS kiszolgálókat érinti.
  
**Mi a frissítés feladata?**    
A frissítés a biztonsági résre vonatkozik, és helyes adatértékelést biztosít a WINS kiszolgálón fogadott csomagokban.
...
| **Telepítés**                              |                                                                                                                                                                                 |  
| Telepítés felhasználói beavatkozás nélkül  | Windows2000-kb969883-x86-enu /quiet                                                                                                                                             |  
| Telepítés újraindítás nélkül               | Windows2000-kb969883-x86-enu /norestart                                                                                                                                         |  
| Frissítési naplófájl                       | kb969883.log                                                                                                                                                                    |  
...
| **Információ az eltávolításhoz**           | Használja a Vezérlőpult **Programok telepítése és törlése** parancsát vagy a Spuninst.exe segédprogramot, amely a %Windir%\\$NTUninstallKB969883$\\Spuninst mappában található. |  
| **Fájlinformációk**                        | Lásd a [Microsoft Tudásbázis 969883. számú cikkét](http://support.microsoft.com/kb/969883/hu)                                                                                   |  
| **Rendszerleíró kulcsok ellenőrzése**      | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969883\\Filelist                                                                                       |
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> parancsát vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB969883$\Spuninst mappában található.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/969883/hu">Microsoft Tudásbázis 969883. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   [Tipping Point](http://www.tippingpoint.com/) és [Zero Day Initiative](http://www.zerodayinitiative.com/), a WINS képmegjelenítő halomtúlcsordulást okozó biztonsági résének (CVE-2009-1923) jelentéséért
-   LiGen, [National University of Defense Technology](http://english.nudt.edu.cn/) a WINS egészszám-bejegyzés túlcsordulás miatti biztonsági résének (CVE-2009-1924) jelentéséért
...
-   1.1 verzió (2009. augusztus 12.): Frissült az érintett szoftvereket tartalmazó táblázat, amely most már felsorolja a KB961064 tudásbáziscikket, mint az egyetlen olyat, amelyet felváltott a Microsoft MS09-008 biztonsági közlemény frissítése.
