---
TOCTitle: 'MS11-010'
Title: 'A Microsoft számú biztonsági közleménye MS11-010 - Fontos'
ms:assetid: 'ms11-010'
ms:contentKeyID: 61228659
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-010(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS11-010 - Fontos
=========================================================

A Windows futásidejű ügyfél/kiszolgáló alrendszerének biztonsági rése jogok kiterjesztését teheti lehetővé (2476687)
--------------------------------------------------------------------------------------------------------------------
...
A biztonsági frissítés a Microsoft Windows futásidejű ügyfél/kiszolgáló alrendszerének (CSRSS) közvetlenül jelentett biztonsági rését szünteti meg a Windows XP és Windows Server 2003 rendszerben. A biztonsági frissítés ezen operációs rendszerek minden támogatott kiadására nézve Fontos besorolású. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.
...
A biztonsági frissítés a biztonsági rés elhárítása érdekében javítja a felhasználói folyamatok kijelentkezéskor alkalmazott leállítási módját. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cfa10178-9859-4e03-bedc-e3f5297a0251)                           | Jogok kiterjesztése        | Fontos                           | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9f0b7b77-5b90-4a4b-97a4-0c1ce6a70126)  | Jogok kiterjesztése        | Fontos                           | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aed08b96-24cc-4e23-8fd5-c7e52f8ef41a)                  | Jogok kiterjesztése        | Fontos                           | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca7879e1-e295-445d-a658-0a31be1928cc)      | Jogok kiterjesztése        | Fontos                           | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 SP2 Itanium-alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=50855101-a15c-4c81-ad81-a7fe3f1d2026) | Jogok kiterjesztése        | Fontos                           | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
...
<th style="border:1px solid black;" >A CSRSS jogok kiterjesztését eredményező biztonsági rése - CVE-2011-0030</th>
...
A CSRSS jogok kiterjesztését eredményező biztonsági rése - CVE-2011-0030  
------------------------------------------------------------------------
  
<span></span>
A Windows futásidejű ügyfél/kiszolgáló alrendszerében (CSRSS) a folyamatok felhasználói kijelentkezéskor történő leállítási módja miatt jogok kiterjesztését lehetővé tévő biztonsági rés található. A biztonsági rést sikeresen kihasználó támadó a továbbiakban a rendszerbe bejelentkezett felhasználó tevékenységének megfigyelésére alkalmas kódot futtathat. Ennek eredménye védendő információk felderítése vagy olyan adatok elérése lehet, amelyeket az érintett rendszerbe bejelentkezett felhasználó elérhet. Ilyen bizalmas adatok lehetnek többek között a további felhasználók bejelentkezési adatai, melyeket a támadó később jogok kiterjesztésére vagy kódok más felhasználó nevében történő futtatására használhat a rendszeren. Fontos megjegyezni, hogy a biztonsági rés a támadó számára nem teszi lehetővé közvetlenül programkód futtatását vagy jogosultságok illetéktelen megszerzését. A biztonsági rés révén a támadó olyan hasznos információkat gyűjthet, amelyekkel később veszélyeztetheti az érintett rendszert. Ha a támadót követően rendszergazdai jogosultságokkal rendelkező felhasználó jelentkezik be a rendszerbe, a támadó kernel módban tetszőleges kódot futtathat. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0030).
  
#### A CSRSS jogok kiterjesztését lehetővé tévő biztonsági résének (CVE-2011-0030) súlyosságát enyhítő tényezők
...
#### Lehetséges megoldások a CSRSS jogok kiterjesztését lehetővé tévő biztonsági résének (CVE-2011-0030) kiküszöbölésére
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismételt kérdések a CSRSS jogok kiterjesztését lehetővé tévő biztonsági résével (CVE-2011-0030) kapcsolatban
...
A biztonsági rés oka az, hogy a Windows futásidejű ügyfél/kiszolgáló alrendszere (CSRSS) nem állítja le megfelelően a felhasználói folyamatokat a felhasználó rendszerből történő kijelentkezésekor.
...
A biztonsági rést sikeresen kihasználó támadó a továbbiakban a rendszerbe bejelentkezett felhasználó tevékenységének megfigyelésére alkalmas kódot futtathat. Ennek eredménye védendő információk felderítése vagy olyan adatok elérése lehet, amelyeket az érintett rendszerbe bejelentkezett felhasználó elérhet. Ilyen bizalmas adatok többek között a hitelesítő adatok, melyeket a támadó később jogok kiterjesztésére vagy más felhasználó nevében történő kódfuttatásra használhat a rendszeren. A bizalmas információk megszerzését követően a biztonsági rést sikeresen kihasználó támadó a továbbiakban a rendszerbe bejelentkezett felhasználó jogosultsági szintjén kódot futtathat. Ha rendszergazda jelentkezett be, a támadó programkódja kiemelt jogosultságokkal hajtódhat végre.
  
**Hogyan használhatja ki a támadó a biztonsági rést?**    
A biztonsági rés kihasználásához a támadónak először be kell jelentkeznie a rendszerbe, A támadó ekkor elindíthat egy olyan speciálisan kialakított alkalmazást, amely a támadó kijelentkezését követően is tovább fut. Amikor bejelentkezik egy új felhasználó saját hitelesítő adataival, a támadó által indított folyamat megfigyelheti az újonnan bejelentkezett felhasználó által végrehajtott minden műveletet. Ha az újonnan bejelentkezett felhasználó rendszergazda, a megszerzett információkkal később fokozottabban veszélyeztethető az érintett rendszer.
...
A frissítés a biztonsági rés elhárítása érdekében javítja a felhasználói folyamatok kijelentkezéskor alkalmazott leállítási módját.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2476687$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2476687">Microsoft Tudásbázis 2476687. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   Sihan Qing (egyetemi tanár), Weiping Wen (tanársegéd), Liang Yi és Husheng Zhou (egyetemi hallgatók), [Pekingi Egyetem, Informatikai Tanszék](http://www.ss.pku.edu.cn/en/), a CSRSS jogok kiterjesztését lehetővé tévő biztonsági résének (CVE-2011-0030) jelentéséért
