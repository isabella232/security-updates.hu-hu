---
TOCTitle: 'MS11-098'
Title: 'A Microsoft számú biztonsági közleménye MS11-098 - Fontos'
ms:assetid: 'ms11-098'
ms:contentKeyID: 61228845
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-098(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS11-098 - Fontos
=========================================================

A Windows kernel jogok kiterjesztését lehetővé tévő biztonsági rése (2633171)
-----------------------------------------------------------------------------

Közzétéve: 2011. december 13. | Frissítve: 2012. február 1.
...
Ez a fontos besorolású biztonsági frissítés a Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 és a Windows 7 összes támogatott 32 bites kiadását érinti. További információkért lásd az **Érintett és nem érintett szoftverek** alfejezetet.

A biztonsági frissítés a biztonsági rés megszüntetése érdekében biztosítja, hogy a Windows rendszermag megfelelően inicializálja a memóriában lévő objektumokat. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.

**Javaslat:** Ha a rendszergazda, vállalati telepítő vagy végfelhasználó manuálisan szeretné telepíteni a biztonsági frissítést, a Microsoft a minél előbbi telepítést javasolja frissítéskezelő szoftver vagy a [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) szolgáltatás igénybevételével.

Lásd még a közlemény **Észlelési és telepítési eszközök, útmutatás** fejezetét.

**Ismert problémák.** A [Microsoft Tudásbázis 2633171. számú cikkében](http://support.microsoft.com/kb/2633171) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                                           | Jogok kiterjesztése        | Fontos                           | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                                  | Jogok kiterjesztése        | Fontos                           | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                                        | Jogok kiterjesztése        | Fontos                           | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows Server 2008 32 bites rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                        | Jogok kiterjesztése        | Fontos                           | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows 7 32 bites rendszerekhez és Windows 7 32 bites rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | Jogok kiterjesztése        | Fontos                           | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
...
<th style="border:1px solid black;" >A Windows rendszermag kivételkezelőjének biztonsági rése - CVE-2011-2018</th>
...
A Windows rendszermag kivételkezelőjének biztonsági rése - CVE-2011-2018  
------------------------------------------------------------------------
  
<span></span>
A Windows rendszermagban a nem megfelelően inicializált objektumok hozzáférési módja miatt jogok kiterjesztését lehetővé tévő biztonsági rés található. A biztonsági rést sikeresen kihasználó támadó kernel módban mesterséges kódot futtathat az érintett rendszeren. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-2018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018).
  
#### A Windows rendszermag kivételkezelője biztonsági résének (CVE-2011-2018) súlyosságát enyhítő tényezők
...
#### A Windows rendszermag kivételkezelője biztonsági résének (CVE-2011-2018) lehetséges megoldásai
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismételt kérdések a Windows rendszermag kivételkezelője biztonsági résével (CVE-2011-2018) kapcsolatban
...
A biztonsági rés akkor keletkezik, amikor a Windows rendszermag hozzáfér egy olyan objektumhoz, amely nem megfelelően lett inicializálva.
...
A frissítés a biztonsági rés megszüntetése érdekében biztosítja, hogy a Windows rendszermag megfelelően inicializálja a memóriában lévő objektumokat.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2633171$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2633171">Microsoft Tudásbázis 2633171. számú cikkét</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Használja a Vezérlőpult **Programok telepítése és törlése** lehetőségét vagy a %Windir%\\$NTUninstallKB2633171$\\Spuninst mappában található Spuninst.exe segédprogramot
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Lásd a [Microsoft Tudásbázis 2633171. számú cikkét](http://support.microsoft.com/kb/2633171)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Matthew Jurczyk, a [VeriSign iDefense Labs](http://labs.idefense.com/) szervezettel együttműködésben, a Windows rendszermag kivételkezelője biztonsági résének (CVE-2011-2018) jelentéséért
...
-   V1.1 (2012. február 1.): Új hivatkozás a Microsoft Tudásbázis 2633171 sz. cikkére az Összefoglalás rész Ismert problémák c. szakaszában.
