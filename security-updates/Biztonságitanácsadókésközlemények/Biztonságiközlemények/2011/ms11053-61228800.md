---
TOCTitle: 'MS11-053'
Title: 'A Microsoft számú biztonsági közleménye MS11-053 - Kritikus'
ms:assetid: 'ms11-053'
ms:contentKeyID: 61228800
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-053(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS11-053 - Kritikus
===========================================================

A Bluetooth verem biztonsági rése (2566220) távolról történő programkódfuttatást tehet lehetővé
-----------------------------------------------------------------------------------------------
...
Ez a kritikus besorolású biztonsági frissítés a Windows Vista és a Windows 7 összes támogatott kiadására vonatkozik. További információkért lásd az **Érintett és nem érintett szoftverek** című részt ebben a fejezetben.

A biztonsági frissítés a biztonsági rés kiküszöböléséhez módosítja a Windows Bluetooth Stack memóriaobjektumok kezelését érintő módját. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
**Ismert problémák** A[Microsoft Tudásbázis 2566220 számú cikkében](http://support.microsoft.com/kb/2566220) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7f811b75-c3ff-411a-aaa9-126dce34cc01">Windows 7 32 bites rendszerekhez és Windows 7 32 bites rendszerekhez Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Nincsenek</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa">Windows 7 x64 alapú rendszerekhez és Windows 7 x64 alapú rendszerekhez Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Nincsenek</td>
...
<sup>[1]</sup> A Windows Vista Service Pack 1 csak akkor érintett, ha a Windows Vista Feature Pack for Wireless lett telepítve. Lásd a gyakori frissítési kérdéseket.
...
**A rendszeren Windows Vista Service Pack 1. fut.** **Érinti a rendszert a biztonsági rés?**    
A Windows Vista Service Pack 1 csak akkor érintett, ha a rendszer támogatja a Bluetooth 2.1 technológiát. Azok a Windows Vista Service Pack 1 csomagot használó ügyfelek, akik telepítették a [Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567) alkalmazást Bluetooth 2.1 technológiát használnak, melyre hatással van a biztonsági rés. Ezeknek az ügyfeleknek szükséges telepíteniük a KB2561109 biztonsági frissítést. Azok az ügyfelek, akik nem telepítették a Windows Vista Feature Pack for Wireless alkalmazást, nem használnak Bluetooth 2.1 technológiát, ezért rájuk nincs hatással a biztonsági rés. További tudnivalókat a [Microsoft Tudásbázis 2566220. számú cikkében](http://support.microsoft.com/kb/2566220) talál.
  
**Telepítettem a Windows Vista Feature Pack for Wireless alkalmazást a Wireless for Windows Vista Service Pack 1 alkalmazáshoz, de a rendszer frissítette a Windows Vista Service Pack 2 alkalmazást. Melyik frissítést telepítsem?**    
Azok a Windows Vista Service Pack 1 csomagot használó ügyfelek, akik bekapcsolták a [Windows Vista Feature Pack for Wireless](http://support.microsoft.com/kb/942567) alkalmazást és sikeresen frissítették a Windows Vista Service Pack 2 alkalmazást, telepíteniük kell a KB2532531 biztonsági frissítést. További tudnivalókat a [Microsoft Tudásbázis 2566220. számú cikkében](http://support.microsoft.com/kb/2566220) talál.
...
<th style="border:1px solid black;" >Bluetooth köteg biztonsági rés - CVE-2011-1265</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
Bluetooth köteg biztonsági rés - CVE-2011-1265  
----------------------------------------------
  
<span></span>
A Windows Bluetooth 2.1 Stack alkalmazásban távoli kódvégrehajtást lehetővé tevő biztonsági rés jelentkezett, miközben az objektum nem megfelelő inicializálás vagy törlés közben próbált hozzáférni a memóriához. A biztonsági rés távolról történő programkódfuttatást tehet lehetővé, ha a támadó speciálisan kialakított Bluetooth csomagokat küld az érintett rendszernek. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265).
  
#### A Bluetooth verem biztonsági résének hibáit enyhítő tényezők - CVE-2011-1265
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   Ez a biztonsági rés csupán a Bluetooth-kompatibilis rendszereket érinti.
  
#### Lehetséges megoldások a Bluetooth verem biztonsági résére - CVE-2011-1265
  
A lehetséges megoldás olyan beállítást vagy konfigurációs módosítást takar, amely magát a biztonsági rést nem szünteti meg, azonban a frissítés telepítése előtt segít az ismert támadási lehetőségek kivédésében. A Microsoft alaposan megvizsgálta a következő lehetséges megoldásokat, és tájékoztatja a felhasználókat, amennyiben a megoldás csökkenti a működőképességet:
  
-   **Állítsa le és tiltsa le a Bluetooth-illesztőprogramot**
  
    Az illesztőprogramot úgy állíthatja és tilthatja le, hogy a parancssorba a következő parancsot írja be:
  
    `sc config bthport start= disabled`
  
    **A megoldás visszavonása.**
  
    A Bluetooth illesztőprogramot úgy engedélyezheti újra, hogy a parancssorba a következő parancsot írja be:
  
    `sc config bthport start= demand`
  
#### Gyakran ismételt kérdések a Bluetooth verem biztonsági résével kapcsolatban - CVE-2011-1265
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés távolról történő kódfuttatást tehet lehetővé.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rést az okozza, hogy a Windows Bluetooth Stack hibásan inicializált vagy törölt memóriaobjektumokhoz fér hozzá.
...
Ennek a biztonsági résnek a kihasználásához, a támadónak a célszámítógéppel megegyező kapcsolatot kell használnia, hogy Bluetooth rádió spektrumú rádióadást tudjon küldeni és fogadni. Ezek után a biztonsági rés kihasználható, ha a támadó speciálisan kialakított Bluetooth csomagokat küld a célszámítógépre.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**    
A biztonsági rés elsősorban a munkaállomásokat veszélyezteti.
  
**Windows Vista vagy Windows 7 munkaállomásom nem támogatja a Bluetooth technológiát. Érinthet ez a probléma?**    
Igen. A Windows Vista és Windows 7 rendszerek a Bluetooth rádióeszközök széles spektrumát támogatják. A Bluetooth illesztőprogramot eltvávolítható Bluetooth készülék csatlakoztatásakor telepíti a rendszer. Ezért a Windows Vista és Windows 7 minden támogatott verzióját érinti a probléma. További információkért olvassa el az MSDN [Bluetooth vezeték nélküli technológia, GYIK - 2010](http://msdn.microsoft.com/en-us/windows/hardware/gg487349.aspx) című cikkét.
  
**Mi a frissítés feladata?**    
A frissítés a biztonsági rés kiküszöböléséhez módosítja a Windows Bluetooth 2.1 Stack memóriaobjektumok kezelését érintő módját.
...
<td style="border:1px solid black;">A Windows Vista Service Pack 1 32 bites verziójához, engedélyezett Windows Vista Feature Pack for Wireless alkalmazással:<br />
Windows6.0-KB2561109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows Vista Service Pack 2 összes támogatott 32 bites kiadása esetén:<br />
Windows6.0-KB2532531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows Vista Service Pack 1 x64 alapú verziójához, engedélyezett Windows Vista Feature Pack for Wireless alkalmazással:<br />
Windows6.0-KB2561109-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows Vista Service Pack 2 összes támogatott x64 alapú kiadása esetén:<br />
...
<td style="border:1px solid black;">A Windows Vista Service Pack 1 alkalmazáshoz, engedélyezett Windows Vista Feature Pack for Wireless alkalmazással:<br />
Lásd a <a href="http://support.microsoft.com/kb/2561109">Microsoft Tudásbázis 2561109. számú cikkét</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Vista Service Pack 2 csomaghoz<br />
Lásd a <a href="http://support.microsoft.com/kb/2532531">Microsoft Tudásbázis 2532531. számú cikkét</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2532531">Microsoft Tudásbázis 2532531. számú cikkét</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Beállításkulcsok hitelesítése</strong></td>
<td style="border:1px solid black;"><strong>Megjegyzés</strong> A frissítés meglétének ellenőrzéséhez nincs beállításkulcs.</td>
