---
TOCTitle: 'MS08-066'
Title: 'A Microsoft számú biztonsági közleménye MS08-066 - Fontos'
ms:assetid: 'ms08-066'
ms:contentKeyID: 61228277
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms08-066(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS08-066 - Fontos
=========================================================

A Microsoft kiegészítő funkció-illesztőprogramjában a jogosultság illetéktelen megszerzését lehetővé tévő biztonsági rés (956803)
---------------------------------------------------------------------------------------------------------------------------------

Közzétéve: 2008. október 14. | Frissítve: 2009. január 13.
...
A Windows XP és a Windows Server 2003 összes támogatott kiadására nézve ez a biztonsági frissítés fontos besorolásúnak minősül. További tudnivalókért tekintse meg az **Érintett és nem érintett szoftvereket** felsoroló részt.

Ez a biztonsági frissítés azzal szünteti meg a biztonsági rést, hogy helyesen érvényesíti a Windows Kernel részére továbbított, az AFD összetevőn át a felhasználói módból érkező beviteli adatokat. A biztonsági réssel kapcsolatos bővebb információkat lásd az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben.

**Javaslat.** A Microsoft a biztonsági frissítés lehető leghamarabb történő telepítését javasolja ügyfeleinek.

**Ismert problémák** A [Microsoft Tudásbázis 956803 számú](http://support.microsoft.com/kb/956803) cikkében olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Windows XP Service Pack 2 és Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9)                                                     | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows XP Professional x64 Edition és Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3)                  | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 Service Pack 1 és Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074)                                   | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 x64 Edition és Windows Server 2003 x64 Edition Service Pack 2 rendszerhez](http://www.microsoft.com/downloads/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25)              | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 SP1 Itanium alapú rendszerekhez és Windows Server 2003 SP2 Itanium alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517) | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
...
A Microsoft az észlelés változásának bejelentésével módosította a biztonsági közleményt. A javítás következményeképpen az észlelési funkció a biztonsági frissítést olyan érintett rendszereknek ajánlja fel, amelyeknek korábban nem. A rendszerüket sikeresen frissített felhasználóknak nem kell újra telepíteniük a frissítést.

**Hol találhatók a fájlinformációs adatok?**  
A fájlinformációs adatok a [Microsoft Tudásbázis 956803. számú cikkében](http://support.microsoft.com/kb/956803) találhatók.

**Milyen ismert problémákkal találkozhatnak a felhasználók a biztonsági frissítés telepítésekor?**  
A [Microsoft Tudásbázis 956803 cikkében](http://support.microsoft.com/kb/956803) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen, jelenleg már ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
<th style="border:1px solid black;" >AFD Kernel-felülírás miatti biztonsági rés - CVE-2008-1451</th>
...
AFD Kernel-felülírás miatti biztonsági rés - CVE-2008-1451  
----------------------------------------------------------
  
<span></span>
A jogok kiterjesztését lehetővé tévő biztonsági rés a Microsoft kiegészítő funkció-illesztőprogramjában (afd.sys) található, oka a felhasználói módban küldött beviteli adatok helytelen hitelesítése a Windows kernelen. A biztonsági rést kihasználó támadó kiterjesztett jogosultságokkal végezhet kódfuttatást az érintett rendszeren. Ha egy helyi támadó kihasználja a biztonsági rést, távolról tetszőleges kódot futtathat és teljes mértékben átveheti az érintett rendszer irányítását. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2008-3464](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464).
  
#### AFD Kernel-felülírás miatti biztonsági rés - CVE-2008-3464 - súlyosságát enyhítő tényezők
...
#### AFD Kernel-felülírás miatti biztonsági rést - CVE-2008-3464 - elkerülő megoldások
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran feltett kérdések az AFD Kernel-felülírás miatti biztonsági résről - CVE-2008-3464
...
Az AFD összetevő nem megfelelően érvényesíti a felhasználó általi bevitelt, amikor a felhasználói módból adatokat továbbít a kernel részére.
  
**Mi az AFD összetevő?**    
Az afd.sys fájlban lévő AFD összetevő biztosítja a "kiegészítő funkcióillesztést", ami a Windows szoftvercsatornás alkalmazásait támogatja. Az afd.sys illesztőprogram kernel módban fut, és a Winsock TCP/IP kommunikációs protokollt kezeli. Ez a Winsock Kernel Interface biztosítja a TDI átvitelek elérését. Az AFD összetevőről további információkat a következő [Microsoft weboldalon](http://msdn.microsoft.com/en-us/library/aa940505,aspx) találhat.
  
**Mi a TDI összetevő?**  
A Transport Driver Interface (TDI) olyan kernel módú hálózati csatoló felületet biztosít, amelyik az összes átviteli protokoll fölött helyezkedik el. A legmagasabb szintű protokollillesztő minden ilyen halmazban a TDI felületet támogatja a még magasabb szintű, kernel módú hálózati ügyfeleknél. A TDI összetevőről további információkat a következő [Microsoft weboldalon](http://msdn.microsoft.com/en-us/library/ms801224,aspx) találhat.
...
Ez a frissítés azzal szünteti meg a biztonsági rést, hogy helyesen érvényesíti a Windows Kernel részére továbbított, az AFD összetevőn át a felhasználói módból érkező beviteli adatokat.
...
<td style="border:1px solid black;">Használja a Vezérlőpult Programok telepítése és törlése lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB956803$\Spuninst mappában található</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/956803">Microsoft Tudásbázis 956803. számú cikkét</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Információ az eltávolításhoz</strong></td>
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB956803$\Spuninst mappában található</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/956803">Microsoft Tudásbázis 956803. számú cikkét</a></td>
...
-   Fabien Le Mentec, [SkyRecon](http://www.skyrecon.com/) az AFD Kernel-felülírás miatti biztonsági résről (CVE-2008-3464) adott jelentéséért
...
-   1.1 verzió (2009. január 13.): A **Gyakran ismételt kérdések a biztonsági frissítéssel kapcsolatban** című rész a biztonsági frissítés észlelési funkciójának módosítását taglaló bejegyzéssel bővült. A javított észlelési funkció a biztonsági frissítést olyan érintett rendszereknek ajánlja fel, amelyeknek korábban nem. A rendszerüket sikeresen frissített felhasználóknak nem kell újra telepíteniük a frissítést.
