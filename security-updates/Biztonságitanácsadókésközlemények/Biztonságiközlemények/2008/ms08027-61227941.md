---
TOCTitle: 'MS08-027'
Title: 'A Microsoft számú biztonsági közleménye MS08-027 - Kritikus'
ms:assetid: 'ms08-027'
ms:contentKeyID: 61227941
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms08-027(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS08-027 - Kritikus
===========================================================

A Microsoft Publisher biztonsági rése távolról történő programkódfuttatást tehet lehetővé (951208)
--------------------------------------------------------------------------------------------------

Közzétéve: 2008. május 13. | Frissítve: 2008. június 4.
...
A biztonsági frissítés besorolása a Microsoft Office Publisher 2000 Service Pack 3 esetén kritikus, a Microsoft Publisher 2002, Microsoft Office Publisher 2003 és Microsoft Office Publisher 2007 támogatott verziói esetén pedig fontos. További tudnivalókért tekintse meg az **Érintett és nem érintett szoftverek** c. részt.
...
A fájlinformációs adatok a [Microsoft Tudásbázis 951208 számú cikkében találhatók](http://support.microsoft.com/kb/951208).
  
**A cikkben említett Microsoft Office összetevő ugyan a rendszeremre telepített Office csomag része; viszont nem telepítettem az adott összetevőt. Felajánlják nekem a frissítést?**    
Igen, ha a rendszerre telepített Microsoft Office csomag része a közleményben tárgyalt összetevő, annak telepítésétől függetlenül felajánljuk a rendszerhez a frissítéseket. Az érintett rendszerek vizsgálatára használt észlelési logikát úgy alakították ki, hogy az adott Microsoft Office csomagban lévő összes összetevőhöz tartozó frissítést ellenőrizze és felajánlja a rendszernek. Azok a felhasználók, akik úgy döntenek, hogy nem alkalmazzák a nem telepített, de a Microsoft Office csomaghoz tartozó összetevő frissítését, nem növelik a rendszer biztonsági kockázatát. Azok esetében pedig, akik úgy döntenek, hogy telepítik a frissítést, ez nem jár negatív hatással a rendszer biztonságára és teljesítményére. A probléma részletes ismertetése a [Microsoft Tudásbázis 830335. számú cikkében](http://support.microsoft.com/kb/830335) olvasható.
...
<th style="border:1px solid black;" >A Publisher objektumkezelő érvényesítés miatti biztonsági rése - CVE-2008-0119</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
A Publisher objektumkezelő érvényesítés miatti biztonsági rése - CVE-2008-0119  
------------------------------------------------------------------------------
  
<span></span>
A Microsoft Office Publisher objektumfejléceket érintő ellenőrzési módja távoli kódvégrehajtást lehetővé tévő biztonsági rést okoz. A támadó úgy használhatja ki a biztonsági rést, hogy különlegesen kialakított Publisher fájlt küld e-mail mellékletként, illetve rosszindulatú vagy sérült biztonságú webhelyen helyezi el.
...
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2008-0119](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0119).
  
#### A Publisher objektumkezelő érvényesítés miatti biztonsági résének (CVE-2008-0119) súlyosságát enyhítő tényezők
...
-   Az Office Document Open Confirmation Tool for Office 2000 eszközét telepítő felhasználókat a rendszer a dokumentum megnyitása előtt megnyitásra, mentésre vagy a művelet mellőzésére kéri fel. Az [Office Document Open Confirmation Tool](http://www.microsoft.com/downloads/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f) eszköz az Office XP és az Office későbbi kiadásainak részét képezi.
  
#### A Publisher objektumkezelő érvényesítés miatti biztonsági résének (CVE-2008-0119) lehetséges megoldásai
...
#### Gyakran feltett kérdések a Publisher objektumkezelő érvényesítés miatti biztonsági résével (CVE-2008-0119) kapcsolatban
...
**Mi az objektumkezelő, és mi a funkciója?**    
Az objektumkezelő az OLE-kiszolgáló alkalmazások dinamikus csatolású függvénytára (DLL). Ez a DLL közvetítő szerepet játszik az ügyfél- és kiszolgálóalkalmazások között; például szükség esetén javítja a teljesítményt az ügyfélalkalmazás ablakában lévő objektum újrarajzolásához.
...
A frissítés a biztonsági rést az objektumkezelő adatainak a Publisher fájlok megnyitásakor történő helyes érvényesítésével szünteti meg.
...
| Szoftver                                       | MBSA 2.1 |  
|------------------------------------------------|----------|  
| Microsoft Office Publisher 2000 Service Pack 3 | Nem      |  
| Microsoft Office Publisher 2002 Service Pack 3 | Igen     |  
| Microsoft Office Publisher 2003 Service Pack 2 | Igen     |  
| Microsoft Office Publisher 2003 Service Pack 3 | Igen     |  
| Microsoft Office Publisher 2007                | Igen     |  
...
|------------------------------------------------|---------|--------------------------|-----------------------------|-----------|  
| Microsoft Office Publisher 2000 Service Pack 3 | Igen    | Igen                     | Nem                         | Nem       |  
| Microsoft Office Publisher 2002 Service Pack 3 | Igen    | Igen                     | Igen                        | Igen      |  
| Microsoft Office Publisher 2003 Service Pack 2 | Igen    | Igen                     | Igen                        | Igen      |  
| Microsoft Office Publisher 2003 Service Pack 3 | Igen    | Igen                     | Igen                        | Igen      |  
| Microsoft Office Publisher 2007                | Nem     | Nem                      | Igen                        | Igen      |  
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/951208">Microsoft Tudásbázis 951208. számú</a> cikkét</td>
</tr>
<tr class="even">
...
| **Telepítés**                              |                                                                                                                                                                             |  
| Telepítés felhasználói beavatkozás nélkül  | publisher2007-kb950114-fullfile-x86-glb /passive                                                                                                                            |  
| Telepítés újraindítás nélkül               | publisher2007-kb950114-fullfile-x86-glb /norestart                                                                                                                          |  
| Frissítési naplófájl                       | A /log kapcsolóval aktiválható a részletes naplózás. A további tudnivalókat a [Microsoft Tudásbázis 912203. számú](http://support.microsoft.com/kb/912203) cikke ismerteti. |  
...
| **Fájlinformációk**                        | Lásd a [Microsoft Tudásbázis 951208. számú](http://support.microsoft.com/kb/951208) cikkét                                                                                  |  
...
-   Cocoruder, [Fortinet Security Research](http://www.fortinet.com/), a Publisher objektumkezelő érvényesítés miatti biztonsági résének (CVE-2008-0119) jelentéséért.
...
-   1.1 verzió (2008. június 4.): Új hivatkozás a Microsoft Tudásbázis 951208. cikkére az Összefoglalás rész Ismert problémák szakaszában.
