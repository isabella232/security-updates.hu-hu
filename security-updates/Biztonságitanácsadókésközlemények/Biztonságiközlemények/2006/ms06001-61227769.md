---
TOCTitle: 'MS06-001'
Title: 'A Microsoft számú biztonsági közleménye MS06-001 - Kritikus'
ms:assetid: 'ms06-001'
ms:contentKeyID: 61227769
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms06-001(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS06-001 - Kritikus
===========================================================

A képmegjelenítő rendszer biztonsági rése távoli kódfuttatást tehet lehetővé (912919)
-------------------------------------------------------------------------------------

Közzétéve: 2006. január 5.
...
-   Microsoft Windows 2000 Service Pack 4 – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=aa9e27bd-cb9a-4ef1-92a3-00ffe7b2ac74)
-   Microsoft Windows XP Service Pack 1 és Microsoft Windows XP Service Pack 2 – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=0c1b4c96-57ae-499e-b89b-215b7bb4d8e9)
-   Microsoft Windows XP Professional x64 Edition – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=3a1166e6-5e9e-4e73-bcd4-28eca6ece877)
-   Microsoft Windows Server 2003 és Microsoft Windows Server 2003 Service Pack 1 – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=1584aae0-51ce-47d6-9a03-db5b9077f1f2)
-   Microsoft Windows Server 2003, Itanium alapú rendszerekhez és Microsoft Windows Server 2003 SP1 javítócsomaggal, Itanium alapú rendszerekhez - [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=6e372d41-2c16-415e-8306-a5ca8845cc09)
-   Microsoft Windows Server 2003 x64 Edition – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=a8f4dcba-5d28-4d9d-a6a4-3b71108cfe2d)
...
**Megjegyzés** A biztonsági rést jelenleg is kihasználják, korábban már volt róla szó a 912840. számú Microsoft biztonsági tanácsadóban.
...
<th>Windows 98, Windows 98 SE és Windows ME</th>
<th>Windows 2000</th>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">A képmegjelenítő rendszer biztonsági rése - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2005-4560">CVE-2005-4560</a></td>
<td style="border:1px solid black;">Távoli kódfuttatás<br />
</td>
<td style="border:1px solid black;">Nem kritikus</td>
...
Igen. A biztonsági frissítés kiküszöbölésére bemutatott módosítás eltávolítja a SETABORTPROC bejegyzéstípus támogatását a WMF-kép META\_ESCAPE bejegyzéséből. A frissítés nem távolítja el az ABORTPROC funkciók támogatását, amelyet az alkalmazás SetAbortProc() API hívásai regisztráltak.
...
A Windows ezen változataihoz a Microsoft csak a kritikus biztonsági résekre ad ki javításokat. A nem kritikus hibákhoz a jelen támogatási időszakban nem jár frissítés. Ha többet szeretne tudni a Microsoft támogatási életciklusokkal kapcsolatos irányelveiről, látogasson el erre a [webhelyre](http://go.microsoft.com/fwlink/?linkid=33327)
...
Nem. Bár a Windows 98, Windows 98 Second Edition és a Windows Millennium Edition rendszerek tartalmazzák az érintett összetevőt, a biztonsági rés ezeknél a rendszereknél nem kritikus, mert az ismertté vált támadások nem merítették ki a kritikus szintet. A biztonsági rések súlyossági minősítéséről további információt talál ezen a [webhelyen](http://go.microsoft.com/fwlink/?linkid=21140).
...
Az SMS által használható Security Update Inventory Tool segítségével a [Software Update Services](http://go.microsoft.com/fwlink/?linkid=21133) által támogatott [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) frissítések és az MBSA 1.2.1 által támogatott biztonsági frissítések kereshetők. A Security Update Inventory Tool eszközzel kapcsolatos további tájékoztatást a következő [Microsoft webhely](http://www.microsoft.com/smserver/downloads/2003/featurepacks/suspack) tartalmaz: A Security Update Inventory Tool korlátozásaival kapcsolatban tekintse meg a [Microsoft Tudásbázis 306460 számú cikkét](http://support.microsoft.com/kb/306460/hu).
...
<span></span>
#### A képmegjelenítő rendszer biztonsági rése - CVE-2005-4560:
...
#### A képmegjelenítő rendszer biztonsági rése (CVE-2005-4560) által okozott hibát enyhítő tényezők:
...
#### Lehetséges megoldások a képmegjelenítő rendszer biztonsági résének (CVE-2005-4560) elhárításához:
  
A Microsoft az alábbi megoldásokat tesztelte. Ez a megoldás a biztonsági rést nem szünteti meg, azonban segít az ismert támadások elhárításában.
  
-   **Hajtsa végre a kép- és faxmegjelenítő (Shimgvw.dll) Windows XP Service Pack 1; Windows XP Service Pack 2; Windows Server 2003 és Windows Server 2003 Service Pack 1 rendszeren futó változatainak deregisztrálását.**
    ...
    **Megjegyzés** A megoldás webalapú támadások ellen hasznos, nem használható a fájlokba beágyazott Windows metafájlok felhasználásával végrehajtott támadások ellen.
    ...
    **Megjegyzés** A következő lépések végrehajtásához rendszergazdai jogosultság szükséges. A műveletek végrehajtását követően ajánlott a számítógép újraindítása. Az újraindítás helyett ki is jelentkezhet, majd ismét be is jelentkezhet a rendszerbe. Azonban az ajánlott módszer továbbra is a számítógép újraindítása.
    ...
    A Shimgvw.dll regisztrációjának törléséhez a következő lépéseket hajtsa végre:
  
    1.  Kattintson a **Start** menü **Futtatás** parancsára, írja be a következő parancsot „**regsvr32 -u %windir%\\system32\\shimgvw.dll**” (az idézőjelek nélkül), majd kattintson az **OK** gombra.  
    2.  Ha a folyamat sikeres befejezéséről értesítő párbeszédpanel megjelenik, kattintson az **OK** gombra.
  
    **A megoldás hatása:** A Windows kép- és faxmegjelenítő többé nem indul el akkor, ha a felhasználó a programmal társított képhez vezető hivatkozásra kattint.
  
    Ha a megoldást vissza kívánja vonni a biztonsági frissítés telepítését követően, deregisztrálnia kell a Shimgvw.dll fájlt. Ehhez ugyanezt az eljárást kell követnie, de az 1. lépésben a szöveget cserélje fel erre: **„regsvr32 %windir%\\system32\\shimgvw.dll”** (az idézőjelek nélkül).
  
#### Gyakran ismételt kérdések a képmegjelenítő rendszer biztonsági résével (CVE-2005-4560) kapcsolatban:
...
A képtípusokról és képformátumokról további tudnivalókat a [Microsoft Tudásbázis 320314](http://support.microsoft.com/kb/320314/hu) számú cikkében talál. Az említett fájlformátumokról emellett az [MSDN Library webhelyén](http://msdn.microsoft.com/library/default.asp?url=/library/en-us/gdicpp/gdiplus/aboutgdiplus/imagesbitmapsandmetafiles/metafiles.asp) is olvashat.
...
A támadó úgy is kihasználhatja a biztonsági rést, hogy egy speciálisan kialakított Windows metafájl (WMF) képet ágyaz be más fájlokba, pl. Word dokumentumokba, majd ráveszi a felhasználót, hogy nyissa meg azokat.
...
**Védelmet nyújt-e a jelen közleményben közzétett megoldás a biztonsági rés megváltoztatott kiterjesztésű WMF-képeken keresztüli kihasználása ellen?**  
Igen. A közleményben ismertetett megoldás biztos védelmet nyújt a megváltoztatott WMF-fájlok esetében. Ez a megoldás csak akkor hatásos, ha a Windows kép- és faxmegjelenítőt (Shimgvw.dll) megnyitották. A megoldás webalapú támadások ellen hasznos, nem használható a fájlokba beágyazott Windows metafájlok felhasználásával végrehajtott támadások ellen.
...
A biztonsági frissítés kiküszöbölésére bemutatott módosítás eltávolítja a SETABORTPROC bejegyzéstípus támogatását a WMF-kép META\_ESCAPE bejegyzéséből. A frissítés nem távolítja el az ABORTPROC funkciók támogatását, amelyet az alkalmazás SetAbortProc() API hívásai regisztráltak.
  
**Ismert volt-e a nyilvánosság előtt ez a biztonsági rés az említett közlemény kiadásának idején?**  
Igen. Ez a biztonsági rés nyilvánosságra került. A normál biztonsági rés besorolást és a CVE-2005-4560 azonosítót kapta.
...
Igen. Ez a biztonsági frissítés megszünteti a jelenleg kihasznált biztonsági rést. A biztonsági rés a CVE-2005-4560 normál biztonsági rés azonosítót kapta.
  
**Mi a Microsoft véleménye a WMF biztonsági résére vonatkozó, külső szállítók által kifejlesztett javításokról?**  
...
A független külső féltől származó frissítésekre a Microsoft nem vállal felelősséget.
  
**Milyen kapcsolatban áll ez a biztonsági rés a MS05-053 jelű közleményben javított biztonsági réssel?**  
Mindkét biztonsági rés a képmegjelenítő rendszer része. Ez a frissítés azonban egy olyan, újonnan felfedezett biztonsági réshez készült, melyet az MS05-053 jelű frissítés nem hivatott megszüntetni. Az MS05-053 jelű frissítés elősegíti az azonos jelű közleményben tárgyalt biztonsági rés kihasználásának megakadályozását, de az e közleményben tárgyalt új biztonsági rését nem. Ez a frissítés nem váltja fel az MS05-053 jelű frissítést. Ahhoz, hogy mindkét biztonsági rést megszüntesse, telepítenie kell mind ezt, mind az MS05-053 jelű biztonsági közleményben kiadott frissítést.
...
A rendszergazdák a biztonsági javítás eltávolításához az Spuninst.exe segédprogramot is használhatják. A Spuninst.exe segédprogram a %Windir%\\$NTUninstallKB912919$\\Spuninst mappában található.
...
|-----------|---------------|---------------|---------|---------|--------|
| Gdi32.dll | 5.2.3790.462  | 2005. 12. 31. | 04:23   | 271 872 | RTMGDR |
| Gdi32.dll | 5.2.3790.462  | 2005. 12. 31. | 04:37   | 272 384 | RTMQFE |
| Gdi32.dll | 5.2.3790.2606 | 2005. 12. 31. | 04:12   | 281 600 | SP1GDR |
| Gdi32.dll | 5.2.3790.2606 | 2005. 12. 31. | 04:25   | 282 112 | SP1QFE |
...
|------------|---------------|---------------|---------|---------|-------|-------------|
| Gdi32.dll  | 5.2.3790.462  | 2005. 12. 31. | 04:48   | 806 912 | IA-64 | RTMGDR      |
| Wgdi32.dll | 5.2.3790.462  | 2005. 12. 31. | 04:48   | 250 880 | x86   | RTMGDR\\WOW |
| Gdi32.dll  | 5.2.3790.462  | 2005. 12. 31. | 04:50   | 808 448 | IA-64 | RTMQFE      |
| Wgdi32.dll | 5.2.3790.462  | 2005. 12. 31. | 04:50   | 251 392 | x86   | RTMQFE\\WOW |
| Gdi32.dll  | 5.2.3790.2606 | 2005. 12. 31. | 05:09   | 907 264 | IA-64 | SP1GDR      |
| Wgdi32.dll | 5.2.3790.2606 | 2005. 12. 31. | 05:09   | 285 184 | x86   | SP1GDR\\WOW |
| Gdi32.dll  | 5.2.3790.2606 | 2005. 12. 31. | 04:50   | 907 264 | IA-64 | SP1QFE      |
| Wgdi32.dll | 5.2.3790.2606 | 2005. 12. 31. | 04:50   | 285 184 | x86   | SP1QFE\\WOW |
...
| Fájlnév    | Verziószám    | Dátum         | Időpont | Méret   | CPU | Mappa       |
|------------|---------------|---------------|---------|---------|-----|-------------|
| Gdi32.dll  | 5.2.3790.2606 | 2005. 12. 31. | 05:00   | 609 792 | x64 | SP1GDR      |
| Wgdi32.dll | 5.2.3790.2606 | 2005. 12. 31. | 05:00   | 285 184 | x86 | SP1GDR\\WOW |
| Gdi32.dll  | 5.2.3790.2606 | 2005. 12. 31. | 04:46   | 609 792 | x64 | SP1QFE      |
| Wgdi32.dll | 5.2.3790.2606 | 2005. 12. 31. | 04:46   | 285 184 | x86 | SP1QFE\\WOW |
...
-   **Rendszerleíró kulcsok ellenőrzése**
    ...
    **Megjegyzés:** Nem biztos, hogy ez a kulcs tartalmazza az összes telepített fájlt. Előfordulhat, hogy ha a rendszergazda vagy az OEM gyártó beépíti a 912919 számú biztonsági frissítést a Windows telepítési forrásfájljaiba, a program hibásan hozza létre a rendszerleíró kulcsot.

#### Windows XP (az összes verzió)

**Előfeltételek**
A biztonsági frissítéshez Microsoft Windows XP Service Pack 1 vagy későbbi verzió szükséges. További információt a [Microsoft Tudásbázis 322389](http://support.microsoft.com/kb/322389/hu) számú cikkében talál.
...
| Fájlnév    | Verziószám    | Dátum         | Időpont | Méret   | Mappa  |
|------------|---------------|---------------|---------|---------|--------|
| Gdi32.dll  | 5.1.2600.1789 | 2006. 01. 02. | 22:38   | 260 608 | SP1QFE |
| Mf3216.dll | 5.1.2600.1331 | 2004. 03. 30. | 01:48   | 36 864  | SP1QFE |
| Gdi32.dll  | 5.1.2600.2818 | 2005. 12. 29. | 02:54   | 280 064 | SP2GDR |
| Gdi32.dll  | 5.1.2600.2818 | 2005. 12. 29. | 03:04   | 280 064 | SP2QFE |
...
-   **Rendszerleíró kulcsok ellenőrzése**
    ...
    **Megjegyzés:** Nem biztos, hogy ezek a rendszerleíró kulcsok az összes telepített fájlt tartalmazzák. Ne feledje azt sem, hogy ha a rendszergazda vagy az OEM gyártó beépíti a 912919 számú biztonsági frissítést a Windows rendszer telepítési forrásfájljaiba, a program esetleg hibásan hozza létre a rendszerleíró kulcsokat.
...
A legújabb javítócsomag beszerzéséről a [Microsoft Tudásbázis 260910](http://support.microsoft.com/kb/260910/hu) számú cikkében tájékozódhat.
...
|------------|---------------|---------------|---------|---------|
| Gdi32.dll  | 5.0.2195.7073 | 2005. 12. 30. | 16:15   | 233 744 |
...
-   **Rendszerleíró kulcsok ellenőrzése**
    ...
    **Megjegyzés:** Nem biztos, hogy ez a kulcs tartalmazza az összes telepített fájlt. Ne feledje azt sem, hogy ha a rendszergazda vagy az OEM gyártó beépíti a 912919 számú biztonsági frissítést a Windows rendszer telepítési forrásfájljaiba, a program esetleg hibásan hozza létre a rendszerleíró kulcsot.
...
-   Dan Hubbard [(WebSense)](http://websense.com/) - a képmegjelenítő rendszer biztonsági résének (CVE-2005-4560) jelentéséért.
