---
TOCTitle: 'MS12-033'
Title: 'A Microsoft számú biztonsági közleménye MS12-033 - Fontos'
ms:assetid: 'ms12-033'
ms:contentKeyID: 61228880
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms12-033(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS12-033 - Fontos
=========================================================

A Windows Partitíciókezelő biztonsági rése jogok kiterjesztését teheti lehetővé (2690533)
-----------------------------------------------------------------------------------------
...
A biztonsági frissítés a biztonsági rés megszüntetése érdekében javítja a Windows Partitíciókezelő memóriaobjektum-kezelési módját. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
<th>
A Plug and Play (PnP) Konfigurációkezelő biztonsági rése - CVE-2012-0178
</th>
<th>
Összesített súlyossági besorolás
</th>
...
<span></span>
A Windows Partíciókezelőben az eszközkapcsolatokra vonatkozó kérelmek kezelési módja miatt jogok kiterjesztését lehetővé tévő biztonsági rés található. A biztonsági rést sikeresen kihasználó támadó kernel módban mesterséges kódot futtathat az érintett rendszeren. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.

A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2012-0178](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0178).

#### A Plug and Play (PnP) Konfigurációkezelő biztonsági rése (CVE-2012-0178) által okozott hibákat enyhítő tényezők
...
#### Lehetséges megoldások a Plug and Play (PnP) Konfigurációkezelő biztonsági résének (CVE-2012-0178) elhárításához

A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.

#### Gyakori kérdések a Plug and Play (PnP) Konfigurációkezelő biztonsági résével (CVE-2012-0178) kapcsolatban

**Mire terjed ki a biztonsági rés hatása?**
A biztonsági rés jogok kiterjesztését teheti lehetővé.

**Mi okozza a biztonsági rést?**
A biztonsági rés akkor jön létre, amikor két vagy több folyamat vagy szál egy időben hívja meg a Plug and Play (PnP) Konfigurációkezelő funkcióit.

**Melyik** **összetevőt érinti a biztonsági rés?**
A biztonsági rés által érintett összetevő a Windows Partíciókezelő (partmgr.sys).

**Mi az a Windows Partíciókezelő** **(partmgr.sys)?** **
**A Windows Partíciókezelő a partíciók észleléséért, létrehozásáért, törléséért és kezeléséért felelős összetevő. A Partíciókezelő a lemezosztályú illesztőprogramok által létrehozott lemez-eszközobjektumok szűrőillesztőjeként funkcionál. Az a feladata, hogy minden online lemez egyedi aláírással vagy GUID azonosítóval rendelkezzen.
...
A frissítés a biztonsági rés megszüntetése érdekében javítja a Windows Partitíciókezelő memóriaobjektum-kezelési módját.
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2690533">Microsoft Tudásbázis 2690533. számú cikkét</a></td>
</tr>  
<tr class="odd">
