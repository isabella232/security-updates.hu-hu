---
TOCTitle: 'MS10-084'
Title: 'A Microsoft számú biztonsági közleménye MS10-084 - Fontos'
ms:assetid: 'ms10-084'
ms:contentKeyID: 61228647
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-084(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS10-084 - Fontos
=========================================================

A Windows helyi eljáráshívása biztonsági rése jogok kiterjesztését okozhatja (2360937)
--------------------------------------------------------------------------------------

Közzétéve: 2010. október 5.
...
A biztonsági frissítés a biztonsági rés elhárítása végett módosítja az LRPC port üzeneteinek kezelését az RPC alrendszeren belül. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6049c879-b81a-4d10-b96b-b2837cb24834)                                                 | Jogok kiterjesztése        | Fontos                           | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d690846c-5e0b-4216-84cd-d17e366dd16d)                        | Jogok kiterjesztése        | Fontos                           | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b31e18b0-da9f-4b3b-82c6-603e08b3b241)                                        | Jogok kiterjesztése        | Fontos                           | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d73f0f1-6ec8-4304-a20e-345d8b6c225a)                            | Jogok kiterjesztése        | Fontos                           | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 SP2 karbantartó csomaggal Itanium alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=8fad4f77-7c89-4684-b957-9c00ced248d3) | Jogok kiterjesztése        | Fontos                           | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
...
<th style="border:1px solid black;" >LPC-üzenet puffertúlcsordulást okozó biztonsági rése - CVE-2010-3222</th>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=?...?">Windows Server 2003 SP2 karbantartó csomaggal Itanium alapú rendszerekhez</a></td>
<td style="border:1px solid black;"><strong>Fontos</strong> <br />
Jogok kiterjesztése</td>
<td style="border:1px solid black;"><strong>Fontos</strong></td>
</tr>
...
LPC-üzenet puffertúlcsordulást okozó biztonsági rése - CVE-2010-3222  
--------------------------------------------------------------------
  
A jogok kiterjesztését lehetővé tévő biztonsági rés található a NetworkService fiók környezetében futó Távoli eljáráshívás alrendszerben (RPCSS). A biztonsági rés révén a helyi alkalmazások az LPC segítségével kérelmet küldhetnek az LPC-kiszolgálónak, hogy az LRPC használatával kapcsolódjon vissza az ügyfélhez. Ez a kérelem különlegesen kialakított, kötegalapú puffertúlcsordulást okozó adatokat tartalmazhat, ami lehetővé teszi, hogy a hitelesített felhasználó a NetworkService fiók környezetében futó erőforrásokat érhessen el.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
  
#### Az LPC-üzenet puffertúlcsordulást okozó biztonsági résének (CVE-2010-3222) súlyosságát enyhítő tényezők
...
#### Lehetséges megoldások az LPC-üzenet puffertúlcsordulást okozó biztonsági résének (CVE-2010-3222) kiküszöbölésére
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismételt kérdések az LPC-üzenet puffertúlcsordulást okozó biztonsági résével (CVE-2010-3222) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés jogok kiterjesztését teheti lehetővé. A biztonsági rést sikeresen kihasználó, felhasználói jogosultságokkal rendelkező támadó kódot futtathat a Hálózati szolgáltatás fiók környezetében.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rést az LPC és az RPCSS szolgáltatáson belül található LRPC-kiszolgáló (RPC végpontleképező) közötti portüzenetváltásban bekövetkező, kötegalapú puffertúlcsordulás okozza.
  
**Melyik összetevőt érinti a biztonsági rés?**    
A biztonsági rés által érintett összetevő a Microsoft Helyi eljáráshívás (LPC), a Távoli eljáráshívás (RPC) egyik összetevője.
  
**Mi az LPC?**  
A Helyi eljáráshívás (LPC) a Windows rendszerben található üzenettovábbító szolgáltatás. A szolgáltatáson keresztül a szálak és a folyamatok kommunikálhatnak egymással. Amikor egy ügyfélfolyamat szolgáltatást kér egy kiszolgálói folyamattól, kell lennie egy lehetőségnek a folyamatok egymás közötti kommunikációjára. Kell lennie lehetőségnek az ügyfélfolyamat számára, hogy kéréseket intézhessen a szerver felé, a szerver számára, hogy válaszokat küldhessen az ügyfélnek, és mindkettőjüknek, hogy egymás állapotát meghatározhassák. Ha az ügyfélfolyamat és a kiszolgálói folyamat különböző rendszeren van, akkor a távoli eljáráshívás (RPC) szolgáltatás lép használatba. Ha ugyanazon a rendszeren helyezkednek el, akkor az LPC használható.
  
**Mi az RPC?**  
A Távoli eljáráshívás (RPC) olyan folyamatközi kommunikációs (IPC) mechanizmus, amely lehetővé teszi egy eltérő folyamat részét képező adatok cseréjét és funkciók előhívását. A folyamatok egy számítógépen, egy helyi hálózaton (LAN) vagy interneten keresztül kapcsolódhatnak egymáshoz. A Microsoft RPC funkciója más IPC eszközök (pl. named pipe-ok, NetBIOS/Winsock) segítségével biztosítja az ügyfél és a kiszolgáló közti kommunikációt. Az RPC használatakor az alapvető programlogika és a hozzá tartozó eljáráskód külön számítógépen is lehet; ez különösen fontos az elosztott alkalmazásokhoz. További információkért lásd az [RPC-ről szóló](http://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx) TechNet cikket
  
**Mi az LRPC?**  
A helyi RPC (LRPC) a helyi rendszeren zajló RPC-kommunikációt jelenti.
  
**Mire használhatja a biztonsági rést a támadó?**    
A biztonsági rést sikeresen kihasználó támadó speciálisan kialakított kódot futtathat a NetworkService-fiók környezetében, ezzel hozzáférést szerezhet a NetworkService keretében futó erőforrásokhoz. Egyes folyamatok kiterjeszthetik a jogokat a LocalSystem szintjére, így bármelyik NetworkService folyamat is LocalSystem szintre terjesztheti ki jogosultságait. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Hogyan használhatja ki a támadó a biztonsági rést?**    
A helyileg, érvényes hitelesítő adatokkal bejelentkezett támadó úgy használhatja ki a biztonsági rést, hogy különlegesen kialakított kódot futtat, amely LPC-üzenetet küld a helyi LRPC-kiszolgálóra. Az üzenet ezután lehetővé teheti, hogy a hitelesített felhasználó a NetworkService fiók környezetében kódot futtasson.
...
A frissítés a biztonsági rés elhárítása végett módosítja az LPC port üzeneteinek kezelését az RPCSS rendszeren belül.
  
**Ismert volt-e a nyilvánosság előtt ez a biztonsági rés az említett közlemény kiadásának idején?**    
Igen. A biztonsági rés nyilvánosságra került, A normál biztonsági rés besorolást és a [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222) azonosítót kapta.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB2360937$\Spuninst mappában található.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2360937">Microsoft Tudásbázis 2360937. számú cikkét</a></td>
</tr>
<tr class="even">
