---
TOCTitle: 'MS10-029'
Title: 'A Microsoft számú biztonsági közleménye MS10-029 - Közepes'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61228592
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-029(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS10-029 - Közepes
==========================================================

A Windows ISATAP összetevő biztonsági rése tartalomhamisítást okozhat (978338)
------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 2 és Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                             | Tartalomhamisítás          | Mérsékelt.                       | Nincsenek                                                 |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                                 | Tartalomhamisítás          | Mérsékelt.                       | Nincsenek                                                 |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                                 | Tartalomhamisítás          | Mérsékelt.                       | Nincsenek                                                 |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                     | Tartalomhamisítás          | Mérsékelt.                       | Nincsenek                                                 |
| [Windows Server 2003 SP2 for Itanium-based Systems](http://www.microsoft.com/downloads/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                                  | Tartalomhamisítás          | Mérsékelt.                       | Nincsenek                                                 |
| [Windows Vista, Windows Vista Service Pack 1 és Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                        | Tartalomhamisítás          | Mérsékelt.                       | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 és Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36)    | Tartalomhamisítás          | Mérsékelt.                       | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 32 bites rendszerekhez és Windows Server 2008 32 bites rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)\*         | Tartalomhamisítás          | Mérsékelt.                       | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 x64 alapú rendszerekhez és Windows Server 2008 x64 alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)\*       | Tartalomhamisítás          | Mérsékelt.                       | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 Itanium alapú rendszerekhez és Windows Server 2008 Itanium alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842) | Tartalomhamisítás          | Mérsékelt.                       | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |

**\*A kiszolgálómag telepítését érinti.** A frissítés besorolása ugyanaz a Windows Server 2008 támogatott kiadásain függetlenül attól, hogy a kiszolgálómag-telepítési opcióval telepítették-e. Ezen telepítési opcióval kapcsolatosan további tájékoztatás a [Kiszolgálómag](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) című részben található. A Server Core telepítési beállítás a Windows Server 2008 egyes kiadásainál nem alkalmazható. További tudnivalók: [Server Core telepítési beállítások összehasonlítása](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
...
A biztonsági frissítés két korábbi biztonsági funkciót alkalmaz:

-   **Potenciális útválasztók listája (PRL) ISATAP ügyfeleken:** A PRL jóvoltából az ügyfelek ellenőrizhetik a forráscímet a bejövő bújtatott ISATAP csomagokon. A PRL a biztonsági frissítés telepítése után automatikusan be van kapcsolva, és segíti a CVE-2010-0812 közleményben ismertetett ISATAP IPv6 forráscím-hamisítási biztonsági rés megoldását. További információk a PRL működéséről a [Microsoft Tudásbázis 978338. cikkében](http://support.microsoft.com/kb/978338).
-   **Szomszéd elérhetetlenségének észlelése (NUD) ISATAP interfészeken:** A NUD funkció annak ellenőrzésére szolgál, hogy a szomszéd elérhető-e. A NUD működést az ISATAP csomópontok végzil el az ISATAP csomagok küldése előtt. A NUD funkció alapértelmezésben nincs bekapcsolva: a hálózati rendszergazdának manuálisan kell konfigurálnia. A NUD működésével és bekapcsolásával kapcsolatban további információ található a [Microsoft Tudásbázis 978338. számú cikkében](http://support.microsoft.com/kb/978338).

**A Microsoft Windows 2000 rendszert miért nem érinti a biztonsági rés?**      
A Microsoft Windows 2000 rendszer nem támogatja az IPv6 használatát, ezért ezt az operációs rendszert nem érinti a probléma.

**A Windows 7 és a Windows Server 2008 R2 rendszert miért nem érinti a biztonsági rés?**      
A biztonsági frissítés funkciói, a potenciális útválasztók listája (PRL) és a szomszéd elérhetetlenségének észlelése (NUD), már a Windows 7 és Windows Server 2008 R2 rendszerben is megtalálhatók.

**Megjegyzés** Noha a PRL alapértelmezésben működik ezeken a platformokon, a NUD funkcióra ez nem igaz: azt a hálózati rendszergazdának kell manuálisan konfigurálnia. A funkció részleteiről lásd a [Microsoft Tudásbázis 978338. cikkét](http://support.microsoft.com/kb/978338).

**Felajánlják ezt a frissítést akkor is, ha nálam nincs engedélyezve az IPv6?**      
Igen, az Automatikus frissítések szolgáltatás felajánlja ezt a biztonsági frissítést, mert a rendszereken jelen van az érintett kód. Javasoljuk azonban, hogy ha a jövőben telepíteni kívánja az IPv6 alkalmazást, telepítsék a biztonsági frissítést.
...
<th style="border:1px solid black;" >ISATAP IPv6 forráscím-hamisítási biztonsági rése - CVE-2010-0812</th>
...
ISATAP IPv6 forráscím-hamisítási biztonsági rése - CVE-2010-0812  
----------------------------------------------------------------
  
A tartalomhamisítást lehetővé tévő biztonsági rés oka a Microsoft Windows IPv6 kötegnél az, ahogyan a Windows ellenőrzi a belső csomagok IPv6 forráscímét bújtatott ISATAP csomag esetén. A biztonsági rést sikeresen kihasználó támadó megszemélyesíthet egy címet a perem- vagy állomástűzfalak megkerülése végett. Emellett illetéktelen adathozzáférés is történhet, ha a megtámadott számítógép választ küld az üzenetre, és ehhez a támadó által megadott forrás IPv6 címet használja.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-0812](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812).
  
#### Az ISATAP IPv6 forráscím-hamisítási biztonsági résének (CVE-2010-0812) hibáit enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   A biztonsági rés csak azokat a Windows rendszereket érinti, amelyeknél be van állítva az ISATAP interfész.
  
#### Az ISATAP IPv6 forráscím-hamisítási biztonsági résének (CVE-2010-0812) lehetséges megoldásai
...
-   **Tiltsa le az ISATAP IPv6 interfész működését**
  
    Az ISATAP IPv6 interfész letiltásához futtassa a következő parancsot az emelt szintű parancssorból:
    ...
    **A megoldás hatása.** Az ISATAP interfész letiltása megakadályozza, hogy a rendszer IPv6 bújtatási technikaként alkalmazza az ISATAP összetevőt.
  
    **A megoldás visszavonása.**
  
    Az ISATAP IPv6 interfész újbóli engedélyezéséhez futtassa a következő parancsot az emelt szintű parancssorból:
...
#### Gyakran feltett kérdések az ISATAP IPv6 forráscím-hamisítási biztonsági résével (CVE-2010-0812) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**        
Ez a biztonsági rés tartalomhamisításra ad lehetőséget. A biztonsági rést kihasználó támadó úgy meghamisíthat egy IPv4 címet, hogy az megkerüli a forrás IPv4 címen alapuló szűrőeszközöket.
  
**Mi okozza a biztonsági rést?**        
A biztonsági rés oka, hogy a Windows TCP/IP köteg nem megfelelően ellenőrzi a forrás IPv6 címet a bújtatott ISATAP csomagokban.
  
**Mi az ISATAP?**        
Az Intra-Site Automatic Tunnel Addressing Protocol (ISATAP) IPv6 kapcsolatot biztosít IPv4 intraneten belül. Az ISATAP protokollról bővebb információk az [RFC5214: Intra-Site Automatic Tunnel Addressing Protocol (ISATAP)](http://www.ietf.org/rfc/rfc5214.txt) részben.
  
**Mire használhatja a biztonsági rést a támadó?**        
A támadó megszemélyesíthet egy másik felhasználót vagy rendszert, ezzel a forráscímszűrők (pl. perem- és állomástűzfalak) megkerülését okozva.
  
**Hogyan használhatja ki a támadó a biztonsági rést?**        
A biztonsági rést kihasználni kívánó támadó speciálisan létrehozott hálózati csomagokat alakíthat ki egy speciális IPv6 forráscímmel olyan ISATAP kapcsolaton, ami nem felel meg a vonatkozó IPv4 forráscímnek.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**        
Az IPv6 ISATAP funkciókat engedélyező össze operációs rendszert fenyegeti a biztonsági rés.
  
**Mi a frissítés feladata?**        
A frissítés a biztonsági rés elhárítása érdekében módosítja a bújtatott ISATAP csomagban található forrás IPv6 cím ellenőrzési módját a Windows TCP/IP kötegben.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\\$NTUninstallKB978338$\Spuninst mappában található.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/978338">Microsoft Tudásbázis 978338. számú cikkét</a></td>
</tr>
<tr class="even">
...
Gabi Nakibly, National EW Research & Simulation Center (Rafael), az ISATAP IPv6 forráscím-hamisítási biztonsági résének (CVE-2010-0812) jelentéséért
...
-   1.1 verzió (2010. április 21.): Kijavítottuk a közlemény-felváltásra vonatkozó információt minden Windows Vista és Windows Server 2008 frissítőcsomagra vonatkozóan.
