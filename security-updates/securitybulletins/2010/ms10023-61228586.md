---
TOCTitle: 'MS10-023'
Title: 'A Microsoft számú biztonsági közleménye MS10-023 - Fontos'
ms:assetid: 'ms10-023'
ms:contentKeyID: 61228586
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-023(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS10-023 - Fontos
=========================================================

A Microsoft Office Publisher biztonsági rése távoli kódfuttatást tehet lehetővé (981160)
----------------------------------------------------------------------------------------
...
A biztonsági frissítés besorolása a Microsoft Publisher 2002, Microsoft Office Publisher 2003 és Microsoft Office Publisher 2007 támogatott verzióira nézve Fontos. További tudnivalókért tekintse meg az **Érintett és nem érintett szoftverek** c. részt.

Ai frissítés a biztonsági rés megszüntetéséhez módosítja a Publisher fájlok megnyitási módját a Microsoft Office Publisher alkalmazásban. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.

**Javaslat.** A Microsoft a biztonsági frissítés lehető leghamarabb történő telepítését javasolja ügyfeleinek.

**Ismert problémák** A[Microsoft Tudásbázis 981160. számú cikkében](http://support.microsoft.com/kb/981160) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek. Ha az ismert problémák és az ajánlott megoldások csak a szoftver egyes kiadásaira vonatkoznak, a cikkben további utalások olvashatók más cikkekre.
...
<tr class="even">
<td style="border:1px solid black;">2007-es Microsoft Office rendszer Service Pack 2 javítócsomaggal</td>
...
<th style="border:1px solid black;" >Microsoft Office Publisher fájlkonverziós szövegdoboz-feldolgozás puffertúlcsordulási biztonsági rése - CVE-2010-0479</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
Microsoft Office Publisher fájlkonverziós szövegdoboz-feldolgozás puffertúlcsordulási biztonsági rése - CVE-2010-0479  
---------------------------------------------------------------------------------------------------------------------
  
A Publisher fájlok megnyitási módja távoli kódvégrehajtást lehetővé tévő biztonsági rést okoz a Microsoft Office Publisher programban. A támadó úgy használhatja ki a biztonsági rést, hogy speciálisan kialakított Publisher fájlt küld e-mail mellékletként, illetve azt különlegesen kialakított vagy sérült biztonságú webhelyen helyezi el, majd ráveszi a felhasználót, hogy nyissa meg a speciálisan kialakított Publisher fájlt.
...
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-0479](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0479).
  
#### A Microsoft Office Publisher fájlkonverziós szövegdoboz-feldolgozás puffertúlcsordulási biztonsági résének (CVE-2010-0479) hibáit enyhítő tényezők
...
-   Webalapú támadás esetén a támadónak olyan webhelyet kell üzemeltetnie, amely egy, a biztonsági rés kihasználását lehetővé tevő weblapot tartalmaz. Az érintett weboldalak és a felhasználó által biztosított tartalomnak, esetleg hirdetéseknek helyet adó weboldalak is tartalmazhatnak a biztonsági rést kihasználni képes különlegesen kialakított tartalmat. A támadóknak azonban nem áll módjukban a felhasználókat ezeknek a weboldalaknak a látogatására kényszerítenie. A támadónak rá kell vennie a felhasználókat, hogy látogassanak el a webhelyre. Ehhez általában rá kell kattintani egy e-mail üzenetben vagy azonnali üzenetküldő programban kapott hivatkozásra, majd meg kell nyitni a speciálisan létrehozott Publisher fájlt.  
...
#### A Microsoft Office Publisher fájlkonverziós szövegdoboz-feldolgozás puffertúlcsordulási biztonsági résének (CVE-2010-0479) lehetséges megoldásai
...
#### Gyakran feltett kérdések a Microsoft Office Publisher fájlkonverziós szövegdoboz-feldolgozás puffertúlcsordulási biztonsági résével (CVE-2010-0479) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés távolról történő kódfuttatást tehet lehetővé. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rés oka a fájlelemzési kódban rejlik, amelyet a Microsoft Office Publisher a speciálisan kialakított Publisher fájlok megnyitásakor használ.
...
A biztonsági frissítés úgy oldja meg a biztonsági rés okozta problémát, hogy kijavítja a különlegesen kialakított Publisher fájlok megnyitásának kezelését a Microsoft Office Publisher alkalmazásban.
...
| Microsoft Office Publisher 2007 Service Pack 2 | Igen       |
...
|------------------------------------------------|---------|-----------------------------|-----------------------------|----------------------------|  
| Microsoft Office Publisher 2002 Service Pack 3 | Nem     | Nem                         | Igen                        | Igen                       |  
| Microsoft Office Publisher 2003 Service Pack 3 | Nem     | Nem                         | Igen                        | Igen                       |  
| Microsoft Office Publisher 2007 Service Pack 1 | Nem     | Nem                         | Igen                        | Igen                       |  
| Microsoft Office Publisher 2007 Service Pack 2 | Nem     | Nem                         | Igen                        | Igen                       |
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/980466">Microsoft Tudásbázis 980466. számú cikkét</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/980469">Microsoft Tudásbázis 980469. számú cikkét</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Rendszerleíró kulcsok ellenőrzése</strong></td>
<td style="border:1px solid black;">Nem érintett</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/980470">Microsoft Tudásbázis 980470. számú cikkét</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Rendszerleíró kulcsok ellenőrzése</strong></td>
<td style="border:1px solid black;">Nem érintett</td>
...
-   Lionel d'Hauenens, a [TippingPoint](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) munkatársa, a Microsoft Office Publisher fájlkonverziós szövegdoboz-feldolgozás puffertúlcsordulási biztonsági rése (CVE-2010-0479) jelentéséért
