---
TOCTitle: 'MS10-069'
Title: 'A Microsoft számú biztonsági közleménye MS10-069 - Fontos'
ms:assetid: 'ms10-069'
ms:contentKeyID: 61228632
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-069(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS10-069 - Fontos
=========================================================

A Windows futásidejű ügyfélkiszolgáló alrendszerének biztonsági rése jogok kiterjesztését teheti lehetővé (2121546)
-------------------------------------------------------------------------------------------------------------------
...
A biztonsági frissítés a biztonsági rés kiküszöbölése végett kijavítja a futásidejű ügyfélkiszolgáló alrendszer (CSRSS) memóriakiosztási módját bizonyos tranzakciók kezelésekor. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
Ha a rendszergazda, vállalati telepítő vagy végfelhasználó manuálisan szeretné telepíteni a biztonsági frissítést, a Microsoft a minél előbbi telepítést javasolja.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=20091358-7127-4ace-bf96-4319461ad305)                           | Jogok kiterjesztése        | Fontos                           | Nincsenek                                                |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=107eb958-b60f-40ae-a785-5d5b4d13d8c6)  | Jogok kiterjesztése        | Fontos                           | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fd46ba66-8ca1-4aa2-b91b-9e5861a173f7)                  | Jogok kiterjesztése        | Fontos                           | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff5976e0-579c-4e6e-a225-c0d3913cdc85)      | Jogok kiterjesztése        | Fontos                           | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 SP2 Itanium alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=e450ca08-1d75-4419-ad9f-c5e5efb55cd5) | Jogok kiterjesztése        | Fontos                           | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
...
**Nem használok kínai, japán, sem koreai Windows-verziót. Vonatkozik rám a biztonsági közlemény?**    
Az érintett operációs rendszerek minden nyelvi verziója tartalmazza a jelen közleményben tárgyalt biztonsági rést, de az csak akkor kihasználható, ha a rendszert kínai, japán vagy koreai területi beállításokra konfigurálták.
...
<th style="border:1px solid black;" >A CSRSS jogok helyi kiterjesztését eredményező biztonsági rése - CVE-2010-1891</th>
...
A CSRSS jogok helyi kiterjesztését eredményező biztonsági rése - CVE-2010-1891  
------------------------------------------------------------------------------
  
A Windows CSRSS rendszerben egyes tranzakciók kezelési módja miatt jogok kiterjesztését lehetővé tévő biztonsági rés található. A biztonsági rést sikeresen kihasználó támadó tetszőleges kódot futtathat a helyi rendszer biztonsági környezetében. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891).
  
#### A CSRSS jogok helyi kiterjesztését eredményező biztonsági résének (CVE-2010-1891) hatását enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   Csak a kínai, japán illetve koreai területi beállításokra konfigurált rendszereket érinti a probléma.  
...
#### A CSRSS jogok helyi kiterjesztését eredményező biztonsági résének (CVE-2010-1891) lehetséges megoldásai
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran feltett kérdések a CSRSS jogok helyi kiterjesztését eredményező biztonsági résével (CVE-2010-1891) kapcsolatban
...
A Windows CSRSS nem mindig végzi megfelelően a memóriakiosztást bizonyos felhasználói tranzakciók kezelése során a kínai, japán illetve koreai területi beállításokra konfigurált Windows-rendszereken.
  
**Mi a Windows futásidejű ügyfélkiszolgáló alrendszer (CSRSS)?**      
A CSRSS a Win32 alrendszer felhasználói módú része (a Win32.sys a kernel módú rész). A CSRRS a futásidejű ügyfélkiszolgáló alrendszer rövidítése. A rendszer fontos, ezért folyamatosan működnie kell. A CSRSS felelős a konzolablakokért, valamint a szálak létrehozásáért és/vagy törléséért.
  
**Mire használhatja a biztonsági rést a támadó?**      
A biztonsági rést sikeresen kihasználó támadó tetszőleges kódot futtathat a helyi rendszer biztonsági környezetében. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
...
A frissítés a biztonsági rés kiküszöbölése végett kijavítja a CSRSS memóriakiosztási módját bizonyos tranzakciók kezelésekor.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB2121546$\Spuninst mappában található.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2121546">Microsoft Tudásbázis 2121546. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   [IBM Japan](http://www.ibm.com/jp/ja/), a CSRSS jogok helyi kiterjesztését eredményező biztonsági résének (CVE-2010-1891) jelentéséért
