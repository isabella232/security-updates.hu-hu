---
TOCTitle: 'MS10-055'
Title: 'A Microsoft számú biztonsági közleménye MS10-055 - Kritikus'
ms:assetid: 'ms10-055'
ms:contentKeyID: 61228618
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms10-055(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS10-055 - Kritikus
===========================================================

A Cinepak Codec biztonsági rése távolról történő kódfuttatást tesz lehetővé (982665)
------------------------------------------------------------------------------------
...
Ez a kritikus besorolású biztonsági frissítés a Windows XP, Windows Vista és a Windows 7 összes támogatott kiadására vonatkozik. További információkért lásd az **Érintett és nem érintett szoftverek** című részt ebben a fejezetben.

A biztonsági frissítés célja a biztonsági rés kijavítása azáltal, hogy módosítja azt a módot, ahogyan a Cinepak kód a médiafájlokat kibontja. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
**Ismert problémák** A[Microsoft Tudásbázis 982665. számú cikkében](http://support.microsoft.com/kb/982665) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=5ddb5e34-f97a-47c6-96c8-ba2ed06ccb77)                                                            | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cff5d6e-11a5-40ed-92ac-e12d287919e6)                                   | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows Vista Service Pack 1 és Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=60c81415-b61e-44a4-8dd9-cedec99eb70f)                         | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows Vista x64 Edition Service Pack 1 és Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=469b732d-ca62-4a48-bb55-99f2ae4ddcf5) | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows 7 32 bites rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=2e782ac9-b5d5-490e-a01a-7d4481eab224)                                                     | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows 7 x64 alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=24751193-592f-4c44-a8d6-f4112d4f011b)                                                    | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
...
<th style="border:1px solid black;" >Cinepak Codec kibontási biztonsági rés - CVE-2010-2553</th>
...
Cinepak Codec kibontási biztonsági rés - CVE-2010-2553  
------------------------------------------------------
  
A Cinepac codec támogatott formátumú fájlokat kezelő módjában távoli kódvégrehajtást lehetővé tévő biztonsági rés található. A biztonsági rés kódvégrehajtást tehet lehetővé, ha a felhasználó különlegesen kialakított médiafájlt nyit meg. Ha valamely felhasználó felügyeleti jogosultságokkal bejelentkezett a rendszerbe, akkor a biztonsági rést kihasználó támadó teljes mértékben átveheti az irányítást a számítógép felett, Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2010-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553).
  
#### A Cinepak Codec kibontási biztonsági rés (CVE-2010-2553) enyhítő tényezői
...
#### A Cinepak Codec kibontási biztonsági rés (CVE-2010-2553) lehetséges megoldásai
  
A lehetséges megoldás olyan beállítást vagy konfigurációs módosítást takar, amely magát a biztonsági rést nem szünteti meg, azonban a frissítés telepítése előtt segít az ismert támadási lehetőségek kivédésében. A Microsoft alaposan megvizsgálta a következő lehetséges megoldásokat, és tájékoztatja a felhasználókat, amennyiben a megoldás csökkenti a működőképességet:
  
-   **Módosítsa az iccvid.dll fájlra vonatkozó hozzáférés-szabályozási listát (ACL)**
  
    Módosítsa az iccvid.dll fájlra vonatkozó hozzáférés-szabályozási listát (ACL) olyan módon, hogy korlátozóbb jellegű legyen.
  
    A Windows XP 32-bites kiadványai esetén futtassa a következő parancsokat egy parancssorból (rendszergazdai jogosultság szükséges):  
    `cacls %WINDIR%\SYSTEM32\iccvid.DLL /E /P everyone:N`
  
    A Windows XP 64-bites kiadványai esetén futtassa a következő parancsokat egy parancssorból (rendszergazdai jogosultság szükséges):  
    `cacls %WINDIR%\SYSWOW64\iccvid.DLL /E /P everyone:N `
  
    `32-bites kiadás esetén,` Windows Vista és Windows 7 rendszeren futtassa a következő parancsokat egy emelt szintű parancssorból:  
    ...
    **A megoldás hatása.** A Cinepak codec használatával dekódolt médiafájlok lejátszása nem működik multimédiás alkalmazásokon.
...
-   **Tiltsa le a Cinepac használatával kódolt fájlok elemzését a DirectShow alatt**
    ...
    **Interaktív módszerrel**
    ...
    4.  A Rendszerleíró adatbázis exportálása párbeszédpanelen adja meg a **Drivers32\_Backup.reg** nevet, és kattintson a **Mentés** gombra.  
        **Megjegyzés** Ez a művelet alapértelmezés szerint a Dokumentumok mappában hozza létre a beállításkulcs biztonsági mentését.  
    5.  Keresse meg és jelölje ki a **vidc.cvid** karakterláncot névként és az **iccvid.dll** karakterláncot adatként.  
    6.  A billentyűzet **Delete** gombjának megnyomásával törölje a rendszerleíró kulcsot. A Kulcs törlésének megerősítése párbeszédpanel megjelenésekor az **Igen** gombra kattintva engedélyezze a törlést.
    ...
    **Vezérelt telepítési parancsfájl segítségével**
    ...
    2.  Ezután mentse a következőket egy .REG kiterjesztésű fájlba, például Disable\_Cinepak\_Parser.reg:  
        **32 bites Windows-rendszerek esetén**:  
    ...
    **A megoldás visszavonása.**
    ...
    3.  A Rendszerleíró adatbázis importálása párbeszédpanelen adja meg a **Drivers32\_Backup.reg** nevet, és kattintson a **Megnyitás** gombra.
...
#### Gyakran ismételt kérdések a Cinepak Codec kibontási biztonsági résről (CVE-2010-2553)
...
A Microsoft Windows csomaghoz tartozó Cinepak codec nem megfelelően kezeli a különlegesen kialakított médiafájlokat.
  
**Mi az a Cinepac codec?**    
A Cinepak codec egy multimédiás kódoló és dekódoló, amelyet a Windows Media Player támogat. Ez a kodek lehetővé teszi bitfolyamok kódolását és dekódolását médiafájlokhoz. A Cinepak vektoros kvantálás alapú képtömörítést és egyszerű különbségképzést használ.
...
A biztonsági frissítés célja a biztonsági rés kijavítása azáltal, hogy módosítja azt a módot, ahogyan a Cinepak codec a médiafájlokat kibontja.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét, vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB982665$\Spuninst mappában található.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/982665">Microsoft Tudásbázis 982665. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   A [TippingPoint](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/)programjában résztvevő anonim kutató, a Cinepac codec kibontási biztonsági rése (CVE-2010-2553) jelentéséért
