---
TOCTitle: 'MS07-006'
Title: 'A Microsoft számú biztonsági közleménye MS07-006 - Fontos'
ms:assetid: 'ms07-006'
ms:contentKeyID: 61227852
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms07-006(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS07-006 - Fontos
=========================================================

A Windows rendszerhéj biztonsági rése a jogok kiterjesztését teheti lehetővé (926255)
-------------------------------------------------------------------------------------
...
-   Microsoft Windows XP Service Pack 2 – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=f821b3a0-4e5a-4737-b9bf-1249f6683f4d)
-   Microsoft Windows XP Professional x64 Edition - [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=75abff9b-c2b5-4151-b366-4be652882944)
-   Microsoft Windows Server 2003 és Microsoft Windows Server 2003 Service Pack 1 – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=418acc52-0ebd-4623-81a7-5eacc21c3965)
-   Microsoft Windows Server 2003, Itanium alapú rendszerekhez és Microsoft Windows Server 2003 SP1 szervizcsomaggal, Itanium alapú rendszerekhez - [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=dc33a2fc-2d01-4577-b133-017493d1f278)
-   Microsoft Windows Server 2003 x64 Edition – [Frissítés letöltése](http://www.microsoft.com/downloads/details.aspx?familyid=c3e55066-b34e-485d-ac04-179f8e3a407a)
...
| A biztonsági rés azonosítója                                                                                                                      | A biztonsági rés hatása              | Windows XP Service Pack 2 | Windows Server 2003 | Windows Server 2003 Service Pack 1 |
|---------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|---------------------------|---------------------|------------------------------------|
| A Windows rendszerhéj hardverfigyelését érintő biztonsági rése - [CVE-2007-0211](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0211) | Jogosultság illetéktelen megszerzése | Fontos                    | Fontos              | Fontos                             |

Ez a [minősítés](http://go.microsoft.com/fwlink/?linkid=21140) a biztonsági rés által érintett rendszerek típusain, a tipikus telepítési környezeteken, valamint a biztonsági rés kihasználásával az adott rendszerekben elérhető hatáson alapul.

**Megjegyzés** A Windows Server 2003 és a Windows Server 2003 Service Pack 1 biztonsági frissítése a Windows Server 2003 R2 rendszerre is vonatkozik.
...
-   A Windows XP Professional x64 Edition súlyossági besorolása megegyezik a Windows XP Professional Service Pack 2 súlyossági besorolásával.
...
|--------------------------------------------------------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| [**MS06-045**](http://go.microsoft.com/fwlink/?linkid=69730) | Nem érintett                | Lecserélve                | Lecserélve          | Lecserélve                         |
...
#### A Windows rendszerhéj hardverfigyelését érintő biztonsági rése - CVE-2007-0211:

A [jogok kiterjesztését](http://go.microsoft.com/fwlink/?linkid=21142) okozó biztonsági rés a Windows rendszerhéjban akkor valósul meg, amikor az operációs rendszer elvégzi az új hardver felismerését és regisztrálását. A biztonsági rés révén a már hitelesített felhasználók teljes mértékben átvehetik a rendszer vezérlését.

#### A Windows rendszerhéj hardverfigyelés biztonsági rése (CVE-2007-0211) által okozott hibát enyhítő tényezők:
...
-   Windows XP Service Pack 2 és Windows Server 2003 Service Pack 1 rendszeren a biztonsági rés távolból történő kihasználásához rendszergazdai jogosultságokkal kell rendelkeznie.

#### A Windows rendszerhéj hardverfigyelés biztonsági rése (CVE-2007-0211) által okozott hiba lehetséges megoldásai:

A Microsoft az alábbi megoldásokat tesztelte. Jóllehet ezek a megoldások magát a biztonsági rést nem szüntetik meg, segítenek kivédeni az ismert támadási módszereket. Ha egy megoldási javaslat csökkenti a funkcionalitást, azt a következő fejezetben jelezzük.

-   **A rendszerhéj hardverfigyelési szolgáltatásának letiltása**  

    A rendszerhéj hardverfigyelési szolgáltatás kikapcsolásával megvédheti az érintett rendszert a biztonsági rés kihasználására irányuló kísérletekkel szemben. A rendszerhéj hardverfigyelési szolgáltatásának letiltásához tegye a következőt:
    ...
    4.  Kattintson kettőt a **Rendszerhéj hardverfigyelése** szolgáltatásra.
    5.  Az **Indítási típus** listában válassza a **Letiltva** lehetőséget.
    6.  Kattintson a **Stop**, majd az **OK** gombra.

    A rendszerhéj hardverfelismerő szolgáltatását úgy is leállíthatja és kikapcsolhatja, hogy a parancssorba a következő parancsot írja be:

    `sc stop ShellHWDetection & sc config ShellHWDetection start= disabled`

    **A megoldás hatása:** Ha letiltja a **Rendszerhéj hardverfigyelése** szolgáltatás használatát, nem használhatja ki a Gyors felhasználóváltás lehetőségét. Emiatt javasoljuk, hogy ezt a megoldást csak olyan rendszerek esetén alkalmazza, amelyek nem kommunikálnak digitális képkezelő eszközökkel.

#### Gyakran feltett kérdések a Windows rendszerhéj hardverfigyelése biztonsági résével (CVE-2007-0211) kapcsolatban:

**Mire terjed ki a biztonsági rés hatása?**  
A probléma [illetéktelen jogosultságok megszerzéséhez](http://go.microsoft.com/fwlink/?linkid=21142) vezethet. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A biztonsági rés kihasználásához a támadónak érvényes bejelentkezési adatokkal kell rendelkeznie a rendszerhez és egy programot kell futtatnia.

**Mi a Rendszerhéj hardverfigyelése szolgáltatás?**  
A Rendszerhéj hardverfigyelése szolgáltatás értesítést küld az Automatikus lejátszás hardvereseményeiről.

**Mi okozza a biztonsági rést?**  
A Microsoft Windows hardverinicializálás és -felismerési lehetőségeinek egyik paramétere nincs hitelesítve.
...
A biztonsági rés kihasználásához a támadónak érvényes bejelentkezési adatokkal kell rendelkeznie a rendszerhez és egy programot kell futtatnia.

**Hogyan használhatja ki a támadó a biztonsági rést?**  
A biztonsági rést kihasználó támadónak be kell jelentkeznie a rendszerre, és ott egy e célra létrehozott alkalmazást futtatni. Ezzel rákényszerítheti az érintett rendszert, hogy hardverfelismerést és -inicializálást hajtson végre. A kérelem kiadása történhet helyben, vagy terminálszolgáltatások munkamenetén keresztül, egy külön e célra létrehozott alkalmazás, hardvereszköz vagy tár előhívásával. A biztonsági rést kihasználó támadó megszerezheti az irányítást a teljes rendszer felett.
...
Nem. Nem. A támadónak be kell tudnia jelentkezni a támadásra kiszemelt rendszerbe. E biztonsági rés következményeként a jogosulatlan támadó nem képes programok távoli betöltésére és futtatására.

**Mi a frissítés feladata?**  
A frissítés azáltal szünteti meg a biztonsági rést, hogy hitelesíti az érintett funkciós paramétert.
...
**Milyen kapcsolatban áll ez a biztonsági rés a MS06-045 jelű közleményben javított biztonsági réssel?**  
Mindkét biztonsági rés a Windows-rendszerhéjon volt megtalálható, de ez a frissítés egy új biztonsági rést orvosol, amelyre az [MS06-045](http://technet.microsoft.com/security/bulletin/ms06-045) frissítés nem kínált megoldást. Az MS06-045 frissítés az abban a közleményben tárgyalt problémát oldja meg, azonban az új biztonsági rést nem javítja ki. A frissítés a MS06-045 biztonsági frissítést váltja fel. Ezzel a frissítéssel a rendszer mindkét biztonsági rés ellen megfelelő védelmet kap.
...
**Előfeltételek**
Ehhez a biztonsági frissítéshez a Microsoft Windows XP Service Pack 1 szükséges. További információt a [Microsoft tudásbázis 322389](http://support.microsoft.com/kb/322389/hu). cikkében olvashat.
...
A rendszergazdák a biztonsági frissítés eltávolításához a Spuninst.exe segédprogramot is használhatják. A Spuninst.exe segédprogram a %Windir%\\$NTUninstallKB928255$\\Spuninst mappában található.
...
|--------------|---------------|---------------|---------|-----------|--------|
| Shell32.dll  | 6.0.2900.3051 | 2006. 12. 19. | 21:52   | 8 453 632 | SP2GDR |
| Shsvcs.dll   | 6.0.2900.3051 | 2006. 12. 19. | 21:52   | 134 656   | SP2GDR |
| Shell32.dll  | 6.0.2900.3051 | 2006. 12. 19. | 21:50   | 8 458 752 | SP2QFE |
| Shsvcs.dll   | 6.0.2900.3051 | 2006. 12. 19. | 21:50   | 135 168   | SP2QFE |
| Xpsp3res.dll | 5.1.2600.3051 | 2006. 12. 19. | 16:10   | 248 320   | SP2QFE |
...
| Fájlnév      | Verziószám    | Dátum            | Időpont | Méret     | CPU | Mappa  |
|--------------|---------------|------------------|---------|-----------|-----|--------|
| Shell32.dll  | 6.0.3790.630  | 2007. január 4.  | 19:10   | 8 173 056 |     | RTMGDR |
| Shsvcs.dll   | 6.0.3790.630  | 2007. január 4.  | 19:10   | 124 928   | x86 | RTMGDR |
| Shell32.dll  | 6.0.3790.630  | 2007. január 4.  | 19:18   | 8 174 080 | x86 | RTMQFE |
| Shsvcs.dll   | 6.0.3790.630  | 2007. január 4.  | 19:18   | 124 928   | x86 | RTMQFE |
| Shell32.dll  | 6.0.3790.2867 | 2007. január 23. | 15:02   | 8 382 976 | x86 | SP1GDR |
| Shsvcs.dll   | 6.0.3790.2857 | 2007. január 4.  | 19:34   | 135 168   | x86 | SP1GDR |
| Shell32.dll  | 6.0.3790.2867 | 2007. január 23. | 15:35   | 8 384 512 | x86 | SP1QFE |
| Shsvcs.dll   | 6.0.3790.2857 | 2007. január 4.  | 19:45   | 135 168   | x86 | SP1QFE |
| W03a2409.dll | 5.2.3790.2857 | 2007. január 4.  | 16:38   | 27 136    | x86 | SP1QFE |
