---
TOCTitle: 'MS12-024'
Title: 'A Microsoft számú biztonsági közleménye MS12-024 - Kritikus'
ms:assetid: 'ms12-024'
ms:contentKeyID: 61228871
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms12-024(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS12-024 - Kritikus
===========================================================

A Windows biztonsági rése távoli kódfuttatást tehet lehetővé (2653956)
----------------------------------------------------------------------
...
A biztonsági frissítés a Microsoft Windows közvetlenül jelentett biztonsági rését szünteti meg. A biztonsági rég távoli kódfuttatást tehet lehetővé, ha egy felhasználó vagy alkalmazás speciálisan kialakított, aláírt PE-fájt futtat vagy telepít egy érintett rendszeren.
...
A biztonsági frissítés azáltal szünteti meg a biztonsági rést, hogy módosítja azt a módszert, amellyel a Windows Authenticode aláírás-ellenőrzési funkció Windows Authenticode aláírás-ellenőrzést végez PE-fájl ellenőrzése során. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
**Ismert problémák.** A [Microsoft Tudásbázis 2653956.](http://support.microsoft.com/kb/2653956) cikkében olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=734ff97a-7d72-4bfe-9557-7fac91902f8e">Windows Server 2003 SP2 Itanium-alapú rendszerekhez</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c36c20f7-a742-4151-b8f2-85ef80479d06">Windows Server 2008 32 bites rendszerekhez, Service Pack 2</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=330cea47-221d-439e-b106-58a146fc28ee">Windows Server 2008 x64 alapú rendszerekhez, Service Pack 2</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1ec74522-ec1e-4b3c-bfeb-6a505cc4f11a">Windows Server 2008 Itanium-alapú rendszerekhez, Service Pack 2</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">Windows 7 32 bites rendszerekhez</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">Windows 7 32 bites rendszerekhez, Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">Windows 7 x64-alapú rendszerekhez</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">Windows 7 x64 alapú rendszerekhez, Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Nincsenek</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">Windows Server 2008 R2 x64 alapú rendszerekhez</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">Windows Server 2008 R2 x64-alapú rendszerekhez, Service Pack 1</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Nincsenek</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 Itanium-alapú rendszerekhez</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Az <a href="http://go.microsoft.com/fwlink/?linkid=184933">MS10-019</a> közleményben szereplő KB978601 frissítést a KB2653956 számú váltja fel</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 Itanium alapú rendszerekhez, Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Nincsenek</td>
...
Igen. A Windows Developer Preview kiadáshoz elérhető a KB2653956 frissítés. A Windows Developer Preview felhasználói alkalmazzák a frissítést a rendszereiken. A frissítés csak a [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) szolgáltatáson keresztül érhető el.
  
**Érinti a Windows** **8** **Consumer** **Preview a közleményben ismertetett biztonsági rés?**  
Igen. A KB2653956 frissítés elérhető a Windows 8 Consumer Preview kiadáshoz. A Windows Consumer Preview felhasználói alkalmazzák a frissítést a rendszereiken. A frissítés csak a [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) szolgáltatáson keresztül érhető el.
  
**Alkalmaztam a frissítést, és most a szoftverem aláírása érvénytelen. Mi a teendő?** **  
**A frissítés hatására a Windows Authenticode aláírás-ellenőrző funkció szigorú ellenőrzést végez a PE fájlokon. A PE fájlokat „aláíratlannak” fogja tekinteni a rendszer, ha a Windows olyan tartalmat ismer fel, amely nem felel meg a fájlban lévő Authenticode specifikációnak. Ez hatással néhány telepítőre. Ha érintett telepítőprogramot használ, a Microsoft azt javasolja, hogy olyan telepítőt használjon, amely csak az aláírt fájl érvényesített részeiből tömöríti ki a tartalmat.
  
A PE fájlokat akkor is "aláíratlannak" fogja tekinteni a rendszer, ha a fájlhoz további tartalmat csatolnak az aláírás alkalmazása után. Az alkalmazás aláírásának kell lennie az utolsó lépésnek az összeállítási folyamatban a bináris fájlok kiadása előtt. Ha bővebb tájékoztatásra van szüksége ezekkel vagy egyéb, a biztonsági frissítéssel kapcsolatos ismert problémák tekintetében, tekintse meg a [Microsoft Tudásbázis 2653956. sz.](http://support.microsoft.com/kb/2653956) cikkét.
  
**Tartalmaz a frissítés funkcionalitásbeli módosítást is?**  
Igen. A frissítés A biztonsági rés részletes ismertetése című szakaszban ismertetett megoldások mellett olyan mélyreható módosításokat tartalmaz, amelyek elősegítik a Windows biztonsági funkcióinak javítását.
...
<th style="border:1px solid black;" >A WinVerifyTrust aláírás-érvényesítési biztonsági rése - CVE-2012-0151</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
A biztonsági rés akkor használható ki, ha a felhasználó vagy egy alkalmazás speciálisan kialakított és aláírt PE-fájlt futtat vagy telepít. A támadó egy meglévő aláírt fájl módosításával rosszindulatú kódot adhat a fájlhoz az aláírás érvénytelenítése nélkül. A kód azzal a jogosultsággal kapcsolatban fog működni, amelyben az aláírt PE-fájlt elindították.
  
E-mail alapú támadásnál a támadó úgy próbálja meg kihasználni a biztonsági rést, hogy különlegesen kialakított PE-fájlt tartalmazó e-mail üzenetet küld a felhasználónak, és ráveszi a fájl megnyitására.
  
Web-alapú támadás esetén a támadónak olyan webhelyet kell üzemeltetnie, amely speciálisan kialakított PE-fájlt tartalmaz. Az érintett weboldalak és a felhasználó által biztosított tartalomnak, esetleg hirdetéseknek helyet adó weboldalak is tartalmazhatnak a biztonsági rés kihasználására használható különlegesen kialakított tartalmat. A támadónak nincs lehetősége arra, hogy a felhasználót a különlegesen kialakított médiafájlnak otthont adó webhely megnyitására kényszerítse. Csupán megkísérelheti rávenni a felhasználókat arra, hogy kattintsanak az e-mailben vagy azonnali üzenetben megjelenő hivatkozásra, amelyen keresztül a támadó weboldalára jutnak.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**  
A biztonsági rés elsősorban a munkaállomásokat és kiszolgálókat veszélyezteti.
  
**Mi a frissítés feladata?**  
A frissítés azáltal szünteti meg a biztonsági rést, hogy módosítja azt a módszert, amellyel a Windows Authenticode aláírás-ellenőrzési funkció Windows Authenticode aláírás-ellenőrzést végez PE-fájl ellenőrzése során.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> elemét vagy a %Windir%\$NTUninstallKB2653956$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2653956">Microsoft Tudásbázis 2653956. számú cikkét</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Használja a Vezérlőpult **Programok telepítése és törlése** elemét vagy a %Windir%\\$NTUninstallKB2653956$\\Spuninst mappában található Spuninst.exe segédprogramot
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Lásd a [Microsoft Tudásbázis 2653956. számú cikkét](http://support.microsoft.com/kb/2653956)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Robert Zacek és Igor Glucksmann, [Avast Software](http://www.avast.com/), a WinVerifyTrust aláírás-ellenőrzési biztonsági rés (CVE-2012-0151) jelentéséért
