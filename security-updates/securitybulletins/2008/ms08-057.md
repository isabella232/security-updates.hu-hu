---
TOCTitle: 'MS08-057'
Title: 'A Microsoft számú biztonsági közleménye MS08-057 - Kritikus'
ms:assetid: 'ms08-057'
ms:contentKeyID: 61228268
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms08-057(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS08-057 - Kritikus
===========================================================

A Microsoft Excel biztonsági rései távolról történő programkódfuttatást tehetnek lehetővé (956416)
--------------------------------------------------------------------------------------------------
...
Ennek a biztonsági frissítésnek a minősítése Kritikus a Microsoft Office Excel 2000 valamennyi támogatott kiadása vonatkozásában, a Microsoft Office Excel 2002, a Microsoft Office Excel 2003, a Microsoft Office Excel Viewer 2003, a Microsoft Office Excel 2007, a Microsoft Office Compatibility Pack a Microsoft Office Excel Viewer, és Microsoft Office SharePoint Server 2007 valamennyi támogatott kiadása vonatkozásában pedig a minősítése Fontos. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a7be004-5903-4101-90c5-c0d5f8722af9">Microsoft Office kompatibilitási csomag a Word, Excel és PowerPoint 2007 fájlformátumokhoz</a><br />
(KB955936)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a7be004-5903-4101-90c5-c0d5f8722af9">Microsoft Office kompatibilitási csomag a Word, Excel és PowerPoint 2007 fájlformátumok Service Pack 1 csomagjához</a><br />
(KB955936)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
...
A fájlinformációs adatok a [Microsoft Tudásbázis 956416. számú cikkében](http://support.microsoft.com/kb/956416) találhatók.
...
<th style="border:1px solid black;" >A Naptár objektum érvényesítési biztonsági rése - CVE-2008-3477</th>
<th style="border:1px solid black;" >Fájlformátum-elemzési biztonsági rés - CVE-2008-3471</th>
<th style="border:1px solid black;" >Képletelemzési biztonsági rés - CVE-2008-4019</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
A Naptár objektum érvényesítési biztonsági rése - CVE-2008-3477  
---------------------------------------------------------------
  
A VBA Performance Cache Excel általi feldolgozási módjában távoli kódvégrehajtást lehetővé tévő biztonsági rés található. A biztonsági rés távoli kódfuttatást tesz lehetővé, amikor a felhasználó speciálisan kialakított Excel fájlt nyit meg a VBA Performance Cache helyen. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2008-3477](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3477).
  
#### A Naptár objektum érvényesítési biztonsági résének (CVE-2008-3477) hibáit enyhítő tényezők
...
#### A Naptár objektum érvényesítési biztonsági rését (CVE-2008-3477) elkerülő megoldások
...
-   Hozzáférés-szabályozási lista (ACL) módosítása a VBE6.DLL fájlban a Mindenki csoport letiltása érdekében
  
    **Windows 2000 és Windows XP esetén**
  
    A VBE6.DLL hozzáférés-szabályozási listája (ACL) módosításához és a jogosultságok korlátozásához hajtsa végre a következő lépéseket:
    ...
    **A megoldás hatása:** A beágyazott ActiveX vezérlők nem működnek az Office dokumentumokban. A felhasználók nem szúrhatnak be objektumokat a dokumentumokba.
    ...
    **Windows Vista és Windows Server 2008 esetén**
    ...
    Rendszergazdai jogosultsággal írja a következő parancsot a parancssorba:  
    icacls "%ProgramFiles%\\Common Files\\Microsoft Shared\\VBA\\VBA6\\vbe6.dll" /save %TEMP%\\VBE6\_ACL.TXT
  
#### Gyakran feltett kérdések a Naptár objektum érvényesítési biztonsági réséről (CVE-2008-3477)
...
Az Excel nem megfelelően végzi el a VBA Performance Cache adatainak érvényesítését.
...
A frissítés módosítja az Excel azon eljárását, amely az ActiveX-vezérlőket tartalmazó VBA Performance Cache betöltését kezeli.
...
Fájlformátum-elemzési biztonsági rés - CVE-2008-3471  
----------------------------------------------------
  
A távoli kódfuttatást lehetővé tévő biztonsági rés a Microsoft Excelben az Excel objektumok betöltésekor történő nem megfelelő memóriafoglalás miatt keletkezik. A biztonsági rés távoli kódfuttatást tesz lehetővé amennyiben a felhasználó megnyit egy speciálisan létrehozott, hibás objektumot tartalmazó Excel fájlt. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2008-3471](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3471).
  
#### Fájlformátum-elemzési biztonsági rés súlyosságát enyhítő tényezők - CVE-2008-1444
...
#### A fájlformátum-elemzési biztonsági rést - CVE-2008-1444 - elkerülő megoldások
...
#### Gyakran feltett kérdések a fájlformátum-elemzési biztonsági résről - CVE-2008-1444
...
**Mi okozza a biztonsági rést?**  
A Microsoft Excelben lévő biztonsági rés lehetővé teszi, hogy a támadó távoli kódfuttatást hajtson végre egy speciálisan kialakított, a támadótól érkező Excel táblázat megnyitásakor. A konkrét hiba abban a módszerben van, ahogyan a Microsoft Excel az Excel táblázatot elemzi.
  
**Mire használhatja a biztonsági rést a támadó?**  
A biztonsági rést sikeresen kihasználó támadó tetszőleges programkódot futtathat a bejelentkezett felhasználó nevében. Ha valamely felhasználó felügyeleti jogosultságokkal bejelentkezett a rendszerbe, akkor a támadó teljes mértékben átveheti az irányítást a számítógép felett. Ezt követően a támadó programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén
  
**Hogyan használhatja ki a támadó a biztonsági rést?**  
A biztonsági rés akkor használható ki, ha a felhasználó különlegesen kialakított Excel táblázatot nyit meg a Microsoft Excel érintett verziójával.  
E-mailes támadás esetén a támadó úgy próbálja kihasználni a biztonsági rést, hogy helytelenül formázott Excel fájlt küld a felhasználónak, és meggyőzi, hogy nyissa meg azt.  
Internetes támadás esetén a támadónak olyan webhelyet kell üzemeltetnie, amely a biztonsági rés kihasználását lehetővé tevő Office fájlt tartalmaz. Az érintett weboldalak és a felhasználó által biztosított tartalomnak, esetleg hirdetéseknek helyet adó weboldalak is tartalmazhatnak a biztonsági rést kihasználni képes különlegesen kialakított tartalmat. A támadónak nincs lehetősége arra, hogy a felhasználót a különlegesen kialakított webhely megnyitására kényszerítse. Ehelyett a támadóknak saját webhelyükre kell csábítaniuk a felhasználókat, ezt pedig rendszerint egy kifejezetten ezt a célt szolgáló hivatkozás segítségével érik el.
...
**Mi a frissítés feladata?**  
A frissítés a biztonsági rés kiküszöböléséhez módosítja azt a módszert, ahogyan a Microsoft Excel a BIFF fájlokat kezeli.
...
Képletelemzési biztonsági rés - CVE-2008-4019  
---------------------------------------------
  
A konkrét hiba a cellába beágyazott, speciálisan kialakított képletet tartalmazó Microsoft Excel dokumentumok elemzésekor keletkezik. Ennek eredményeként az aktuálisan bejelentkezett felhasználó nevében lehet távolból veszélyeztetni a rendszer integritását.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2008-4019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4019).
  
#### A képletelemzési biztonsági rés - CVE-2008-4019 - súlyosságát enyhítő tényezők
...
#### A képletelemzési biztonsági rést - CVE-2008-4019 - elkerülő megoldások
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran feltett kérdések a képletelemzési biztonsági résről - CVE-2008-4019
  
**Mire terjed ki a biztonsági rés hatása?**  
A biztonsági rés távolról történő kódfuttatást tehet lehetővé. Ha egy támadó sikeresen kihasználja a biztonsági rést, teljes mértékben átveheti az érintett rendszer távoli irányítását. Ezt követően programokat telepíthet vagy adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Mi okozza a biztonsági rést?**  
Az Excel SOKSZOR függvénye a cella teljes megengedett hosszáig egészszám-túlcsordulást tehet lehetővé, ami kihasználható helyzetet eredményez.
...
**Mi a frissítés feladata?**  
Ez a frissítés megszünteti az egészszám-túlcsordulást az Excel fájlok memóriába töltésekor.
...
| Microsoft Office SharePoint Server 2007 x64 Edition                                                                | Igen     |  
| Microsoft Office SharePoint Server 2007 x64 Edition Service Pack 1                                                 | Igen     |
...
| Microsoft Office SharePoint Server 2007 x64 Edition                                                                | Nem     | Nem                      | Igen. Lásd a **Megjegyzés Microsoft Office SharePoint Server 2007 esetén** című részt alább | Igen. Lásd a **Megjegyzés Microsoft Office SharePoint Server 2007 esetén** című részt alább |  
| Microsoft Office SharePoint Server 2007 x64 Edition Service Pack 1                                                 | Nem     | Nem                      | Igen. Lásd a **Megjegyzés Microsoft Office SharePoint Server 2007 esetén** című részt alább | Igen. Lásd a **Megjegyzés Microsoft Office SharePoint Server 2007 esetén** című részt alább |
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/956416">Microsoft Tudásbázis 956416. számú cikkét</a></td>
</tr>
<tr class="even">
...
A biztonsági frissítéshez Windows Installer 3.1 vagy frissebb verzió telepítése szükséges. A Windows minden támogatott verziója tartalmazza a Windows Installer 3.1 vagy újabb verzióját.
...
Töltse le és telepítse a megfelelő nyelvi változatot a Microsoft Office 2004 for Mac 11.5.2 frissítéshez a [Microsoft Letöltőközpontból](http://www.microsoft.com/downloads/details.aspx?familyid=ba4fa21a-7e01-4ef8-9b9f-9d51d00ef094).
...
-   Nyissa meg a Microsoft Office 2004 for Mac 11.5.2 Update elemet az Asztalon. Ezt a lépést már lehet, hogy végrehajtották.  
-   A frissítés elindításához a Microsoft Office 2004 for Mac 11.5.2 Update ablakban kattintson duplán a Microsoft Office 2004 for Mac 11.5.2 Update alkalmazásra, majd kövesse a képernyőn megjelenő utasításokat.  
-   A telepítés sikeres befejeződését követően a frissítés telepítője eltávolítható a merevlemezről. A telepítés sikerességének ellenőrzéséhez olvassa el „A frissítés telepítésének ellenőrzése” című részben írottakat. A frissítés telepítőjének eltávolításához húzza először az Microsoft Office 2004 for Mac 11.5.2 Update kötetet a Lomtárba, majd tegye ugyanezt a letöltött fájllal is.
...
Amennyiben a program verziószáma **11.5.2**, a frissítés telepítése sikeresen megtörtént.
...
Töltse le és telepítse a megfelelő nyelvi változatot a Microsoft Office 2008 for Mac 12.1.3 frissítéshez a [Microsoft Letöltőközpontból](http://www.microsoft.com/downloads/details.aspx?familyid=e70c5ae0-2858-46de-81f8-dcd1786656b7).
  
-   Lépjen ki az összes futó alkalmazásból, beleértve a víruskereső programokat is, zárja be az összes Microsoft Office alkalmazást, a Microsoft Messenger for Mac alkalmazást és az Office értesítéseket, mivel ezek zavarhatják a telepítést.  
-   Nyissa meg a Microsoft Office 2008 for Mac 12.1.3 Update elemet az asztalon. Ezt a lépést már lehet, hogy végrehajtották.  
-   A frissítés elindításához a Microsoft Office 2008 for Mac 12.1.3 Update ablakban kattintson duplán a Microsoft Office 2008 for Mac 12.1.3 Update alkalmazásra, majd kövesse a képernyőn megjelenő utasításokat.  
-   A telepítés sikeres befejeződését követően a frissítés telepítője eltávolítható a merevlemezről. A telepítés sikerességének ellenőrzéséhez olvassa el „A frissítés telepítésének ellenőrzése” című részben írottakat. A frissítés telepítőjének eltávolításához húzza először a Microsoft Office 2008 for Mac 12.1.3 Update kötetet a Lomtárba, majd tegye ugyanezt a letöltött fájllal is.
...
Amennyiben a program verziószáma **12.1.3**, a frissítés telepítése sikeresen megtörtént.
...
Töltse le és telepítse az Open XML File Format Converter for Mac 1.0.1 Update megfelelő nyelvi változatát a [Microsoft letöltő központjából](http://www.microsoft.com/downloads/details.aspx?familyid=2a8d9a3b-b8a4-43b6-82a6-a2e7d16ae11d).
  
-   Lépjen ki az összes futó alkalmazásból, beleértve a víruskereső programokat is, zárja be az összes Microsoft Office alkalmazást, a Microsoft Messenger for Mac alkalmazást és az Office értesítéseket, mivel ezek zavarhatják a telepítést.  
-   Nyissa meg az Open XML File Format Converter for Mac 1.0.1 Update kötetet az asztalon. Ezt a lépést már lehet, hogy végrehajtották.  
-   A frissítés elindításához az Open XML File Format Converter for Mac 1.0.1 Update ablakban kattintson duplán az Open XML File Format Converter for Mac 1.0.1 Update alkalmazásra, majd hajtsa végre a képernyőn megjelenő utasításokat.  
-   A telepítés sikeres befejeződését követően a frissítés telepítője eltávolítható a merevlemezről. A telepítés sikerességének ellenőrzéséhez olvassa el „A frissítés telepítésének ellenőrzése” című részben írottakat. A frissítés telepítőjének eltávolításához húzza először az Open XML File Format Converter for Mac 1.0.1 Update kötetet a Lomtárba, majd tegye ugyanezt a letöltött fájllal is.
...
Amennyiben a program verziószáma **1.0.1**, a frissítés telepítése sikeresen megtörtént.
...
-   Wushi, [Tipping Point](http://www.tippingpoint.com/) és az együttműködő [Zero Day Initiative](http://www.zerodayinitiative.com/), a fájlformátum elemzése miatti biztonsági rés (CVE-2008-3471) jelentéséért  
-   Lionel d'Hauenens, [Labo Skopia](http://www.laboskopia.com/), és a vele együttműködő [iDefense VCP](http://labs.idefense.com/), a Naptár objektum érvényesítési biztonsági rése (CVE-2008-3477) jelentéséért.  
-   Joshua J. Drake, [iDefense](http://labs.idefense.com/), a Naptár objektum érvényesítési biztonsági rése (CVE-2008-3477) jelentéséért.
...
-   1.1 verzió (2008. október 15.): A Systems Management Server észlelési és telepítési összefoglalója a Microsoft Office Excel Viewer 2003 minden támogatott verziója esetén „igen” értékre módosult az **Észlelési és telepítési eszközök, útmutatás** című alfejezetben. A módosítás csak tájékoztató jellegű. A biztonsági frissítéshez kapcsolódó bináris fájlok és az észlelési logika nem változott.  
-   1.2 verzió (2008. október 29.): A **Gyakran ismételt kérdések (GYIK) a biztonsági frissítéssel kapcsolatban** című rész a frissítésben szereplő, a Microsoft Office 2003 Service Pack 2 programhoz tartozó kiegészítő biztonsági funkciókat taglaló bejegyzéssel bővült. Az **Észlelési és telepítési eszközök, útmutatás** című részbe bekerültek az Excel 2003 Service Pack 3 programra vonatkozó hiányzó bejegyzések. Végezetül javítottuk a Windows Installer Redistributable programra mutató hivatkozásokat a **Biztonsági frissítés telepítése** című részben. A módosítás csak tájékoztató jellegű. A biztonsági frissítéshez kapcsolódó bináris fájlok nem változtak.
