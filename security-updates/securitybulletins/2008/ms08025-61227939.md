---
TOCTitle: 'MS08-025'
Title: 'A Microsoft számú biztonsági közleménye MS08-025 - Fontos'
ms:assetid: 'ms08-025'
ms:contentKeyID: 61227939
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms08-025(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS08-025 - Fontos
=========================================================

A Windows kernel jogok kiterjesztését lehetővé tévő biztonsági rése (941693)
----------------------------------------------------------------------------
...
A Windows 2000, Windows XP, Windows Server 2003, Windows Vista és Windows Server 2008 rendszerek összes támogatott kiadására nézve ez a biztonsági frissítés fontos besorolásúnak minősül. További tudnivalókért tekintse meg az **Érintett és nem érintett szoftverek** c. részt.

A biztonsági frissítés a biztonsági rés elhárítása végett módosítja a felhasználói módban küldött beviteli adatok hitelesítési módját a Windows kernelen. A biztonsági réssel kapcsolatos bővebb információkat lásd az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben.

**Javaslat**  A Microsoft a biztonsági frissítés lehető leghamarabb történő telepítését javasolja ügyfeleinek.

**Ismert problémák** A [Microsoft Tudásbázis 941693. cikkében](http://support.microsoft.com/kb/941693) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen, jelenleg már ismert problémákkal találkozhatnak.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=8db9f328-da0e-4fb8-96c4-6d368b47c224)                                                                      | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e937f65-abd0-46dd-8883-5bfd70ea1178)                                                                                  | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows XP Professional x64 Edition és Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a29bbd13-761f-44fa-8948-e1a8c244bd7a)                  | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 Service Pack 1 és Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d3b855a6-4648-4771-826d-11a151828eac)                                   | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 x64 Edition és Windows Server 2003 x64 Edition Service Pack 2 rendszerhez](http://www.microsoft.com/downloads/details.aspx?familyid=320fd100-35e1-4345-9399-796393235cbc)              | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 SP1 Itanium alapú rendszerekhez és Windows Server 2003 SP2 Itanium alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=126426a7-be38-4327-89db-02d99d76589d) | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Vista és Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9640cd8b-d749-4ddd-8af9-b298cebed969)                                                              | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Vista x64 Edition és Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d56bb4fe-304e-45e0-95f2-fde2f47b2a04)                                      | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2008 32 bites rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=4497333c-9418-4b91-83dc-0155735421c0)                                                                 | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2008 x64 alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=5aefc7a6-79a4-45a2-b534-35d0ec400dda)                                                                | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2008 for Itanium-based Systems](http://www.microsoft.com/downloads/details.aspx?familyid=3080c26b-7456-41ef-8668-28f15bc7b8ce)                                                              | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
...
<th style="border:1px solid black;" >A Windows kernel biztonsági rése - CVE-2008-1084</th>
...
A Windows kernel biztonsági rése - CVE-2008-1084  
------------------------------------------------
...
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2008-1084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1084).
  
#### A Windows kernel biztonsági résének (CAN-2008-1084) hibáit enyhítő tényezők
...
#### A Windows kernel biztonsági résének (CAN-2008-1084) lehetséges megoldásai
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran feltett kérdések a Windows kernel biztonsági rése (CAN-2008-1084) kapcsán
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés jogok kiterjesztését teheti lehetővé. Ha egy támadó kihasználja a biztonsági rést, távolról mesterséges kódot futtathat és teljes mértékben átveheti az érintett rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Mi okozza a biztonsági rést?**    
A felhasználói módban küldött beviteli adatok helytelen hitelesítése a Windows kernelen.
...
A biztonsági rést sikeresen kihasználó támadó kernel módban mesterséges kódot futtathat az érintett rendszeren. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
...
A frissítés a felhasználói módú visszahívásokból kapott paraméterek Windows kernelen történő helyes hitelesítésével szünteti meg a biztonsági rést.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Használja a Vezérlőpult Programok telepítése és törlése lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB941693$\Spuninst mappában található</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/941693">Microsoft Tudásbázis 941693 számú</a> cikkét</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Információ az eltávolításhoz</strong></td>
<td style="border:1px solid black;">Használja a Vezérlőpult Programok telepítése és törlése lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB941693$\Spuninst mappában található</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/941693">Microsoft Tudásbázis 941693 számú</a> cikkét</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Információ az eltávolításhoz</strong></td>
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\$NTUninstallKB941693$\Spuninst mappában található</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/941693">Microsoft Tudásbázis 941693 számú</a> cikkét</td>
...
-   Thomas Garnier, a Windows kernel biztonsági résének (CVE-2008-1084) jelentéséért.
...
-   1.1 verzió (2008. április 9.): Közlemény frissítve az ismert problémákat részletező GYIK szakasz értelmezésével.  
