---
TOCTitle: 'MS11-085'
Title: 'A Microsoft számú biztonsági közleménye MS11-085 - Fontos'
ms:assetid: 'ms11-085'
ms:contentKeyID: 61228832
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-085(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS11-085 - Fontos
=========================================================

A Windows Mail és a Windows Tárgyaló biztonsági rése távoli programkódfuttatásra adhat lehetőséget (2620704)
------------------------------------------------------------------------------------------------------------
...
A biztonsági frissítés a Windows Vista összes támogatott kiadására nézve fontos, a Windows Server 2008 összes támogatott kiadására nézve mérsékelt, a Windows 7 és a Windows Server 2008 R2 rendszerek összes támogatott kiadására nézve pedig alacsony besorolásúnak minősül. További tudnivalókat a közlemény későbbi részében, az **Érintett és nem érintett szoftverek** cím alatt talál.

A biztonsági frissítés a biztonsági rés kiküszöbölése végett kijavítja a külső függvénytárak betöltési módját a Windows Mail és Windows Tárgyaló alkalmazásban. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524)                                                                                            | Távoli kódfuttatás         | Fontos                           | Nincsenek                                |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38)                                                                                | Távoli kódfuttatás         | Fontos                           | Nincsenek                                |
| [Windows Server 2008 32 bites rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc)\*\*                                                          | Távoli kódfuttatás         | Mérsékelt                        | Nincsenek                                |
| [Windows Server 2008 x64 alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9)\*\*                                                         | Távoli kódfuttatás         | Mérsékelt                        | Nincsenek                                |
| [Windows Server 2008 Itanium-alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc)                                                         | Távoli kódfuttatás         | Mérsékelt                        | Nincsenek                                |
| [Windows 7 32 bites rendszerekhez és Windows 7 32 bites rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9)                                     | Távoli kódfuttatás         | Alacsony                         | Nincsenek                                |
| [Windows 7 x64 alapú rendszerekhez és Windows 7 x64 alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960)                                   | Távoli kódfuttatás         | Alacsony                         | Nincsenek                                |
| [Windows Server 2008 R2 x64 alapú rendszerekhez és Windows Server 2008 R2 x64 alapú rendszerekhez, Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5)\*\*    | Távoli kódfuttatás         | Alacsony                         | Nincsenek                                |
| [Windows Server 2008 R2 Itanium alapú rendszerekhez és Windows Server 2008 R2 Itanium alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1) | Távoli kódfuttatás         | Alacsony                         | Nincsenek                                |
...
A Windows Server 2008 operációs rendszeren számos asztali funkció, például a Windows Mail, alapértelmezés szerint nincs telepítve, hanem az Asztali élmény összetevővel egyszerre telepíthetők a Windows Server 2008 rendszerre. Erről bővebb információt a [Windows Mail, Windows Media Player és a Windows Server 2008 Asztali élmény további elemei](http://technet.microsoft.com/en-us/library/cc771519(ws.10).aspx) című TechNet-cikkben talál.

**Miért ajánlja fel a rendszer a frissítést a Windows Server 2008 rendszerekhez, függetlenül attól, hogy telepítettem-e az Asztali élmény alkalmazást?**
A biztonsági rést jelentő kód az Asztali élmény telepítésétől függetlenül megtalálható a Windows Server 2008 rendszereken. Mivel az érintett kód jelen van, a rendszer felajánlja a frissítést.

Másrészt viszont a biztonsági rés a Windows Mail és a Windows Tárgyaló programokon keresztül használható ki. A Windows Tárgyaló és a Windows Mail alapértelmezés szerint nincs telepítve a Windows Server 2008 operációs rendszeren. Azokon a rendszereken, amelyeken nincs telepítve a Windows Tárgyaló és a Windows Mail alkalmazás, az érintett kód nem érhető el.

A Windows Mail az Asztali élmény összetevővel telepíthető a Windows Server 2008 rendszerre. A azt ajánlja, hogy a Windows Server 2008 felhasználói a lehetséges támadási felületek megszüntetése érdekében alkalmazzák a frissítést.

**Miért alacsonyabb a súlyossági besorolás a Windows 7 és Windows Server 2008 R2 rendszerek esetében? 
**Noha az érintett kód a Windows 7 és Windows Server 2008 R2 rendszereken is létezik, a Microsoftnak jelenleg nincs tudomása a biztonsági rés kihasználását lehetővé tévő támadási felületről ezeken az operációs rendszereken. Továbbra is ajánlott azonban, hogy ezen operációs rendszerek felhasználói mélyreható biztonsági megoldásként telepítsék a frissítést.
...
**Más levelezési ügyfélprogramot, például a Windows Live Mail vagy az Outlook Express alkalmazást is érinti a probléma? 
**Nem. A biztonsági rés kizárólag az Érintett szoftverek részben felsorolt operációs rendszereken található Windows Mail programokat érinti. Egyéb alkalmazás nem érintett.
...
<th style="border:1px solid black;" >
A Windows Mail nem biztonságos függvénytárbetöltése miatti biztonsági rés – CVE-2011-2016
</th>
...
A biztonsági rést a DLL-fájlok betöltése okozza a Windows Mail és Windows Tárgyaló programokban. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén

A biztonsági rés standard bejegyzésének megtekintéséhez a gyakran előforduló biztonsági rések besorolási listáján lásd: [CVE-2011-2016](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016).

#### A Windows Mail nem biztonságos függvénytárbetöltése miatti biztonsági rés (CVE-2011-2016) súlyosságát enyhítő tényezők

Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:

-   A sikeres támadáshoz a felhasználónak egy nem megbízhatónak ítélt távoli fájlrendszerre vagy WebDAV megosztásra kell ellátogatnia, majd onnan megbízható fájlt (például .eml vagy .wcinv fájlt) kell megnyitnia, amelyet ezt követően a biztonsági rés által érintett alkalmazás betölt.
...
-   A Windows Mail és a Windows Tárgyaló alapértelmezés szerint nincs telepítve a Windows Server 2008 operációs rendszeren. A Windows Mail kizárólag az Asztali élmény telepítésekor települ.
-   Noha az érintett kód a Windows 7 és Windows Server 2008 R2 rendszereken is létezik, a Microsoftnak jelenleg nincs tudomása a biztonsági rés kihasználását lehetővé tévő támadási felületről ezeken az operációs rendszereken.

#### A Windows Mail nem biztonságos függvénytárbetöltése miatti biztonsági rés (CVE-2011-2016) lehetséges megoldásai
...
#### Gyakran ismételt kérdések a Windows Mail nem biztonságos függvénytárbetöltése miatti biztonsági réssel (CVE-2011-2016) kapcsolatban

**Mire terjed ki a biztonsági rés hatása?**
A biztonsági rés távolról történő kódfuttatást tehet lehetővé. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.

**Mi okozza a biztonsági rést?**
A biztonsági rés oka, hogy a Windows Mail és a Windows Tárgyaló nem megfelelően korlátozza a külső függvénytárak betöltésekor használatos elérési utat.
...
**Mi az a Windows Tárgyaló?**
A Windows Tárgyaló segítségével megoszthatja dokumentumait, programjait vagy az Asztalt más, Windows Vista operációs rendszerű számítógéppel rendelkező felhasználókkal. A társközi (peer-to-peer) technológiát alkalmazó Windows Tárgyaló automatikusan ad hoc hálózatot hoz létre, ha nem talál létező hálózatot. További információkat [A Windows Tárgyaló programmal kapcsolatos gyakran ismételt kérdések](http://windows.microsoft.com/en-us/windows-vista/windows-meeting-space-frequently-asked-questions) között találhat.
...
A támadó ráveheti a felhasználót, hogy olyan megbízható fájlt (például .eml vagy .wcinv fájlt) nyisson meg, amely azonos hálózati meghajtón található, mint egy különlegesen kialakított dinamikus csatolású függvénytár (DLL) fájl. Ezután a megbízható fájl megnyitásakor a Windows Mail vagy a Windows Tárgyaló megpróbálhatja betölteni a DLL-fájlt, és végrehajtani az abban található kódot.

E-mailes támadás esetén a támadó a biztonsági rés kihasználásával megbízható fájlt (például .eml vagy .wcinv fájlt) küld a felhasználónak, és ráveszi, hogy az olyan könyvtárba helyezze a mellékletet, amely különlegesen kialakított DLL fájlt tartalmaz, és itt nyissa meg a megbízható fájlt. Ezután a megbízható fájl megnyitásakor a Windows Mail vagy a Windows Tárgyaló megpróbálhatja betölteni a DLL-fájlt, és végrehajtani az abban található kódot.

Hálózati támadás esetén a támadó hálózati megosztáson, UNC vagy WebDAV helyen helyezheti el a megbízható fájlt (például .eml vagy .wcinv fájlt) és a különlegesen kialakított DLL-fájlt, majd ráveheti a felhasználót, hogy nyissa meg a fájlt.

**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**
Elsősorban azok a rendszerek (munkaállomások és terminálkiszolgálók) vannak kockázatnak kitéve, amelyeken Windows Mail vagy Windows Tárgyaló programot használnak. A kiszolgáló nagyobb kockázatnak van kitéve, ha a rendszergazda engedélyezi a felhasználóknak a kiszolgálóra történő bejelentkezést és a programok futtatását. Ezt azonban a gyakorlati tanácsok értelmében feltétlenül kerülni kell.

**Mi a frissítés feladata?**
A frissítés a biztonsági rés kiküszöbölése végett kijavítja a külső függvénytárak betöltési módját a Windows Mail és Windows Tárgyaló alkalmazásban.
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2620704">Microsoft Tudásbázis 2620704. számú cikkét</a></td>
</tr>
<tr class="odd">
...
-   Ivan Sanchez, EvilCode a Windows Mail nem biztonságos függvénytárbetöltése miatti biztonsági rés (CVE-2011-2016) jelentéséért
