---
TOCTitle: 'MS11-058'
Title: 'A Microsoft számú biztonsági közleménye MS11-058 - Kritikus'
ms:assetid: 'ms11-058'
ms:contentKeyID: 61228805
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-058(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS11-058 - Kritikus
===========================================================

A DNS-kiszolgáló biztonsági rései távolról történő kódfuttatást tehetnek lehetővé (2562485)
-------------------------------------------------------------------------------------------

Közzétéve: 2011. augusztus 9. | Frissítve: 2011. október 25.
...
Ez a biztonsági frissítés Kritikus besorolású a Windows Server 2008 32 bites és az x64 alapú kiadásainál, és a Windows Server 2008 R2 x64 alapú kiadásainál; Fontos besorolású a Windows Server 2003 összes támogatott kiadása esetén. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.

A biztonsági frissítés úgy küszöböli ki a biztonsági réseket, hogy megváltoztatja azt az eljárást, amelyikkel a DNS kiszolgáló a NAPTR lekérdezéseket kezeli a memóriában, és amelyikkel a használatuk előtt az objektumokat inicializálja a memóriában. A biztonsági résekkel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2d4aa38-9241-465d-8d65-aba73e936d0f)                                                                                | Szolgáltatásmegtagadás     | Fontos                           | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2db4098a-f4f9-4211-b55d-5d0df1409c43)                                                                    | Szolgáltatásmegtagadás     | Fontos                           | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 SP2 Itanium-alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=1934acfa-5637-4ae9-9e9a-fc7e58930b7a)                                                               | Szolgáltatásmegtagadás     | Fontos                           | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2008 32 bites rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ac2d5122-6f9b-46f5-9840-77aa7ff84308)\*                                                      | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                                 |
| [Windows Server 2008 x64 alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5f605f6f-3854-403d-878b-637626aef78f)\*                                                     | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                                 |
| [Windows Server 2008 R2 x64 alapú rendszerekhez és Windows Server 2008 R2 x64 alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6a86e2cf-4e7d-4012-88c3-6957a3842dd3)\* | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                                 |
...
**iért módosították a közleményt** **2011.október** **25-én?**  
A Microsoft által módosított közlemény a Windows Server 2003 valamennyi támogatott verziójának vonatkozásában szerepelnek a helyes felváltó közlemény adatai és az észlelési logika módosításai. A biztonsági frissítéshez kapcsolódó fájlok nem változtak. A rendszer frissítését már elvégzett felhasználóknak több tennivalójuk nincsen.
...
<th style="border:1px solid black;" >DNS - NAPTR lekérdezések miatti biztonsági rés - CVE-2011-1966</th>
<th style="border:1px solid black;" >DNS - Inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés – CVE-2011-1970</th>
...
DNS - NAPTR lekérdezések miatti biztonsági rés - CVE-2011-1966  
--------------------------------------------------------------
  
A Windows DNS Server azért tartalmazza a távoli kódfuttatást lehetővé tevő biztonsági rést, mert a speciálisan kialakított NAPTR lekérdezés karakterláncát a memóriában nem megfelelően kezeli. A biztonsági rést sikeresen kihasználó támadó tetszőleges kódot futtathat a rendszer környezetében. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1966](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1966).
  
#### A DNS NAPTR lekérdezése miatti biztonsági rés (CVE-2011-1966) súlyosságát enyhítő tényezők
  
A Microsoft egyelőre nem talált enyhítő tényezőket a biztonsági rés megszüntetésére.
  
#### Lehetséges megoldások a DNS NAPTR lekérdezési biztonsági résének - CVE-2011-1966 - kiküszöbölésére
  
A lehetséges megoldás olyan beállítást vagy konfigurációs módosítást takar, amely magát a biztonsági rést nem szünteti meg, azonban a frissítés telepítése előtt segít az ismert támadási lehetőségek kivédésében. A Microsoft alaposan megvizsgálta a következő lehetséges megoldásokat, és tájékoztatja a felhasználókat, amennyiben a megoldás csökkenti a működőképességet:
  
-   **Ha nem használja, tiltsa le a DNS szolgáltatást**
  
    **Interaktív módszer:**
  
    1.  Kattintson a **Start** menü **Futtatás** parancsára, írja be a **regedit** parancsot, majd kattintson az **OK** gombra.  
    2.  Bontsa ki a **HKEY\_LOCAL\_MACHINE**, a **System**, a **CurrentControlSet**, végül a **Szolgáltatások** elemet.  
    3.  Kattintson a **DNS** elemre.  
    4.  Kattintson a **Fájl** menü **Exportálás** elemére.  
    5.  A Beállításjegyzék exportálása párbeszédpanelen adja meg a **DNS\_configuration\_backup.reg** nevet, és kattintson a **Mentés** gombra.  
    ...
    **Vezérelt telepítési parancsfájl segítségével:**
    ...
    2.  A következőket mentse egy .REG kiterjesztésű fájlba (pl. "Disable\_service\_DNSame.reg"):  
    ...
    3.  A következő paranccsal futtassa a fenti 2. lépésben létrehozott rendszerleíró parancsfájlt a célgépen:  
    ...
    **Interaktív módszer:**
    ...
    3.  A Beállításjegyzék importálása párbeszédpanelen adja meg a **DNS\_configuration\_backup.reg** nevet, és kattintson a **Megnyitás** gombra.
  
    **Vezérelt telepítési parancsfájl segítségével:**
  
    Állítsa vissza rendszergazdaként futtatva a parancssorból a következő parancsot:  
    `Regedit /s DNS_configuration_backup.reg`
  
#### Gyakran ismétlődő kérdések a DNS NAPTR lekérdezési biztonsági réséről - CVE-2011-1966
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés távolról történő kódfuttatást tehet lehetővé.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rés akkor keletkezik, amikor egy nem mérvadó DNS kiszolgáló nem megfelelően kezeli a speciálisan kialakított NAPTR bejegyzést a memóriában, miközben ismétlődően lekéri a bejegyzést a mérvadó DNS kiszolgálótól.
  
**Melyik összetevőt érinti a biztonsági rés?**    
A Dns.exe a biztonsági rés által érintett összetevő.
  
**Mire használhatja a biztonsági rést a támadó?**    
A biztonsági rést sikeresen kihasználó támadó tetszőleges kódot futtathat a rendszer környezetében. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Hogyan használhatja ki a támadó a biztonsági rést?**    
A távoli hitelesítetlen támadó kihasználhatja ezt a biztonsági rést, ha regisztrál egy tartományt, létrehoz egy NAPTR DNS erőforrás-bejegyzést, majd egy speciálisan kialakított NAPTR lekérdezést küld a célként kiszemelt DNS kiszolgálóra.
...
**Mi az a NAPTR DNS erőforrás-bejegyzés?**    
A NAPTR (Naming Authority Pointer - névhitelességi mutató) DNS erőforrás-bejegyzése (RR) teszi lehetővé, hogy a DNS használható legyen szolgáltatások keresésére az erőforrásnevek széles skálájához, köztük az olyan URI azonosítókhoz is, amelyek nem szerepelnek a tartományi nevek szintaxisában. A NAPTR vonatkozású további tudnivalók az [RFC-2915](http://www.ietf.org/rfc/rfc2915.txt) dokumentumban találhatók.
...
**Mi az URI?**    
Az URI (egységes erőforrás-azonosító) olyan karakterlánc, mely internetes illetve hálózati erőforrások azonosítására szolgál. Az URL olyan URI-elem, mely például egy webhelyet jelöl meg erőforrás gyanánt. Az URI-elemekről további információkat az [RFC-2396](http://www.ietf.org/rfc/rfc2915.txt) cikkben talál.
  
**Mi a frissítés feladata?**    
A frissítés a biztonsági rés megszüntetése érdekében módosítja azt ahogyan a DNS kiszolgáló a NAPTR lekérdezéseket kezeli a memóriában.
...
DNS - Inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés – CVE-2011-1970  
-------------------------------------------------------------------------------------------
  
A szolgáltatásmegtagadás okozó biztonsági rés akkor keletkezik, amikor a DNS kiszolgáló nem megfelelően kezel a memóriában egy nem inicializált objektumot. A biztonsági rést sikeresen kihasználó támadó elérheti, hogy a DNS kiszolgáló ne válaszoljon a célrendszernek.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1970).
  
#### A DNS inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés (CVE-2011-1970) súlyosságát enyhítő tényezők
  
A Microsoft egyelőre nem talált enyhítő tényezőket a biztonsági rés megszüntetésére.
  
#### Lehetséges megoldások a DNS inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés (CVE-2011-1970) kiküszöbölésére
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismétlődő kérdések a DNS inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés (CVE-2011-1970) kapcsán
  
**Mire terjed ki a biztonsági rés hatása?**    
Ez a biztonsági rés szolgáltatásmegtagadást okoz.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rés akkor keletkezik, amikor a DNS kiszolgáló nem megfelelően kezel a memóriában egy nem inicializált objektumot, miközben egy nem létező tartomány erőforrásrekordját keresi.
  
**Melyik összetevőt érinti a biztonsági rés?**    
A Dns.exe a biztonsági rés által érintett összetevő.
  
**Mire használhatja a biztonsági rést a támadó?**    
A biztonsági rést sikeresen kihasználó támadó elérheti, hogy a DNS kiszolgáló ne válaszoljon a célrendszernek.
  
**Hogyan használhatja ki a támadó a biztonsági rést?**    
A távoli hitelesítetlen támadó kihasználhatja ezt a biztonsági rést, ha egy speciálisan kialakított, nem létező tartomány erőforrásrekordjára vonatkozó DNS lekérdezést küld a célként kiszemelt DNS kiszolgálóra.
...
**Mi a frissítés feladata?**    
A frissítés a biztonsági rés megszüntetése érdekében módosítja azt ahogyan a DNS kiszolgáló a memóriában a használatuk előtt inicializálja az objektumokat.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2562485$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd: <a href="http://support.microsoft.com/kb/2562485">Microsoft Tudásbázis 2562485 cikke</a></td>
</tr>
<tr class="even">
...
-   Grischa Zengel (Zengel Medizintechnik GmbH), a DNS NAPTR lekérdezések miatti biztonsági rés (CVE-2011-1966) jelentéséért
...
-   1.1 verzió (2011. szeptember 21.): Az érintett szoftverek javított táblázatából kikerült az utalás az MS11-046 közleményre, amelyet a jelen frissítés vált fel a Windows Server 2003 minden érintett kiadása esetén. A szóban forgó módosítás csak észlelési módosítás. A biztonsági frissítéshez kapcsolódó fájlok nem változtak. A rendszer frissítését már elvégzett felhasználóknak több tennivalójuk nincsen.  
-   1.2 verzió (2011. október 25.): Módosítottuk az észlelési logikát és javítottuk a közlemények felváltására vonatkozó információkat az érintett konfigurációknál. A biztonsági frissítéshez kapcsolódó fájlok nem változtak. Lásd a gyakori frissítési kérdéseket.
