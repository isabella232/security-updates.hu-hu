---
TOCTitle: 'MS11-083'
Title: 'A Microsoft számú biztonsági közleménye MS11-083 - Kritikus'
ms:assetid: 'ms11-083'
ms:contentKeyID: 61228830
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-083(v=Security.10)'
author: SharonSears
ms.author: SharonSears
---


A Microsoft számú biztonsági közleménye MS11-083 - Kritikus
===========================================================

A TCP/IP biztonsági rése távoli kódfuttatást tehet lehetővé (2588516)
---------------------------------------------------------------------
...
A biztonsági frissítés a Microsoft Windows közvetlenül jelentett biztonsági rését szünteti meg. A biztonsági rés távolról történő kódfuttatást tehet lehetővé, ha a támadó folyamatosan speciálisan kialakított UDP-csomagokat küld a célrendszer zárt portjára.
...
A biztonsági frissítés a biztonsági rés elhárítása érdekében módosítja a Windows TCP/IP-verem memórián belüli, UDP-csomagokra vonatkozó nyilvántartási módját. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042)                                                                                            | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39)                                                                                | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 32 bites rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521)\*                                                            | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 x64 alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d)\*                                                           | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 Itanium-alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f)                                                         | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7 32 bites rendszerekhez és Windows 7 32 bites rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7)                                     | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7 x64 alapú rendszerekhez és Windows 7 x64 alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5)                                   | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2 x64 alapú rendszerekhez és Windows Server 2008 R2 x64 alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f)\*       | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2 Itanium alapú rendszerekhez és Windows Server 2008 R2 Itanium alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad) | Kritikus                   | Távoli kódfuttatás               | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
...
<th style="border:1px solid black;" >A hivatkozásszámláló egészszám-túlcsordulást okozó biztonsági rése - CVE-2011-2013</th>
...
A hivatkozásszámláló egészszám-túlcsordulást okozó biztonsági rése - CVE-2011-2013  
----------------------------------------------------------------------------------
  
A Windows TCP/IP-veremben biztonsági rés található. A biztonsági rést a folyamatosan küldött, különlegesen kialakított UDP-csomagok feldolgozási módja okozza. A biztonsági rést sikeresen kihasználó támadó kernel módban mesterséges kódot futtathat az érintett rendszeren. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a gyakran előforduló biztonsági rések besorolási listáján lásd: [CVE-2011-2013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013).
  
#### A hivatkozásszámláló egészszám-túlcsordulást okozó biztonsági résének (CVE-2011-2013) súlyosságát enyhítő tényezők
  
A Microsoft egyelőre nem talált enyhítő tényezőket a biztonsági rés megszüntetésére.
  
#### A hivatkozásszámláló egészszám-túlcsordulást okozó biztonsági résének (CVE-2011-2013) lehetséges megoldásai
  
A lehetséges megoldás olyan beállítást vagy konfigurációs módosítást takar, amely magát a biztonsági rést nem szünteti meg, azonban a frissítés telepítése előtt segít az ismert támadási lehetőségek kivédésében. A Microsoft alaposan megvizsgálta a következő lehetséges megoldásokat, és tájékoztatja a felhasználókat, amennyiben a megoldás csökkenti a működőképességet:
  
-   **A nem használt UDP-portok letiltása a szervezet külső tűzfalán**
  
    A nem használt (lezárt) UDP-portok külső tűzfalon történő letiltása megakadályozza, hogy a támadók kihasználják a tűzfal mögötti rendszereken a biztonsági rést. A portokkal kapcsolatos további információt lásd a [TCP- és UDP-porthozzárendeléseket](http://go.microsoft.com/fwlink/?linkid=21312) ismertető TechNet-cikkben. A Windows tűzfallal kapcsolatban a [Windows tűzfal beállítása egyetlen számítógépen](http://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx) című TechNet-cikkben talál további információkat.
  
#### Gyakran ismételt kérdések a hivatkozásszámláló egészszám-túlcsordulást okozó biztonsági résével (CVE-2011-2013) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**  
Ez a Windows-rendszermag működésének távoli kódfuttatást okozó biztonsági rése.
  
**Mi okozza a biztonsági rést?**  
A biztonsági rés akkor jön létre, amikor a Windows TCP/IP-verem folyamatosan érkező, speciálisan kialakított UDP-csomagokat dolgoz fel, és ennek eredményeként egészszám-túlcsordulás lép fel.
...
**Mi az az UDP?**     
A User Datagram Protocol (UDP) a 768-as számú, „User Datagram Protocol (UDP)" című RFC-dokumentumban TCP/IP-szabványként van meghatározva. Az UDP protokollt egyes programok a TCP helyett használják gyors, könnyű, nem megbízható adatátvitelre a TCP/IP-kiszolgálók között. Az UDP protokoll az elérhető legjobb szintű továbbítást kínáló kapcsolat nélküli datagramszolgáltatást biztosít, azaz nem garantálja, hogy a csomagok célba érnek, és nem ellenőrzi a datagramok sorrendjét. A megbízható kommunikációt igénylő forráskiszolgálónak vagy a TCP protokollt, vagy saját sorrendbe állítási és visszaigazolási szolgáltatásokat biztosító programot kell használnia. További információkért lásd a [User Datagram Protocol (UDP)](http://technet.microsoft.com/en-us/library/cc785220(ws.10).aspx) című TechNet-cikket.
...
A támadó úgy használhatja ki a biztonsági rést, ha folyamatosan speciálisan kialakított UDP-csomagokat küld a célrendszer zárt portjára.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**  
A biztonsági rés elsősorban a munkaállomásokat és kiszolgálókat veszélyezteti.
  
**Mi a frissítés feladata?**  
A frissítés a biztonsági rés elhárítása érdekében módosítja a Windows TCP/IP-verem memórián belüli, UDP-csomagokra vonatkozó nyilvántartási módját.
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2588516">Microsoft Tudásbázis 2588516. számú cikkét</a></td>
</tr>
<tr class="odd">
