---
TOCTitle: 'MS11-092'
Title: 'A Microsoft számú biztonsági közleménye MS11-092 - Kritikus'
ms:assetid: 'ms11-092'
ms:contentKeyID: 61228839
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-092(v=Security.10)'
author: SharonSears
ms.author: SharonSears
---


A Microsoft számú biztonsági közleménye MS11-092 - Kritikus
===========================================================

A Windows Media biztonsági rése távoli programkódfuttatásra adhat lehetőséget (2648048)
---------------------------------------------------------------------------------------
...
A biztonsági frissítés a Windows XP rendszer összes érintett kiadására (beleértve a Windows XP Media Center Edition 2005 rendszert is), valamint a Windows Vista és Windows 7 rendszerek összes támogatott kiadására nézve kritikus besorolásúnak minősül. További tudnivalókat a közlemény későbbi részében, az **Érintett és nem érintett szoftverek** cím alatt talál.

A biztonsági frissítés a biztonsági rés megszüntetéséhez módosítja a speciálisan létrehozott .dvr-ms fájlok megnyitási módját a Windows Media Player és Windows Media Center alkalmazásban. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b6e44069-dec5-48f6-8fc4-8ab375a10b4e">Windows 7 32 bites rendszerekhez és Windows 7 32 bites rendszerekhez Service Pack 1</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Nincsenek</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f7997ab8-27e0-4714-845a-d237f4326587">Windows 7 x64 alapú rendszerekhez és Windows 7 x64 alapú rendszerekhez Service Pack 1</a><br />
(KB2619339)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Kritikus</td>
<td style="border:1px solid black;">Nincsenek</td>
...
Igen. A KB2619339 frissítés elérhető a Windows Developer Preview kiadáshoz. A Windows Developer Preview felhasználói alkalmazzák a frissítést a rendszereiken. A frissítés csak a [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) szolgáltatáson keresztül érhető el.
...
<th style="border:1px solid black;" >A Windows Media Player DVR-MS memóriasérülés miatti biztonsági rése - CVE-2011-3401</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
A Windows Media Player DVR-MS memóriasérülés miatti biztonsági rése - CVE-2011-3401  
-----------------------------------------------------------------------------------
...
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-3401](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3401).
  
#### A Windows Media Player DVR-MS memóriasérülés miatti biztonsági résének (CVE-2011-3401) súlyosságát enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   A biztonsági rést kihasználó támadó a helyi felhasználóval egyező hozzáférést nyer a rendszerhez. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén  
-   E-mail küldésével a biztonsági rés nem használható ki automatikusan. A támadás sikeres kihasználásához a felhasználónak meg kell nyitnia az e-mail mellékletként elküldött, speciálisan létrehozott .dvr-ms fájlt.  
...
#### A Windows Media Player DVR-MS memóriasérülés miatti biztonsági résének (CVE-2011-3401) lehetséges megoldásai
  
A lehetséges megoldás olyan beállítást vagy konfigurációs módosítást takar, amely magát a biztonsági rést nem szünteti meg, azonban a frissítés telepítése előtt segít az ismert támadási lehetőségek kivédésében. A Microsoft alaposan megvizsgálta a következő lehetséges megoldásokat, és tájékoztatja a felhasználókat, amennyiben a megoldás csökkenti a működőképességet:
  
-   **A Rendszergazdák csoport tulajdonába tartozó ENCDEC.DLL elemhez történő hozzáférés korlátozása**
  
    Windows XP (32 bites kiadások) esetén írja a következő parancsot a parancssorba:
  
    `cacls %WINDIR%\SYSTEM32\ENCDEC.DLL /E /P everyone:N`
  
    Windows XP (x64-alapú kiadások) esetén írja a következő parancsot a parancssorba:
  
    `cacls %WINDIR%\SYSWOW64\ENCDEC.DLL E /P everyone:N`
  
    Windows Vista (32 bites kiadások) és Windows 7 (32 bites kiadások) esetén futtassa a parancssorból rendszergazdai jogosultsággal a következő parancsokat:
    ...
    Windows Vista (x64-alapú kiadások) és Windows 7 (x64-alapú kiadások) esetén futtassa a parancssorból rendszergazdai jogosultsággal a következő parancsokat:
    ...
    **A megoldás hatása.** A .dvr-ms fájlok lejátszásának letiltása.
    ...
    **A megoldás visszavonása.**
    ...
    Windows Vista (32 bites kiadások) és Windows 7 (32 bites kiadások) esetén futtassa a parancssorból rendszergazdai jogosultsággal a következő parancsot:
  
    `icacls %WINDIR%\SYSTEM32 /restore %TEMP%\ENCDECDLL_ACL.TXT`
  
    Windows Vista (x64-alapú kiadások) és Windows 7 (x64-alapú kiadások) esetén futtassa a parancssorból rendszergazdai jogosultsággal a következő parancsot:
  
    `icacls %WINDIR%\SYSWOW64 /restore %TEMP%\ENCDECDLL_ACL.TXT<Standard workaround>`
  
-   **Az ENCDEC.DLL regisztrálásának törlése**
  
    A Windows rendszer 32 bites kiadásain futtassa a parancssorból rendszergazdai jogosultsággal a következő parancsot:
  
    `Regsvr32.exe -u %WINDIR%\SYSTEM32\ENCDEC.DLL`
  
    A Windows rendszer x64-alapú kiadásain futtassa a parancssorból rendszergazdai jogosultsággal a következő parancsot:
...
-   **Ne nyisson meg nem megbízható forrásból származó .dvr-ms fájlokat**
  
    Ne nyisson meg és ne mentsen megbízhatatlan forrásból származó vagy megbízható forrásból származó, de nem várt .dvr-ms fájlokat. Ez a biztonsági rés akkor használható ki, amikor a felhasználó egy különlegesen kialakított PowerPoint fájlt nyit meg.
  
#### Gyakran ismételt kérdések a Windows Media Player DVR-MS memóriasérülés miatti biztonsági résével (CVE-2011-3401) kapcsolatban
...
A frissítés módosítja a speciálisan kialakított .dvr-ms fájlok megnyitási módját a Windows Media Player és Windows Media Center alkalmazásban.
...
<td style="border:1px solid black;">Windows XP Media Center Edition 2005 Service Pack 3 esetén:<br />
Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2619340$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 rendszer esetén:<br />
Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2619339$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 esetén:<br />
...
<td style="border:1px solid black;">Windows XP Media Center Edition 2005 Service Pack 3 esetén:<br />
Lásd a <a href="http://support.microsoft.com/kb/2619340">Microsoft Tudásbázis 2619340. számú cikkét</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 rendszer esetén:<br />
Lásd a <a href="http://support.microsoft.com/kb/2619339">Microsoft Tudásbázis 2619339. számú cikkét</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 esetén:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2619339">Microsoft Tudásbázis 2619339. számú cikkét</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Beállításkulcsok ellenőrzése</strong></td>
...
-   A [VeriSign iDefense Labs](http://labs.idefense.com/) anonim együttműködő partnerének a Windows Media Player DVR-MS memóriasérülés miatti biztonsági résének (CVE-2011-3401) jelentéséért
