---
TOCTitle: 'MS11-075'
Title: 'A Microsoft számú biztonsági közleménye MS11-075 - Fontos'
ms:assetid: 'ms11-075'
ms:contentKeyID: 61228822
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-075(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS11-075 - Fontos
=========================================================

A Microsoft Active Accessibility biztonsági rése távoli kódfuttatást tehet lehetővé (2623699)
---------------------------------------------------------------------------------------------

Közzétéve: 2011. október 11. | Frissítve: 2011. október 25.
...
A biztonsági frissítés a biztonsági rés kezelése céljából módosítja a külső függvénytárak betöltésének módját a Microsoft Active Accessibility összetevőben. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=82653b8c-0e58-440d-9702-8847f599caed">Windows Server 2003 SP2 Itanium-alapú rendszerekhez</a><br />
(KB2605295)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;">Nincsenek</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7cd1ecec-8a3f-4cb2-833c-a177c9602ff5">Windows Server 2008 32 bites rendszerekhez, Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=456e450c-3928-4130-8127-e4d3f482c1ca">Windows Server 2008 x64 alapú rendszerekhez, Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2e9930d3-ba13-446d-bfa0-60720c48203b">Windows Server 2008 Itanium-alapú rendszerekhez, Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=02d28e59-b38f-433a-a568-e86f9d43dd42">Windows 7 32 bites rendszerekhez és Windows 7 32 bites rendszerekhez Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=904dec69-e8b9-4b23-a5ea-d3e7e9b9df07">Windows 7 x64 alapú rendszerekhez és Windows 7 x64 alapú rendszerekhez Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c7bd50b7-03f1-4ea4-ad71-d428822c62f8">Windows Server 2008 R2 x64 alapú rendszerekhez és Windows Server 2008 R2 x64 alapú rendszerekhez Service Pack 1</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=aa816682-9652-433c-b1b4-5d0bc17b6a87">Windows Server 2008 R2 Itanium alapú rendszerekhez és Windows Server 2008 R2 Itanium alapú rendszerekhez Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">Távoli kódfuttatás</td>
<td style="border:1px solid black;">Fontos</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<th style="border:1px solid black;" >Az Active Accessibility nem biztonságos függvénytárbetöltése miatti biztonsági rés – CVE-2011-1247</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
Az Active Accessibility nem biztonságos függvénytárbetöltése miatti biztonsági rés – CVE-2011-1247  
--------------------------------------------------------------------------------------------------
  
A biztonsági rést a DLL-fájlok kezelési módja okozza a Microsoft Active Accessibility összetevőben. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247).
  
#### Az Active Accessibility nem biztonságos függvénytárbetöltése miatti biztonsági rés (CVE-2011-1247) súlyosságát enyhítő tényezők
...
#### Az Active Accessibility nem biztonságos függvénytárbetöltése miatti biztonsági rés (CVE-2011-1247) lehetséges megoldásai
...
#### Gyakran ismételt kérdések az Active Accessibility nem biztonságos függvénytárbetöltése miatti biztonsági réssel (CVE-2011-1247) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**  
A biztonsági rés távolról történő kódfuttatást tehet lehetővé. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Mi okozza a biztonsági rést?**  
A biztonsági rés oka, hogy a Microsoft Active Accessibility összetevő nem megfelelően korlátozza a külső függvénytárak betöltésére használatos elérési utat.
  
**Mi az a Microsoft Active Accessibility összetevő?**  
A Microsoft Active Accessibility összetevő a kisegítő lehetőségek Microsoft Windows rendszeren futó alkalmazásokkal történő együttműködési módját javító, Component Object Model-alapú (COM) technológia. Az operációs rendszerbe beépített dinamikus csatolású kódtárakat, valamint COM-illesztőfelületet és API-elemeket tartalmaz, amelyek biztonságos módon nyújtanak információt a felhasználói felület elemeiről. A további tudnivalókat lásd a [Microsoft Active Accessibility](http://msdn.microsoft.com/en-us/library/ms971350.aspx) című MSDN-cikkben.
...
A frissítés a biztonsági rés megszüntetése érdekében kijavítja a külső függvénytárak betöltési módját a Microsoft Active Accessibility összetevőben.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2564958$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2564958">Microsoft Tudásbázis 2564958. számú cikkét</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
A Windows Server 2003 összes támogatott 32 bites és x64 alapú verziója esetén:  
KB2564958.log
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;" colspan="2">
A Windows Server 2003 összes támogatott 32 bites és x64 alapú verziója esetén:  
Használja a Vezérlőpult **Programok telepítése és törlése** lehetőségét vagy a %Windir%\\$NTUninstallKB2564958$\\Spuninst mappában található Spuninst.exe segédprogramot
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
A Windows Server 2003 összes támogatott Itanium-alapú verziója esetén:  
Használja a Vezérlőpult **Programok telepítése és törlése** lehetőségét vagy a %Windir%\\$NTUninstallKB2605295$\\Spuninst mappában található Spuninst.exe segédprogramot
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
A Windows Server 2003 összes támogatott 32 bites és x64 alapú verziója esetén:  
Lásd a [Microsoft Tudásbázis 2564958. számú cikkét](http://support.microsoft.com/kb/2564958)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
A Windows Server 2003 összes támogatott Itanium-alapú verziója esetén:  
Lásd a [Microsoft Tudásbázis 2605295. számú cikkét](http://support.microsoft.com/kb/2605295)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   [Mila Parkour](http://contagiodump.com), valamint Anshul Kothari és Nishant Kaushik, [Adobe Systems, Inc.](http://www.adobe.com), az Active Accessibility nem biztonságos függvénytárbetöltése miatti biztonsági rés (CVE-2011-1247) jelentéséért
...
-   1.1 verzió (2011. október 12.): Javítottuk a közlemények felváltására vonatkozó információkat a Windows Vista, Windows Server 2008, Windows 7, és Windows Server 2008 R2 minden támogatott kiadásához. A módosítás csak tájékoztató jellegű. Sem az észlelési módszert, sem pedig a frissítési fájlokat érintő módosítás nem történt.  
-   1.2 verzió (2011. október 25.): A Microsoft Tudásbázis KB816915. számú cikkében ismertetett rendszernek megfelelően módosítottuk a 32 bites és x64-es Windows XP és Windows Server 2003 operációs rendszerek frissítőfájljainak neveit. A módosítás csak a neveket érinti. Sem az észlelési módszert, sem pedig a frissítési fájlokat érintő módosítás nem történt. Ha már telepítette a frissítést, nincs további teendője.
