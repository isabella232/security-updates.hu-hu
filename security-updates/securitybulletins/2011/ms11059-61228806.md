---
TOCTitle: 'MS11-059'
Title: 'A Microsoft számú biztonsági közleménye MS11-059 - Fontos'
ms:assetid: 'ms11-059'
ms:contentKeyID: 61228806
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-059(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS11-059 - Fontos
=========================================================

Az adatelérési összetevők biztonsági rése távoli programkód futtatását teszi lehetővé (2560656)
-----------------------------------------------------------------------------------------------
...
Ez a fontos besorolású biztonsági frissítés a Windows 7 és a Windows Server 2008 R2 összes támogatott kiadására vonatkozik. További információkért lásd az **Érintett és nem érintett szoftverek** című részt ebben a fejezetben.

A biztonsági frissítés a biztonsági rés megszüntetése érdekében kijavítja a külső függvénytárak Windows Data Access Tracing általi betöltésének módját. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Windows 7 32 bites rendszerekhez és Windows 7 32 bites rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6bc168d9-6664-41fb-914f-dbd7514a4b0e)                                     | Távoli kódfuttatás         | Fontos                           | Nincsenek                                |
| [Windows 7 x64 alapú rendszerekhez és Windows 7 x64 alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=aafeff2d-db9a-4b3b-b620-be4ec5f5bdcc)                                   | Távoli kódfuttatás         | Fontos                           | Nincsenek                                |
| [Windows Server 2008 R2 x64 alapú rendszerekhez és Windows Server 2008 R2 x64 alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c29deec3-4672-4658-a550-dce244434cd4)\*       | Távoli kódfuttatás         | Fontos                           | Nincsenek                                |
| [Windows Server 2008 R2 Itanium alapú rendszerekhez és Windows Server 2008 R2 Itanium alapú rendszerekhez Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1d6b8036-d38f-408a-a36c-027553faefc1) | Távoli kódfuttatás         | Fontos                           | Nincsenek                                |
...
Igen, az adatelérési összetevők függvénytárainak nem biztonságos betöltése miatti - ebben a frissítésben kezelt - biztonsági rés (CVE-2011-1975) kapcsolódik a [Microsoft 2269637. számú biztonsági tanácsadójában](http://technet.microsoft.com/security/advisory/2269637) bemutatott – a külső függvénytárak alkalmazások általi betöltési módját érintő – biztonsági rés típus egyik speciális esetéhez. Ez a biztonsági frissítés a biztonságirés-típus egy különleges esetére tér ki.
...
<th style="border:1px solid black;" >Az adatelérési összetevők függvénytárainak nem biztonságos betöltése miatti biztonsági rés - CVE-2011-1975</th>
...
Az adatelérési összetevők függvénytárainak nem biztonságos betöltése miatti biztonsági rés - CVE-2011-1975  
----------------------------------------------------------------------------------------------------------
  
A távoli kódvégrehajtást lehetővé tévő biztonsági rést az okozza, ahogy a Windows Data Access Tracing összetevő a DLL fájlok betöltését kezeli. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb a veszélyeztetettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1975](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1975).
  
#### Az adatelérési összetevők függvénytárainak nem biztonságos betöltése miatti biztonsági rés (CVE-2011-1975) súlyosságát enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   A támadás sikerességéhez a felhasználónak meg kell látogatnia egy nem megbízhatónak ítélt távoli fájlrendszert vagy WebDAV megosztás, és meg kell nyitnia egy Excel fájlt (például egy .xlsx fájlt).  
...
#### Az adatelérési összetevők függvénytárainak nem biztonságos betöltése miatti biztonsági rést (CVE-2011-1975) megkerülő lehetséges megoldások
...
#### Gyakran ismétlődő kérdések az adatelérési összetevők függvénytárainak nem biztonságos betöltése miatti biztonsági rés (CVE-2011-1975) kapcsán
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés távolról történő kódfuttatást tehet lehetővé. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rést az okozza, amikor a Windows Data Access Tracing összetevő hibásan korlátozza a külső függvénytárak betöltésére használatos elérési utat.
  
**Mi az a Windows Data Access Components (Windows DAC)?**    
A Windows Data Access Components (Windows DAC) 6.0 az olyan technikai eljárások halmaza a Windows Vista, a Windows 7, a Windows Server 2008 és a Windows Server 2008 R2 rendszerben, amelyek az adatelérést szolgáltatják vállalati szinten. Az ilyen technikai eljárások közé tartozik a Microsoft ActiveX Data Objects (ADO), az OLE DB és a Microsoft Open Database Connectivity (ODBC). A webről vagy a helyi hálózatról üzembe helyezett adatvezérelt ügyfél/kiszolgáló alkalmazások használhatják ezeket az összetevőket, hogy a különböző forrásokból, reláció (SQL) vagy nem relációs, könnyen integrálják az adatokat. További információkért lásd a [Windows Data Access Components SDK](http://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) c. MSDN-cikket.
...
A támadó ráveheti a felhasználót, hogy nyisson meg egy normál Excel fájlt (például .xlsx), amely azonos hálózati meghajtón található, mint a speciálisan létrehozott dinamikus csatolású függvénytár (DLL) fájl. Ezután a normál fájl megnyitásakor a Microsoft Office megpróbálhatja betölteni a DLL fájlt, és végrehajtani az abban található kódot.
  
E-mailes támadás esetén a támadó a biztonsági rés kihasználásával normál Excel fájlmellékletet küld a felhasználónak (például .xlsx), és ráveszi, hogy az olyan könyvtárba helyezze a mellékletet, amely speciálisan létrehozott DLL fájlt tartalmaz, és itt nyissa meg az érvényes fájlt. Ezután a normál fájl megnyitásakor a Microsoft Office megpróbálhatja betölteni a DLL fájlt, és végrehajtani az abban található kódot.
...
Jóllehet a biztonsági rést kiaknázó támadási módszer a Microsoft Office olyan alkalmazásán keresztül érvényesül, mint a Microsoft Excel, a biztonsági rés kódja megtalálható a Microsoft Windows egyik megosztott összetevőjében is.
...
A biztonsági frissítés e biztonsági rés megszüntetése érdekében kijavítja a külső függvénytáraknak a Windows Data Access Tracing általi betöltésének módját.
...
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2560656">Microsoft Tudásbázis 2560656. számú cikkét</a></td>
</tr>
<tr class="odd">
...
-   1.1 verzió (2011. augusztus 10.): Az összes érintett operációs rendszer vonatkozásában módosítottuk a frissítés újraindítási követelményeit.
