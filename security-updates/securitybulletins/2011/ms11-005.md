---
TOCTitle: 'MS11-005'
Title: 'A Microsoft számú biztonsági közleménye MS11-005 - Fontos'
ms:assetid: 'ms11-005'
ms:contentKeyID: 61228654
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-005(v=Security.10)'
author: SharonSears
ms.author: SharonSears
---


A Microsoft számú biztonsági közleménye MS11-005 - Fontos
=========================================================

Az Active Directory biztonsági rése szolgáltatásmegtagadást okozhat (2478953)
-----------------------------------------------------------------------------
...
A biztonsági frissítés az Active Directory nyilvánosan jelentett biztonsági rését szünteti meg. A biztonsági rés szolgáltatásmegtagadást tehet lehetővé, ha a támadó speciálisan kialakított csomagot küld az érintett Active Directory kiszolgálónak. A támadónak a biztonsági rés kihasználásához érvényes, helyi rendszergazdai jogosultsággal kell rendelkeznie a tartományhoz csatlakoztatott számítógépen.

A biztonsági frissítés a Windows Server 2003 összes támogatott kiadásán futó Active Directory szolgáltatásra vonatkozóan Fontos besorolásúnak minősül. További tudnivalókért lásd az **Érintett és nem érintett szoftverek** részt ebben a fejezetben.

A biztonsági frissítés a biztonsági rés elhárítása érdekében javítja az egyszerű szolgáltatásnév (SPN) frissítésére vonatkozó kérelmek kezelési módját az Active Directory kiszolgálókon. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
<td style="border:1px solid black;">Alkalmazásmódú Active Directory (ADAM)</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Active Directory Lightweight Directory-szolgáltatás (AD LDS)</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">(Az ADAM, az AD LDS és az Active Directory nem az adott Microsoft Windows kiadáshoz tartozó összetevő)</td>
</tr>
<tr class="even">
...
**Az érintett szoftverek között felsorolt rendszert használok. Miért nem ajánlják fel nekem a frissítést?**      
A frissítést csak olyan rendszerek esetében ajánlják fel, ahol az érintett összetevő telepítve és engedélyezve is van. A tartományvezérlő szerepre nem konfigurált Microsoft Windows Server rendszerek nem érintettek, és nem kapják meg a frissítést.
...
<th style="border:1px solid black;" >Az Active Directory SPN-érvényesítés miatti biztonsági rése – CVE-2011-0040</th>
<th style="border:1px solid black;" >Összesített súlyossági besorolás</th>
</tr>
</thead>
<tbody>
...
Az Active Directory SPN-érvényesítés miatti biztonsági rése – CVE-2011-0040  
---------------------------------------------------------------------------
  
A Microsoft Windows Active Directory implementációiban az egyszerű szolgáltatásnevek (SPN) nem megfelelő érvényesítése miatt szolgáltatásmegtagadási biztonsági rés található, amely SPN-ütközésekhez vezethet. Ilyen esetben az egyszerű szolgáltatásneveket használó szolgáltatások visszaminősíthetik a hitelesítést az NT LAN Manager (NTLM) protokollra, ha be van állítva az egyeztetés. Azok a szolgáltatások, amelyeken nincs beállítva az egyeztetés, elérhetetlenné válnak, ami szolgáltatásmegtagadáshoz vezet. A biztonsági rést sikeresen kihasználó támadó az érintett rendszert a válaszadások megszakítására kényszerítheti.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-0040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040).
  
#### Az Active Directory SPN-érvényesítés miatti biztonsági résének (CVE-2011-0040) enyhítő tényezői
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   A szolgáltatásmegtagadási biztonsági rés kihasználásához a támadónak rendszergazdának kell lennie a tartományhoz csatlakoztatott számítógépen.
  
#### Az Active Directory SPN-érvényesítés miatti biztonsági résének (CVE-2011-0040) lehetséges megoldásai
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismételt kérdések az Active Directory SPN-érvényesítés miatti biztonsági résével (CVE-2011-0040) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**      
A biztonsági rés a szolgáltatásmegtagadás mellett a hitelesítés visszaminősítésével is jár. A biztonsági rést sikerrel kihasználó támadó elérheti, hogy az érintett rendszer a Kerberos helyett a gyengébb NT LAN Manager (NTLM) protokollt használja, a legrosszabb esetben pedig a válaszadás megszakítására kényszerítheti a szolgáltatást. Fontos megjegyezni, hogy a biztonsági rés a támadó számára nem teszi lehetővé programkód futtatását vagy jogosultságok illetéktelen megszerzését.
  
**Mi okozza a biztonsági rést?**      
Az Active Directory nem megfelelően dolgozza fel az egyszerű szolgáltatásnév (SPN) frissítésére vonatkozó, speciálisan kialakított kérelmeket, így a tartományban névütközéseket okozhat.
...
**Mi az SPN?**      
Az egyszerű szolgáltatásnév (SPN) az az egyedi név, amely alapján az ügyfél egy adott szolgáltatási példányt azonosít. Az egyszerű szolgáltatásnevek használatával kapcsolatban bővebb információt az [Egyszerű szolgáltatásnevek](http://msdn.microsoft.com/en-us/library/ms677949(vs.85).aspx) című MSDN-cikkben talál.
...
A biztonsági rést sikeresen kihasználó támadó névütközéseket idézhet elő a tartományban, melynek hatására az egyszerű szolgáltatásneveket használó szolgáltatások visszaminősíthetik a hitelesítést NTLM protokollra. Egyes konfigurációkban, ahol a szolgáltatáson nincs beállítva az egyeztetés, a szolgáltatás elérhetetlen lesz.
  
**Hogyan használhatja ki a támadó a biztonsági rést?**      
A támadó megpróbálhatja kihasználni a biztonsági rést úgy, hogy speciálisan kialakított csomagot küld az Active Directory kiszolgálónak. A támadónak a biztonsági rés kihasználásához érvényes, helyi rendszergazdai jogosultsággal kell rendelkeznie a tartományhoz csatlakoztatott számítógépen.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**      
A biztonsági rés a Windows Server 2003 rendszeren Active Directory szolgáltatást futtató környezetet veszélyezteti.
  
**Mi a frissítés feladata?**      
A frissítés a biztonsági rés elhárítása érdekében javítja az egyszerű szolgáltatásnév (SPN) frissítésére vonatkozó kérelmek kezelési módját az Active Directory kiszolgálókon.
  
**Ismert volt-e a nyilvánosság előtt ez a biztonsági rés az említett közlemény kiadásának idején?**      
Igen. A biztonsági rés nyilvánosságra került, A normál biztonsági rés besorolást és a [CVE-2011-0040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040) azonosítót kapta.
...
<td style="border:1px solid black;">A Windows Server 2003 összes támogatott 32 bites kiadásán futó Active Directory esetén:<br />
WindowsServer2003-KB2478953-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows Server 2003 összes támogatott x64-alapú kiadásán futó Active Directory esetén:<br />
WindowsServer2003.WindowsXP-KB2478953-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">A Windows Server 2003 összes támogatott Itanium alapú kiadásán futó Active Directory esetén:<br />
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2478953$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2478953">Microsoft Tudásbázis 2478953. számú cikkét</a></td>
</tr>
<tr class="even">
