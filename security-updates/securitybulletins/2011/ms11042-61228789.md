---
TOCTitle: 'MS11-042'
Title: 'A Microsoft számú biztonsági közleménye MS11-042 - Kritikus'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61228789
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-042(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS11-042 - Kritikus
===========================================================

Az elosztott fájlrendszer biztonsági rései távoli kódfuttatást okozhatnak (2535512)
-----------------------------------------------------------------------------------

Közzétéve: 2011. június 14. | Frissítve: 2011. június 14.
...
A biztonsági frissítés a Windows XP és a Windows Server 2003 összes támogatott verzióján kritikus besorolást, a Windows Vista és a Windows Server 2008, Windows 7 for 32-bit Systems, Windows 7 for x64-based Systems, Windows Server 2008 R2 for x64-based Systems, valamint Windows Server 2008 R2 for Itanium-based Systems támogatott változatain fontos besorolást kapott. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.

A biztonsági frissítés a biztonsági rések elhárítása érdekében javítja azt az eljárást, ahogy a DFS-ügyfél a mezőket érvényesíti a különlegesen kialakított DFS-hivatkozókra adott válaszokban, valamint javítja a DFS-szolgáltatás különlegesen kialakított DFS-hivatkozókra adott válaszokra vonatkozó kezelési módját. A biztonsági résekkel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                          | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                                 | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                                 | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                                     | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows Server 2003 SP2 karbantartó csomaggal Itanium-alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                          | Távoli kódfuttatás         | Kritikus                         | Nincsenek                                |
| [Windows Vista Service Pack 1 és Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                       | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows Vista x64 Edition Service Pack 1 és Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                               | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows Server 2008 32 bites rendszerekhez és Windows Server 2008 32 bites rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\*         | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows Server 2008 x64 alapú rendszerekhez és Windows Server 2008 x64 alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*       | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows Server 2008 Itanium-alapú rendszerekhez és Windows Server 2008 Itanium-alapú rendszerekhez, Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows 7 32 bites rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                   | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows 7 x64 alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                                  | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows Server 2008 R2 x64 alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                                   | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
| [Windows Server 2008 R2 Itanium-alapú rendszerekhez](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                                 | Szolgáltatásmegtagadás     | Fontos                           | Nincsenek                                |
...
<th style="border:1px solid black;" >A DFS memóriameghibásodást okozó biztonsági rése - CVE-2011-1868</th>
<th style="border:1px solid black;" >A DFS-hivatkozókra adott válaszok biztonsági rése - CVE-2011-1869</th>
...
A DFS memóriameghibásodást okozó biztonsági rése - CVE-2011-1868  
----------------------------------------------------------------
  
<span></span>
A különlegesen kialakított DFS-válaszoknak az Elosztott fájlrendszer (DFS) ügyfél általi elemzési módja hitelesítés nélküli távoli kód futtatását lehetővé tévő biztonsági rést okoz. A biztonsági rés kihasználásához nem szükséges hitelesítés, így a támadók a rés kihasználásához az ügyfél által kezdeményezett DFS-kérelemre különlegesen kialakított DFS-választ küldhetnek. Ha egy támadó kihasználja a biztonsági rést, távolról mesterséges kódot futtathat és teljes mértékben átveheti az érintett rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
  
#### A DFS memóriameghibásodást okozó biztonsági rése (CVE-2011-1868) súlyosságát enyhítő tényezők
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   A tűzfalakra vonatkozó gyakorlati tanácsok, valamint a szabványos alapértelmezett tűzfal-konfigurációk segítséget nyújtanak a hálózatot érő, a szervezet határain kívülről eredő támadások kivédésében. Gyakorlati tanácsként azt javasoljuk, hogy az internetkapcsolattal rendelkező számítógépeken a lehető legkevesebb port legyen megnyitva.
  
#### A DFS memóriameghibásodást okozó biztonsági résének (CVE-2011-1868) lehetséges megoldásai
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismételt kérdések a DFS memóriameghibásodást okozó biztonsági résével (CVE-2011-1868) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**    
A biztonsági rés távolról történő kódfuttatást tehet lehetővé. Ha egy támadó kihasználja a biztonsági rést, teljes mértékben átveheti a rendszer irányítását. Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rés oka a Microsoft elosztott fájlrendszer (DFS) implementációjának helytelen mezőérvényesítési módja a speciálisan kialakított DFS-válaszokban.
  
**Mi az Elosztott fájlrendszer (DFS)?**    
Az Elosztott fájlrendszer (DFS) segítségével a rendszergazdák úgy csoportosíthatják a különböző kiszolgálókon található megosztott mappákat, hogy átláthatóan hozzákapcsolják ezeket egy vagy több DFS-névtérhez. A DFS-névtér az egy szervezeten belüli megosztott mappák virtuális nézete. A rendszergazdák a DFS-eszközökkel kiválaszthatja, mely megosztott mappákat szerepelteti a névtérben, kialakítja a mappák megjelenítéséhez használt hierarchiát, és meghatározza a megosztott mappák névtérben megjelenített neveit. Ha a felhasználó megtekinti a névteret, úgy tűnik, mintha a mappák egyetlen, nagy kapacitású merevlemezen helyezkednének el. A felhasználók anélkül használhatják a névtérben lévő mappákat, hogy ismerniük kellene az adatoknak helyet adó kiszolgálók és megosztott mappák nevét. További információk a [DFS műszaki útmutató](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx) részben olvashatók.
...
A támadó speciálisan kialakított kiszolgálót üzemeltethet, amelynek rendeltetése a biztonsági rés kihasználása, majd megpróbálhatja rávenni a felhasználót, hogy DFS-kapcsolatot kezdeményezzen vele. Ezen kívül a helyi hálózaton lévő támadó illetéktelen támadás útján is elérheti, hogy a rendszer jogszerű DFS-kérelemre hibás DFS-választ küldjön.
  
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**    
A biztonsági rés a Windows XP és a Windows Server 2003 rendszer támogatott verzióit veszélyezteti.
  
**Mi a frissítés feladata?**    
A biztonsági frissítés a biztonsági rés elhárítása érdekében javítja azt az eljárást, ahogy a DFS-ügyfél a mezőket érvényesíti a különlegesen kialakított DFS-válaszokban.
...
A DFS-hivatkozókra adott válaszok biztonsági rése - CVE-2011-1869  
-----------------------------------------------------------------
  
<span></span>
A különlegesen kialakított DFS-hivatkozókra adott válaszok Microsoft elosztott fájlrendszer (DFS) általi kezelési módja szolgáltatásmegtagadást lehetővé tévő biztonsági rést okoz. A biztonsági rés kihasználásához nem szükséges hitelesítés, így a támadók a rés kihasználásához a kiszolgáló szolgáltatást futtató számítógépre különlegesen kialakított hálózati üzenetet küldhetnek.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
  
#### A DFS-hivatkozókra adott válaszok biztonsági résének (CVE-2011-1869) súlyosságát enyhítő tényezők
...
#### A DFS-hivatkozókra adott válaszok biztonsági résének (CVE-2011-1869) lehetséges megoldásai
  
A Microsoft egyelőre nem talált lehetséges megoldást a biztonsági rés megszüntetésére.
  
#### Gyakran ismételt kérdések a DFS-hivatkozókra adott válaszok biztonsági résével (CVE-2011-1869) kapcsolatban
...
**Mi okozza a biztonsági rést?**    
A biztonsági rés oka az Elosztott fájlrendszer (DFS) implementációjának helytelen kezelési módja a speciálisan kialakított DFS-hivatkozókra adott válaszokban.
...
**Mely rendszerekre jelenti a legnagyobb veszélyt a biztonsági rés?**    
A biztonsági rés a Windows rendszer minden támogatott verzióját veszélyezteti.
  
**Mi a frissítés feladata?**    
A biztonsági frissítés a biztonsági rés elhárítása érdekében javítja azt az eljárást, ahogy a DFS szolgáltatás a különlegesen kialakított DFS-hivatkozókra adott válaszokat kezeli.
...
| Windows 7 32 bites rendszerekhez                                                                                   | Igen                        | Igen                       |  
| Windows 7 x64-alapú rendszerekhez                                                                                  | Igen                        | Igen                       |  
| Windows Server 2008 R2 x64-alapú rendszerekhez                                                                     | Igen                        | Igen                       |  
| Windows Server 2008 R2 Itanium-alapú rendszerekhez                                                                 | Igen                        | Igen                       |
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2535512$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2535512">Microsoft Tudásbázis 2535512. számú cikkét</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 7 x64 alapú rendszerekhez:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Az összes Windows 7 x64 rendszerhez:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Telepítés felhasználói beavatkozás nélkül</td>
<td style="border:1px solid black;">Windows 2008 R2 for x64 alapú rendszerekhez:<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 2008 R2 Itanium alapú rendszerekhez:<br />
...
-   Laurent Gaffié, [NGS Software](http://www.ngssoftware.com/), a DFS-hivatkozókra adott válaszok biztonsági résének (CVE-2011-1869) jelentéséért
...
-   1.1 verzió (2011. június 14.): A Windows 7 for 32-bit Systems Service Pack 1, Windows 7 for x64-based Systems Service Pack 1, Windows Server 2008 R2 for x64-based Systems Service Pack 1 és Windows Server 2008 R2 for Itanium-based Systems Service Pack 1 javításokat az érintett szoftverek táblázatából áthelyezték a nem érintett szoftverek táblázatába. A módosítás csak tájékoztató jellegű. A biztonsági frissítéshez kapcsolódó fájlok és az észlelési logika nem változott.
