---
TOCTitle: 'MS11-051'
Title: 'A Microsoft számú biztonsági közleménye MS11-051 - Fontos'
ms:assetid: 'ms11-051'
ms:contentKeyID: 61228798
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms11-051(v=Security.10)'
---


A Microsoft számú biztonsági közleménye MS11-051 - Fontos
=========================================================

Az Active Directory Tanúsítványszolgáltatás webes beiktatás összetevőjének biztonsági rése jogok kiterjesztését teheti lehetővé (2518295)
-----------------------------------------------------------------------------------------------------------------------------------------

Közzétéve: 2011. június 14. | Frissítve: 2011. június 15.
...
A biztonsági frissítés az Itanium kivételével a Windows Server 2003, Windows Server 2008 és Windows Server 2008 R2 összes támogatott kiadására nézve Fontos besorolású. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.

A biztonsági frissítés a biztonsági rés elhárítása érdekében kijavítja a bemeneti paraméterek érvényesítési eljárását az Active Directory Tanúsítványszolgáltatás webes beiktatás összetevőjében. A biztonsági réssel kapcsolatban bővebben az adott problémával foglakozó gyakran feltett kérdéseket ismertető szakaszban, **A biztonsági réssel kapcsolatos tudnivalók** című részben olvashat.
...
**Ismert problémák** A[Microsoft Tudásbázis 2518295. számú cikkében](http://support.microsoft.com/kb/2518295) olvasható, hogy a felhasználók a biztonsági frissítés telepítésekor milyen ismert problémákkal találkozhatnak. A cikkben a problémákra javasolt megoldások is szerepelnek.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ef90d6c1-ea7f-4c32-9c90-0303e04c7436)                                                                                   | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62944095-33d6-4131-be32-a79d9ec4d4a9)                                                                       | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2008 32 bites rendszerekhez és Windows Server 2008 32 bites rendszerekhez Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46ade106-e0cb-4c71-8230-793a15062823)\*\*          | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2008 x64 alapú rendszerekhez és Windows Server 2008 x64 alapú rendszerekhez Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6141a1c5-ecaf-4553-9d27-dd6e5c4a13fd)\*\*        | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
| [Windows Server 2008 R2 x64-alapú rendszerekhez és Windows Server 2008 R2 x64-alapú rendszerekhez, Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1da04414-6210-43ea-8e0a-cf21cf144076)\*\* | Jogok kiterjesztése        | Fontos                           | Nincsenek                                |
...
A frissítést csak olyan rendszerek esetében ajánlják fel, ahol az érintett összetevő telepítve és engedélyezve is van. Az Active Directory Tanúsítványszolgáltatás webes igénylési szerepre nem konfigurált Microsoft Windows Server rendszereket a probléma nem érinti, ezért a frissítést sem kapják meg.

**Testreszabtam webes igénylési ASP-oldalaimat. Érintenek engem a Microsoft 2518295. számú tudásbáziscikkében említett problémák?**  
Igen, a Microsoft a webes igénylési ASP-oldalakat szerkesztő felhasználóknak ajánlja, hogy tekintsék meg a [Microsoft Tudásbázis 2518295. számú cikkét](http://support.microsoft.com/kb/2518295) a rendszerrel kapcsolatban felmerülő ismert problémákra vonatkozó fontos tudnivalókért.
...
<th style="border:1px solid black;" >Az Active Directory Tanúsítványszolgáltatás biztonsági rése – CVE-2011-1264</th>
...
Az Active Directory Tanúsítványszolgáltatás biztonsági rése – CVE-2011-1264  
---------------------------------------------------------------------------
  
Az Active Directory Tanúsítványszolgáltatás webes beiktatás összetevőjében XSS biztonsági rés található, melynek révén a támadók ügyféloldali parancsfájlt juttathatnak a felhasználó Internet Explorer példányába. A parancsfájl a tartalom meghamisítását, adatok kiszolgáltatását okozhatja, vagy – a megtámadott felhasználó nevében – bármilyen műveletet elvégezhet, amelyre az az adott helyen jogosult.
  
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2011-1264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264).
  
#### Az Active Directory Tanúsítványszolgáltatás biztonsági résének (CVE-2011-1264) enyhítő tényezői
  
Az enyhítő tényezők közé sorolható egy beállítás, konfiguráció vagy általánosan bevált gyakorlat, amely alapértelmezett állapotában csökkentheti a biztonsági rés kihasználásának valószínűségét. A következő enyhítő tényezők hasznosnak bizonyulhatnak:
  
-   Az Internet Explorer 8 és az Internet Explorer 9 XSS-szűrő védelmet nyújt az Internet Explorer 8 és az Internet Explorer 9 felhasználóinak a támadás ellen az Internet zónában történő böngészésekor. Az Internet Explorer 8 és az Internet Explorer 9 alkalmazás XSS-szűrője az Intranet zónában alapértelmezés szerint nem engedélyezett.  
...
#### Az Active Directory Tanúsítványszolgáltatás biztonsági résének (CVE-2011-1264) lehetséges megoldásai
...
#### Gyakran ismételt kérdések az Active Directory Tanúsítványszolgáltatás biztonsági résével (CVE-2011-1264) kapcsolatban
  
**Mire terjed ki a biztonsági rés hatása?**    
A tükrözött XSS biztonsági rés jogok kiterjesztését teheti lehetővé.
  
**Mi okozza a biztonsági rést?**    
A biztonsági rést a kérelemparaméterek nem megfelelő bemeneti érvényesítése okozza az Active Directory Tanúsítványszolgáltatás webes beiktatás összetevőjét alkalmazó helyeken.
...
Az Active Directory Tanúsítványszolgáltatás webes beiktatás összetevőjét.
...
Elsősorban az Active Directory Tanúsítványszolgáltatás webes beiktatás összetevőjét futtató kiszolgálókra jelent veszélyt. Az ezt a meghatározott szerepkört el nem látó kiszolgálók nincsenek veszélyben.
  
**Mi a frissítés feladata?**    
A frissítés a biztonsági rés elhárítása érdekében kijavítja a bemeneti paraméterek érvényesítési eljárását az Active Directory Tanúsítványszolgáltatás webes beiktatás összetevőjében.
...
<td style="border:1px solid black;">Használja a Vezérlőpult <strong>Programok telepítése és törlése</strong> lehetőségét vagy a %Windir%\$NTUninstallKB2518295$\Spuninst mappában található Spuninst.exe segédprogramot</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformáció</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/2518295">Microsoft Tudásbázis 2518295. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   Ruggero Strabla, [Emaze Networks](http://www.emaze.net/); [Saipem Security Team](http://www.saipem.com/), az Active Directory Tanúsítványszolgáltatás biztonsági résének (CVE-2011-1264) jelentéséért
...
-   1.1 verzió (2011. június 15.): Pontosítás az XSS-szűrő problémáját enyhítő megoldással kapcsolatban.
