---
TOCTitle: 'MS06-028'
Title: 'A Microsoft számú biztonsági közleménye MS06-028 - Kritikus'
ms:assetid: 'ms06-028'
ms:contentKeyID: 61227796
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms06-028(v=Security.10)'
---

Security Bulletin

A Microsoft számú biztonsági közleménye MS06-028 - Kritikus
===========================================================

A Microsoft PowerPoint biztonsági rése távolról történő programkódfuttatást tehet lehetővé (916768)
---------------------------------------------------------------------------------------------------
...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft PowerPoint 2000 — [Frissítés letöltése (KB916520)](http://www.microsoft.com/downloads/details.aspx?familyid=f635f2cb-cfee-4129-bb77-4779a3b05674)
-   Microsoft Office XP Service Pack 3
    -   Microsoft PowerPoint 2002 — [Frissítés letöltése (KB916519)](http://www.microsoft.com/downloads/details.aspx?familyid=60a1eb9f-f04b-4d21-a95e-ccc90d9782ab)
-   Microsoft Office 2003 Service Pack 1 vagy Service Pack 2
    -   Microsoft PowerPoint 2003 — [Frissítés letöltése (KB916518)](http://www.microsoft.com/downloads/details.aspx?familyid=fced8804-45b4-4fd2-8fdb-4960c5bb8954)
-   Microsoft Office 2004 for Mac
    -   Microsoft PowerPoint 2004 for Mac — [Frissítés letöltése (KB918963)](http://www.microsoft.com/mac/)
-   Microsoft Office v. X for Mac
    -   Microsoft PowerPoint v. X for Mac — [Frissítés letöltése (KB918963)](http://www.microsoft.com/mac/)
...
A tárgyalt frissítés egy újonnan felfedezett, közvetlenül a Microsoftnak jelzett biztonsági rést szüntet meg. A biztonsági rés ismertetését a jelen közlemény „A biztonsági rés részletes ismertetése” című része tartalmazza.
...
| A biztonsági rés azonosítója                                                                                                                                                                       | A biztonsági rés hatása | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft PowerPoint 2003 | Microsoft PowerPoint 2004 for Mac | Microsoft PowerPoint v. X for Mac |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|---------------------------|---------------------------|---------------------------|-----------------------------------|-----------------------------------|
| A Microsoft PowerPoint hibásan kialakított bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági rése [(CVE-2006-0022)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022). | Távoli kódfuttatás      | Kritikus                  | Fontos                    | Fontos                    | Fontos                            | Fontos                            |
...
| Közlemény azonosítója                                                   | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft PowerPoint 2003 | Microsoft PowerPoint 2004 for Mac | Microsoft PowerPoint v. X for Mac |
|-------------------------------------------------------------------------|---------------------------|---------------------------|---------------------------|-----------------------------------|-----------------------------------|
| [**MS06-010**](http://technet.microsoft.com/security/bulletin/ms06-010) | Lecserélve                | Nem érintett              | Nem érintett              | Nem érintett                      | Nem érintett                      |
...
| Microsoft PowerPoint 2002         | Igen.      | Igen.    |
| Microsoft PowerPoint 2003         | Igen.      | Igen.    |
| Microsoft PowerPoint 2004 for Mac | Nem.       | Nem.     |
| Microsoft PowerPoint v. X for Mac | Nem.       | Nem.     |

**Megjegyzés** Az MBSA az Office Detection Tool (ODT) eszköz beépített változatát alkalmazza, amely nem támogatja a távoli ellenőrzési funkciót. Az MBSA-eszközről a további tudnivalókat az MBSA webhelyén találja. Az MBSA-támogatással kapcsolatos további tudnivalókért látogasson el a [Microsoft Baseline Security Analyzer 1.2 – Kérdések és válaszok webhelyre.](http://go.microsoft.com/fwlink/?linkid=33332)

**Megjegyzés** Az MBSA 1.2.1 és a 2.0 alkalmazással a Mac 2004 for Microsoft Office X alkalmazás nem használható.
...
#### A Microsoft PowerPoint hibásan kialakított bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági rése (CVE-2006-0022).

A PowerPoint alkalmazásban távoli kódfuttatást lehetővé tévő, hibásan létrehozott bejegyzés található. A támadó a biztonsági rés kihasználásához olyan különlegesen kialakított PowerPoint fájlt hozhat létre, amely távoli kódfuttatásra adhat lehetőséget.

Ha valamely felhasználó felügyeleti jogosultságokkal bejelentkezett a rendszerbe, akkor a biztonsági rést kihasználó támadó teljes mértékben átveheti az irányítást a számítógép felett, Ezt követően programokat telepíthet, illetve adatokat tekinthet meg, módosíthat és törölhet, de korlátozás nélküli jogosultságokkal rendelkező új fiókokat is létrehozhat. A kevesebb jogosultsággal bíró fiókkal rendelkező felhasználók esetében kisebb lehet az érintettség, mint a rendszergazdai jogosultságokkal rendelkezők esetén.

#### A Microsoft PowerPoint hibásan kialakított bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági rését (CVE-2006-0022) enyhítő tényezők:
...
**Megjegyzés:** Míg a biztonsági rés a PowerPoint 2000 alkalmazást használó webhely látogatásának alkalmával automatikusan nem használható ki, az Office 2000 nem kéri a felhasználót a dokumentum megnyitása előtt **megnyitásra**, **mentésre** vagy **visszavonásra** sem.

#### Lehetséges megoldások a Microsoft PowerPoint hibásan kialakított bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági résének (CVE-2006-0022) enyhítésére:

A Microsoft az alábbi megoldásokat tesztelte. Jóllehet ezek a megoldások magát a biztonsági rést nem szüntetik meg, segítenek kivédeni az ismert támadási módszereket. Ha egy megoldási javaslat csökkenti a funkcionalitást, azt a következő fejezetben jelezzük.

**Ne nyisson meg és ne mentsen nem megbízható forrásból származó Microsoft PowerPoint fájlokat.**
Ez a biztonsági rés akkor használható ki, amikor a felhasználó megnyit egy fájlt.

#### Gyakran ismételt kérdések a Microsoft PowerPoint hibásan kialakított bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági résének (CVE-2006-0022) kihasználásával kapcsolatos kérdések.
...
Amikor a PowerPoint alkalmazás megnyit egy különlegesen kialakított PowerPoint fájlt, amely hibásan létrehozott bejegyzést tartalmaz, a rendszer memóriája megsérülhet, és a támadó tetszőleges kódot futtathat.
...
**Alaphelyzetben támadható-e a felhasználó, ha PowerPoint 2000 alkalmazást használó weboldalra látogat el?**  
Míg a biztonsági rés a PowerPoint 2000 alkalmazást használó webhely látogatásának alkalmával automatikusan nem használható ki, az Office 2000 nem kéri a felhasználót a dokumentum megnyitása előtt **megnyitásra**, **mentésre** vagy **visszavonásra** sem.
...
A frissítés a biztonsági rés megszüntetéséhez módosítja az PowerPoint üzenethossz-ellenőrző algoritmusát, amely az üzeneteket a lefoglalt pufferbe való továbbítás előtt ellenőrzi.
...
1.  [A biztonsági frissítés letöltése.](http://download.microsoft.com/download/8/c/d/8cd18498-aa99-4afb-8c57-52d704211757/office2000-kb916520-fullfile-enu.exe)
...
|--------------|------------|---------------|---------|-----------|
| Powerpnt.exe | 9.0.0.8942 | 2006. 05. 04. | 23:21   | 4 259 892 |
...
1.  [Töltse le a biztonsági frissítést](http://download.microsoft.com/download/8/c/d/8cd18498-aa99-4afb-8c57-52d704211757/office2000-kb916520-fullfile-enu.exe).
2.  Válassza a **Lemezre mentés** lehetőséget, majd kattintson az **OK** gombra.
3.  Kattintson a **Mentés** gombra.
...
| Fájlnév        | Verziószám | Dátum         | Időpont | Méret     |
|----------------|------------|---------------|---------|-----------|
| PowerPoint.exe | 9.0.0.8942 | 2006. 05. 04. | 23:21   | 4 259 892 |
...
-   Az Office XP Service Pack 3 (SP3) csomagnak telepítve kell lennie. E frissítés telepítése előtt telepítse az [Office XP SP3](http://www.microsoft.com/downloads/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e) javítócsomagot. Az Office XP SP3 javítócsomag telepítésével kapcsolatos további tudnivalókat lásd: [Microsoft Tudásbázis 832671](http://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;832671) cikke.
...
1.  [A biztonsági frissítés letöltése.](http://download.microsoft.com/download/d/0/9/d0933324-aabb-4caf-a433-5f42ababfdf5/officexp-kb916519-fullfile-enu.exe)
2.  Válassza a **Lemezre mentés** lehetőséget, majd kattintson az **OK** gombra.
3.  Kattintson a **Mentés** gombra.
4.  A Windows Intézőben keresse meg a mentett fájlt tároló mappát, majd kattintson duplán a fájlra.
5.  Ha a frissítés telepítésének megkezdésére vonatkozó kérdés jelenik meg, kattintson az **Igen** gombra.
...
| Fájlnév        | Verziószám  | Dátum         | Időpont | Méret     |
|----------------|-------------|---------------|---------|-----------|
| PowerPoint.exe | 10.0.6800.0 | 2006. 04. 27. | 07:00   | 6 097 680 |
...
6.  A mappa létrehozását kérő párbeszédpanelen kattintson az **Igen** gombra.
7.  Amennyiben ismeri a **felügyeleti telepítés** frissítésének folyamatát, kattintson a **Start** menü **Futtatás** elemére, adja meg a következő parancsot, majd kattintson az **OK** gombra:
    **msiexec /a** *Admin Pat***h\\**MSI File **/p C:\\adminUpdate\\***MSP File* **SHORTFILENAMES=TRUE**
...
| Fájlnév      | Verziószám  | Dátum         | Időpont | Méret     |
|--------------|-------------|---------------|---------|-----------|
| Powerpnt.exe | 10.0.6800.0 | 2006. 04. 27. | 07:00   | 6 097 680 |
...
1.  [Töltse le a biztonsági frissítést](http://download.microsoft.com/download/a/c/a/aca69765-b6cc-4d4a-8bb2-a183f63a3de2/office2003-kb916518-fullfile-enu.exe).
2.  Válassza a **Lemezre mentés** lehetőséget, majd kattintson az **OK** gombra.
3.  Kattintson a **Mentés** gombra.
4.  A Windows Intézőben keresse meg a mentett fájlt tároló mappát, majd kattintson duplán a fájlra.
5.  Ha a frissítés telepítésének megkezdésére vonatkozó kérdés jelenik meg, kattintson az **Igen** gombra.
...
| Fájlnév      | Verziószám  | Dátum         | Időpont | Méret     |
|--------------|-------------|---------------|---------|-----------|
| Powerpnt.exe | 11.0.8024.0 | 2006. 04. 28. | 10:13   | 6,253,840 |
...
1.  [A biztonsági frissítés letöltése.](http://download.microsoft.com/download/a/c/a/aca69765-b6cc-4d4a-8bb2-a183f63a3de2/office2003-kb916518-fullfile-enu.exe)
2.  Válassza a **Lemezre mentés** lehetőséget, majd kattintson az **OK** gombra.
3.  Kattintson a **Mentés** gombra.
4.  A Windows Intézővel keresse meg a mentett fájlt tároló mappát. Kattintson a **Start** menü **Futtatás** parancsára, írja be az alábbi parancsot, majd az .msp fájl kicsomagolásához kattintson az **OK** gombra:
    **\[path\\name - EXE file\] /c /t:C:\\AdminUpdate**
...
A biztonsági frissítéshez telepített PowerPoint 2004 for Mac 11.0.0-11.2.3 verzióra van szükség.
...
1.  Lépjen a végrehajtható fájlt tartalmazó mappába (**Microsoft Office 2004: Microsoft PowerPoint**).
2.  Kattintson az alkalmazásra.
3.  Kattintson a **File (Fájl)** menü **Get Info (Tulajdonságok)** parancsára.

Amennyiben a program verziószáma 11.2.4, a frissítés telepítése sikeresen megtörtént.

#### PowerPoint v. X for Mac

**Előfeltételek**

A biztonsági frissítéshez PowerPoint v. X for Mac 10.1.6 telepített verzióra van szükség.
...
1.  Lépjen a végrehajtható fájlt tartalmazó mappába (**Microsoft Office X: Microsoft PowerPoint**).
2.  Kattintson az alkalmazásra.
3.  Kattintson a **File (Fájl)** menü **Get Info (Tulajdonságok)** parancsára.
...
-   Nicolas Ruff, Fabrice Desclaux és Kostya Kortchinsky, [European Aeronautic Defence and Space Company](http://www.eads.com/), a Microsoft PowerPoint hibásan létrehozott bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági résének jelentéséért - [CVE-2006-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022).
-   [Elia Florio](https://technet.microsoft.com/hu-HU/library/elia_florio%40symantec.com(v=Security.10)), ([Symantec)](http://www.symantec.com/index.htm) a Microsoft PowerPoint hibásan kialakított bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági résének jelentéséért - [CVE-2006-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022).
-   Dejun Meng [(Fortinet Security Response Team)](http://www.fortinet.com/) Microsofttal való együttműködésért a Microsoft PowerPoint hibásan kialakított bejegyzés miatti, távoli kódfuttatást lehetővé tévő biztonsági résen - [CVE-2006-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0022).
...
-   V1.1 verzió 2006. június 14.: Közlemény módosította a PowerPoint 2003 részét képező „Ügyféltelepítés - fájlinformáció és felügyeleti telepítés - fájlinformáció” c. részt.
-   1.2 verzió (2006. június 21.): A közlemény Gyakran ismételt kérdések a biztonsági frissítéssel kapcsolatban című részének Milyen biztonsági frissítéseket vált fel ez a frissítés? szakasza frissítve.
