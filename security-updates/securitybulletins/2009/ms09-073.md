...
-   **A konverter fájl elérésének korlátozásával tiltsa le a WordPad szövegkonverter működését a Word 97 fájlformátumra vonatkozóan**
    ...
    **Megjegyzés** A biztonsági frissítés telepítése előtt vissza kell vonni ezt az elkerülő megoldást.
    ...
    ```
    echo y| cacls "%ProgramFiles%\Common Files\MicrosoftShared\TextConv\mswrd832,cnv" /E /P everyone:N  
    echo y| cacls "%ProgramFiles(x86)%\Common Files\MicrosoftShared\TextConv\mswrd832,cnv" /E /P everyone:N  
