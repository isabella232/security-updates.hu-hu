---
TOCTitle: 'MS09-002'
Title: 'A Microsoft számú biztonsági közleménye MS09-002 - Kritikus'
ms:assetid: 'ms09-002'
ms:contentKeyID: 61228291
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms09-002(v=Security.10)'
author: SharonSears
...
A Microsoft számú biztonsági közleménye MS09-002 - Kritikus
===========================================================

Összesítő biztonsági frissítés az Internet Explorer programhoz (961260)
-----------------------------------------------------------------------

Közzétéve: 2009. február 10. | Frissítve: 2009. február 16.
...
A biztonsági frissítés a Windows XP és Windows Vista összes támogatott kiadásán futó Internet Explorer 7 esetében kritikus besorolású. A Windows Server 2003 és a Windows Server 2008 valamennyi támogatott kiadásán működő Internet Explorer 7 verzió vonatkozásában a biztonsági frissítés Mérsékelt minősítésű. További tudnivalókat a közlemény későbbi részében az **Érintett és nem érintett szoftverek** cím alatt talál.
...
|------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                      | Microsoft Internet Explorer 5.01 Service Pack 4 szervizcsomaggal |
| Microsoft Windows 2000 Service Pack 4                                                                      | Microsoft Internet Explorer 6 Service Pack 1 szervizcsomaggal    |
| Windows XP Service Pack 2 és Windows XP Service Pack 3                                                     | Microsoft Internet Explorer 6                                    |
| Windows XP Professional x64 Edition és Windows XP Professional x64 Edition Service Pack 2                  | Microsoft Internet Explorer 6                                    |
| Windows Server 2003 Service Pack 1 és Windows Server 2003 Service Pack 2 rendszerhez                       | Microsoft Internet Explorer 6                                    |
| Windows Server 2003 x64 Edition és Windows Server 2003 x64 Edition Service Pack 2 rendszerhez              | Microsoft Internet Explorer 6                                    |
| Windows Server 2003 SP1 Itanium alapú rendszerekhez és Windows Server 2003 SP2 Itanium alapú rendszerekhez | Microsoft Internet Explorer 6                                    |

Gyakran ismételt kérdések a biztonsági frissítéssel kapcsolatban
----------------------------------------------------------------

**Hol találhatók a fájlinformációs adatok?**  
A fájlinformációs adatok a [Microsoft Tudásbázis 961260. számú cikkében találhatók](http://support.microsoft.com/kb/961260).
...
<th style="border:1px solid black;" >
Inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés - CVE-2009-0075
</th>
<th style="border:1px solid black;" >
CSS memória-meghibásodás biztonsági rése - CVE-2009-0076
</th>
<th style="border:1px solid black;" >
Összesített súlyossági besorolás
</th>
...
A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2008-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075).

#### Az inicializálás hiánya miatti memória-meghibásodás okozta biztonsági rés (CVE-2009-0075) súlyosságát enyhítő tényezők
...
-   A biztonsági rés csak a Windows Internet Explorer 7 alkalmazást érinti. A Microsoft Internet Explorer 5 és a Microsoft Internet Explorer 6 támogatott verzióit nem érinti.

#### Lehetséges megoldások az inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés (CVE-2009-0075) kiküszöbölésére
...
#### Gyakran feltett kérdések az inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés (CVE-2009-0075) kapcsán
...
Az Internet Explorer lépcsőzetes stíluslapok (CSS) kezelése miatt az Internet Explorerben távoli kódvégrehajtást lehetővé tévő biztonsági rés található. A támadó a biztonsági rés kihasználásához különlegesen kialakított weboldalt hozhat létre. Ha a felhasználó megtekinti ezt az oldalt, a biztonsági rés távoli kódfuttatást tehet lehetővé. A biztonsági rést kihasználó támadó a bejelentkezett felhasználóval egyező hozzáférést nyer a rendszerhez.

A biztonsági rés standard bejegyzésének megtekintéséhez a normál biztonsági rés besorolási listáján lásd: [CVE-2009-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076).

#### A CSS memóriameghibásodási biztonsági résének (CVE-2009-0076) súlyosságát enyhítő tényezők:
...
#### Lehetséges megoldások a CSS memóriameghibásodási biztonsági résének - CVE-2009-0076 - kiküszöbölésére
...
#### Gyakran feltett kérdések a CSS memóriameghibásodási biztonsági résével (CVE-2009-0076) kapcsolatban
...
**Mi okozza a biztonsági rést?**  
Miközben az Internet Explorer adott CSS-stíluslapokat tartalmazó weboldalt jelenít meg, a rendszer memóriája megsérülhet, emiatt a támadó a bejelentkezett felhasználó környezetében tetszőleges kódot futtathat.
...
**Mi a CSS?**  
A CSS a Cascading Style Sheet (lépcsőzetes stíluslap) rövidítése, mely a HTML-alapú weboldalak formázási módszere. A CSS stíluslapok részletes ismertetése a [Microsoft TechNet webhelyen](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true) található.

**Mi a frissítés feladata?**  
A frissítés módosítja a lépcsőzetes stíluslapok kezelését az Internet Explorer alkalmazásban.
...
| Windows Server 2003 Service Pack 1 és Microsoft Windows Server 2003 Service Pack 2                         | Nem     | Nem                      | Igen                                                                                           | Igen                       |
...
<td style="border:1px solid black;">Internet Explorer 7 alkalmazás a Windows XP összes támogatott kiadása esetén<br />
Használja a Vezérlőpult Programok telepítése és törlése lehetőségét vagy a Spuninst.exe segédprogramot, amely a %Windir%\ie7updates\KB961260-IE7\spuninst mappában található.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Fájlinformációk</strong></td>
<td style="border:1px solid black;">Lásd a <a href="http://support.microsoft.com/kb/961260">Microsoft Tudásbázis 961260. számú cikkét</a></td>
</tr>
<tr class="even">
...
-   [TippingPoint](http://www.tippingpoint.com/) és [Zero Day Initiative](http://www.zerodayinitiative.com/), az inicializálás hiánya miatti memóriameghibásodás okozta biztonsági rés (CVE-2009-0075) jelentéséért.  
-   Sam Thomas (<http://eshu.co.uk/>), a [TippingPoint](http://www.tippingpoint.com/) és a [Zero Day Initiative](http://www.zerodayinitiative.com/) munkatársa, a CSS memóriameghibásodást okozó biztonsági résének jelentéséért (CVE-2009-0076)
...
&ndash;&nbsp;&nbsp;&nbsp;&nbsp;1.0 verzió (2009. február 10.): Közlemény kiadva.  
&ndash;&nbsp;&nbsp;&nbsp;&nbsp;1.1 verzió (2009. február 16.): Új hivatkozás a Microsoft Tudásbázis 961260. cikkére az **Összefoglalás** rész Ismert problémák szakaszában.
