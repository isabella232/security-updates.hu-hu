...
-   **Hozzáférés megtagadása a T2EMBED.DLL vezérlőhöz**
    ...
    **Windows** **Vista** **és Windows Server 2008:**
    ...
    Icacls.exe "%windir%\system32\t2embed.dll" /save  
    %TEMP%\t2embed_ACL.TXTIcacls.exe "%windir%\system32\t2embed.dll" /deny everyone:(F)
    ```
    ...
    Icacls.exe "%windir%\syswow64\t2embed.dll" /save  
    %TEMP%\t2embed_ACL.TXTIcacls.exe "%windir%\syswow64\t2embed.dll" /deny everyone:(F)
    ```
