---
TOCTitle: 'MS07-MAR'
Title: 'Microsoft biztonsági közlemény - összefoglalás, március 2007'
ms:assetid: 'ms07-mar'
ms:contentKeyID: 61227711
ms:mtpsurl: 'https://technet.microsoft.com/hu-HU/library/ms07-mar(v=Security.10)'
---

Security Bulletin Summary

Microsoft biztonsági közlemény - összefoglalás, március 2007
============================================================

Közzétéve: 2007. március 13.

**Verzió:** 1.0

Az összefoglaló a 2007 márciusára kiadott biztonsági közleményeket összegzi.
...
**Frissítésekkel kapcsolatos stratégiák:** [A javítások telepítésére vonatkozó útmutatás](http://go.microsoft.com/fwlink/?linkid=21168) a Microsoft által a biztonsági frissítések telepítéséhez ajánlott legjobban bevált eljárásokat ismerteti.
...
2007. március 13-án a Microsoft nem adott ki biztonsági közleményeket.
...
A **Microsoft Windows kártevő szoftvereket eltávolító eszköze**

A Microsoft a Windows Update, Microsoft Update, Windows Server Update Services és Letöltőközpont szolgáltatásán keresztül elérhetővé tette a Microsoft Windows kártevő szoftvereket eltávolító eszközének frissített változatát.
...
-   A Microsoft két **nem biztonsági jellegű**, kiemelt fontosságú frissítést adott ki a Microsoft Update (MU) és a Windows Server Update Services (WSUS) szolgáltatásokon keresztül.
-   A Microsoft négy **nem biztonsági jellegű**, kiemelt fontosságú frissítést adott ki a Windows rendszerhez a Windows Update (WU) és a Software Update Services (SUS) szolgáltatásokon keresztül.
...
-   1.0 verzió (2007. március 13.): Összefoglaló közlemény közzététele.
