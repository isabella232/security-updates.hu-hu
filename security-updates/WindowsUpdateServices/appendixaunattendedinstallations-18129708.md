...
ms:contentKeyID: 18129708
ms:mtpsurl: 'https://technet.microsoft.com/hu-hu/library/Cc708476(v=WS.10)'
---
...
<td style="border:1px solid black;"><p>Uninstall the product. Also uninstalls the Belső Windows-adatbázis instance if it is installed.</p></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><p>Path to Belső Windows-adatbázis data directory.</p></td>
</tr>
<tr class="even">
