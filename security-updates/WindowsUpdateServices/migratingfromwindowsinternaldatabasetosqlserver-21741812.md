...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Dd939918.Warning(WS.10).gif" />Figyelmeztetés</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
13. Verify that the database migration was successful by opening the WSUS administrative console. (Click **Start**, click **Administrative Tools**, and then click **Microsoft Windows Server Update Services 3.0**.)
    ...
    <thead>
    <tr class="header">
    <th style="border:1px solid black;" ><img src="images/Dd939918.note(WS.10).gif" />Megjegyzés</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
