...
ms:contentKeyID: 21741697
ms:mtpsurl: 'https://technet.microsoft.com/hu-hu/library/Dd939833(v=WS.10)'
---
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Dd939833.note(WS.10).gif" />Megjegyzés</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
2.  Type the following:
    ...
    If you are using Belső Windows-adatbázis as the WSUS database, use the following string in place of *SqlServerName* in the command:
