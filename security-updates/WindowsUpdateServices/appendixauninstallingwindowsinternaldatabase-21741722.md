...
ms:contentKeyID: 21741722
ms:mtpsurl: 'https://technet.microsoft.com/hu-hu/library/Dd939818(v=WS.10)'
---
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Uninstalling Belső Windows-adatbázis is not recommended, because it may affect other applications that may be using the same database instance (such as Windows SharePoint Services).
</td>
</tr>
</tbody>
</table>
