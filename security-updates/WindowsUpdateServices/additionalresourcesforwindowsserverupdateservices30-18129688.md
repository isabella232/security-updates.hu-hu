...
ms:contentKeyID: 18129688
ms:mtpsurl: 'https://technet.microsoft.com/hu-hu/library/Cc708482(v=WS.10)'
---
...
-   For step-by-step guidance for getting started, including installing WSUS, setting up a client computer, and deploying your first set of updates, see [Részletes útmutató a Microsoft Windows Server Update Services (WSUS) 3.0 szolgáltatás használatba vételéhez](https://technet.microsoft.com/a68a19d2-630e-45d6-b596-d24dac987b64)(http://go.microsoft.com/fwlink/?LinkID=41774).
