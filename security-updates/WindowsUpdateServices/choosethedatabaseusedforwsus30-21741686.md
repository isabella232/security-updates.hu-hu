...
ms:contentKeyID: 21741686
ms:mtpsurl: 'https://technet.microsoft.com/hu-hu/library/Dd939812(v=WS.10)'
---

Choose the Database Used for WSUS 3.0
=====================================

You do not need to be a database administrator or purchase database software to use WSUS. WSUS 3.0 will install Belső Windows-adatbázis if you choose to install a minimal version of SQL Server. This version of SQL Server is designed to require very little management by the WSUS administrator. If you already have Windows Internal Database installed, WSUS will use it. If you want more control over the database, you can also use the full version of SQL Server with WSUS.
...
<thead>
<tr class="header">
<th><img src="images/Dd939812.Important(WS.10).gif" />Fontos</th>
</tr>
</thead>
<tbody>
<tr class="odd">
